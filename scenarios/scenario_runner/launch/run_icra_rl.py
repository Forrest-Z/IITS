...
def generate_launch_description():
    ...
    return LaunchDescription([
        ...
        Node(
            package='fead_monitor',
            # node_namespace='fead',
            node_executable='run_fead_monitor',    
            node_name='fead_monitor',
            #parameters=[scenario_runner_parameter],
            remappings=None,
            output='screen',
            emulate_tty=True,
        ...
        Node(
            package='rl_decision_making',
            # node_namespace='fead',
            node_executable='run_trainer',    
            node_name='trainer' ,
            remappings=None,
            output='screen',
            emulate_tty=True,
