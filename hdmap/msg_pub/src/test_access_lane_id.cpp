...
int main(int argc, char **argv) {
  ...
  std::shared_ptr<rclcpp::Node> node =
      rclcpp::Node::make_shared("AccessLaneID_client");  // CHANGE
  rclcpp::Client<fead_interfaces::srv::AccessLaneID>::SharedPtr
      client =  // CHANGE
      node->create_client<fead_interfaces::srv::AccessLaneID>(
          "AccessLaneID");  // CHANGE

  auto request = std::make_shared<
      fead_interfaces::srv::AccessLaneID::Request>();  // CHANGE
