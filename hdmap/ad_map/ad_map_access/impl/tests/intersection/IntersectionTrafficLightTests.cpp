...
// Always assumes that lanes with higher priority are always empty. This is not
// true if there
// is a solid traffic light and the host vehicle is turning left.
// Need to check expectedIncomingLanesWithHigherPriority and
// expectedIncomingLanesWithLowerPriority
...
IntersectionTrafficLightFromWestTest::expectedIntersectionType() const {
...
lane::LaneIdSet IntersectionTrafficLightWestToNorthTest::
...
lane::LaneIdSet IntersectionTrafficLightWestToNorthTest::expectedCrossingLanes()
    const {
  return lane::LaneIdSet();
}
...
TEST_F(IntersectionTrafficLightWestToNorthTest, basic_checks) {
  ...
  geoPoint =
      point::createGeoPoint(point::Longitude(8.457537128),
                            point::Latitude(49.02076074), point::Altitude(3.));
  id1 = landmark::uniqueLandmarkId(geoPoint);
  geoPoint =
      point::createGeoPoint(point::Longitude(8.457463354),
                            point::Latitude(49.02067458), point::Altitude(3.));
  id2 = landmark::uniqueLandmarkId(geoPoint);
  performBasicTrafficLightsChecks({expectedTrafficLight((uint64_t)id1),
                                   expectedTrafficLight((uint64_t)id2)});
}
...
lane::LaneIdSet IntersectionTrafficLightWestToEastTest::
    expectedIncomingLanesWithHigherPriority() const {
  return lane::LaneIdSet();
}

lane::LaneIdSet
IntersectionTrafficLightWestToEastTest::expectedIncomingLanesWithLowerPriority()
    const {
...
lane::LaneIdSet IntersectionTrafficLightWestToEastTest::expectedCrossingLanes()
    const {
  return lane::LaneIdSet();
}
...
TEST_F(IntersectionTrafficLightWestToEastTest, basic_checks) {
  ...
  geoPoint =
      point::createGeoPoint(point::Longitude(8.457463354),
                            point::Latitude(49.02067458), point::Altitude(3.));
  id2 = landmark::uniqueLandmarkId(geoPoint);
  performBasicTrafficLightsChecks({expectedTrafficLight((uint64_t)id2),
                                   expectedTrafficLight((uint64_t)id1)});
}
...
lane::LaneIdSet IntersectionTrafficLightWestToSouthTest::
    expectedIncomingLanesWithHigherPriority() const {
  return lane::LaneIdSet();
}
...
lane::LaneIdSet IntersectionTrafficLightWestToSouthTest::expectedCrossingLanes()
    const {
  return lane::LaneIdSet();
}
TEST_F(IntersectionTrafficLightWestToSouthTest, basic_checks) {
  ...
  geoPoint =
      point::createGeoPoint(point::Longitude(8.457462013),
                            point::Latitude(49.02067301), point::Altitude(3.));
  id1 = landmark::uniqueLandmarkId(geoPoint);
  performBasicTrafficLightsChecks({expectedTrafficLight((uint64_t)id1)});
}
...
intersection::IntersectionType
IntersectionTrafficLightFromEastTest::expectedIntersectionType() const {
  return intersection::IntersectionType::TrafficLight;
}
...
lane::LaneIdSet IntersectionTrafficLightEastToNorthTest::
    expectedIncomingLanesWithHigherPriority() const {
  return lane::LaneIdSet();
}
...
lane::LaneIdSet IntersectionTrafficLightEastToNorthTest::expectedCrossingLanes()
    const {
  return lane::LaneIdSet();
}
...
TEST_F(IntersectionTrafficLightEastToNorthTest, basic_checks) {
  ...
  geoPoint =
      point::createGeoPoint(point::Longitude(8.457971538),
                            point::Latitude(49.0205365), point::Altitude(3.));
  id1 = landmark::uniqueLandmarkId(geoPoint);
  geoPoint =
      point::createGeoPoint(point::Longitude(8.458004075),
                            point::Latitude(49.02058106), point::Altitude(5.));
  id2 = landmark::uniqueLandmarkId(geoPoint);
  geoPoint =
      point::createGeoPoint(point::Longitude(8.458036612),
                            point::Latitude(49.02062562), point::Altitude(3.));
  id3 = landmark::uniqueLandmarkId(geoPoint);
  performBasicTrafficLightsChecks({expectedTrafficLight((uint64_t)id1),
                                   expectedTrafficLight((uint64_t)id2),
                                   expectedTrafficLight((uint64_t)id3)});
}
...
lane::LaneIdSet IntersectionTrafficLightEastToWestTest::
    expectedIncomingLanesWithHigherPriority() const {
  return lane::LaneIdSet();
}

lane::LaneIdSet
IntersectionTrafficLightEastToWestTest::expectedIncomingLanesWithLowerPriority()
    const {
  return createUnorderedLaneIdSet({getIncomingLanesSouth(),
                                   getIncomingLanesWest(),
                                   getIncomingLanesNorth()});
...
lane::LaneIdSet IntersectionTrafficLightEastToWestTest::expectedCrossingLanes()
    const {
  return lane::LaneIdSet();
}
...
lane::LaneIdSet IntersectionTrafficLightEastToSouthTest::
    expectedIncomingLanesWithHigherPriority() const {
...
lane::LaneIdSet IntersectionTrafficLightEastToSouthTest::
  ...
  return createUnorderedLaneIdSet(
      {getIncomingLanesSouth(), getIncomingLanesNorth()});
}
...
lane::LaneIdSet IntersectionTrafficLightEastToSouthTest::expectedCrossingLanes()
    const {
  return lane::LaneIdSet();
}
...
intersection::IntersectionType
IntersectionTrafficLightFromNorthTest::expectedIntersectionType() const {
  return intersection::IntersectionType::TrafficLight;
}
...
lane::LaneIdSet IntersectionTrafficLightNorthToEastTest::
    expectedIncomingLanesWithHigherPriority() const {
  return createUnorderedLaneIdSet({getIncomingLanesSouth()});
}
...
lane::LaneIdSet IntersectionTrafficLightNorthToEastTest::expectedCrossingLanes()
    const {
  return lane::LaneIdSet();
}
...
TEST_F(IntersectionTrafficLightNorthToEastTest, basic_checks) {
  ...
  landmark::LandmarkId id1;
  geoPoint =
      point::createGeoPoint(point::Longitude(8.457771924),
                            point::Latitude(49.02077962), point::Altitude(3.));
  id1 = landmark::uniqueLandmarkId(geoPoint);
  performBasicTrafficLightsChecks({expectedTrafficLight((uint64_t)id1)});
}
...
lane::LaneIdSet IntersectionTrafficLightNorthToWestTest::
    expectedIncomingLanesWithHigherPriority() const {
  return lane::LaneIdSet();
}
...
lane::LaneIdSet IntersectionTrafficLightNorthToWestTest::expectedCrossingLanes()
    const {
  return lane::LaneIdSet();
}
...
lane::LaneIdSet IntersectionTrafficLightNorthToSouthTest::
    expectedIncomingLanesWithHigherPriority() const {
  return lane::LaneIdSet();
}
...
lane::LaneIdSet
IntersectionTrafficLightNorthToSouthTest::expectedCrossingLanes() const {
  return lane::LaneIdSet();
}
...
intersection::IntersectionType
IntersectionTrafficLightFromSouthTest::expectedIntersectionType() const {
  return intersection::IntersectionType::TrafficLight;
}
...
lane::LaneIdSet IntersectionTrafficLightSouthToEastTest::
    expectedIncomingLanesWithHigherPriority() const {
  return lane::LaneIdSet();
}
...
lane::LaneIdSet IntersectionTrafficLightSouthToEastTest::expectedCrossingLanes()
    const {
  return lane::LaneIdSet();
}
...
lane::LaneIdSet IntersectionTrafficLightSouthToWestTest::
    expectedIncomingLanesWithHigherPriority() const {
  return lane::LaneIdSet();
}
...
lane::LaneIdSet IntersectionTrafficLightSouthToWestTest::expectedCrossingLanes()
    const {
  return lane::LaneIdSet();
}
...
lane::LaneIdSet IntersectionTrafficLightSouthToNorthTest::
    expectedIncomingLanesWithHigherPriority() const {
  return lane::LaneIdSet();
}
...
lane::LaneIdSet
IntersectionTrafficLightSouthToNorthTest::expectedCrossingLanes() const {
  return lane::LaneIdSet();
}
...
struct IntersectionTrafficLightTown01WestToSouthTest
    : IntersectionTown01WestToSouthTest,
