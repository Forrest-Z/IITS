...
void prepareMapAllWayStop() { prepareMap("test_files/AllWayStop.adm.txt"); }
...
void prepareMapBasicYield() { prepareMap("test_files/BasicYield.adm.txt"); }
...
void prepareMapTpkPfzDrive() { prepareMap("test_files/TPK_PFZ.adm.txt"); }
...
void prepareMapTown01TrafficLight() { prepareMap("test_files/Town01.txt"); }
