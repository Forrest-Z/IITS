...
TEST_F(GeometryStoreTest, StoreSerialization) {
  ...
  ASSERT_TRUE(serializer_w.open("test_files/test_StoreSerialization.adm",
  ...
  ASSERT_TRUE(serializer_r.open("test_files/test_StoreSerialization.adm",
                                versionMajor, versionMinor));
  ...
  ASSERT_TRUE(serializer_w2.open("test_files/test_StoreSerialization.adm",
                                 versionMajor, versionMinor));
  ...
  ASSERT_TRUE(serializer_r2.open("test_files/test_StoreSerialization.adm",
                                 versionMajor, versionMinor));
