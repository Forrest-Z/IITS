...
TEST_F(AdMapAccessTest, initializeFromOpenDriveContent) {
  ...
  ASSERT_FALSE_NO_LOG(access::initFromOpenDriveContent(
      std::string(), 0.2, intersection::IntersectionType::TrafficLight));

  ASSERT_TRUE(access::initFromOpenDriveContent(
      openDriveContent, 0.2, intersection::IntersectionType::TrafficLight));
  ...
  leftPoints.push_back(toECEF(createGeoPoint(point::Longitude(8.44933898),
                                             point::Latitude(49.00737633),
                                             point::Altitude(0.))));
  leftPoints.push_back(toECEF(createGeoPoint(point::Longitude(8.45006151),
                                             point::Latitude(49.00885163),
                                             point::Altitude(0.))));
  rightPoints.push_back(toECEF(createGeoPoint(point::Longitude(8.44937788),
                                              point::Latitude(49.00736837),
                                              point::Altitude(0.))));
  rightPoints.push_back(toECEF(createGeoPoint(point::Longitude(8.45010064),
                                              point::Latitude(49.00884320),
                                              point::Altitude(0.))));
