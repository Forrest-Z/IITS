...
TEST_F(GeoOperationTest, geoPointapproxAltitude) {
  ...
  {
    GeoPoint ptY =
        vectorInterpolate(pt_ul, pt_ur, physics::ParametricValue(0.3));
  ...
  {
    GeoPoint ptY =
        vectorInterpolate(pt_ur, pt_lr, physics::ParametricValue(0.7));
    GeoPoint ptX = zeroAltitude(ptY);
    GeoPoint pt = approxAltitude(ptX, pts);
    ASSERT_EQ(pt, ptY);
  }
  {
    ...
    ASSERT_EQ(
        createGeoPoint(Longitude(-121.935549), Latitude(37.401336), h + dh),
        ret);
  }
}
...
TEST_F(GeoOperationTest, isOnTheLeft) {
  ...
  edge2_geo.clear();
  edge2_geo.push_back(createGeoPoint(Longitude(-121.935549 - diff),
                                     Latitude(37.401336), Altitude(123.456)));
  edge2_geo.push_back(createGeoPoint(
      Longitude(-121.935549), Latitude(37.401336 + diff), Altitude(123.456)));
  edge3_geo.clear();
  edge3_geo.push_back(createGeoPoint(Longitude(-121.935549),
                                     Latitude(37.401336), Altitude(123.456)));
  edge3_geo.push_back(createGeoPoint(
      Longitude(-121.935549), Latitude(37.401336 + diff), Altitude(123.456)));
  ...
  edge2_geo.push_back(createGeoPoint(
      Longitude(-121.935549), Latitude(37.401336 - diff), Altitude(123.456)));
  edge2_geo.push_back(createGeoPoint(Longitude(-121.935549),
                                     Latitude(37.401336), Altitude(123.456)));
  edge3_geo.clear();
  edge3_geo.push_back(createGeoPoint(Longitude(-121.935549),
                                     Latitude(37.401336), Altitude(123.456)));
  edge3_geo.push_back(createGeoPoint(Longitude(-121.935549 + diff),
                                     Latitude(37.401336), Altitude(123.456)));
