...
TEST_F(PointOperationTest, dot_product) {
  std::vector<std::pair<double, std::pair<ENUPoint, ENUPoint>>> testVectors{
      std::make_pair(0., std::make_pair(createENUPoint(10., 0., 0.),
                                        createENUPoint(0., 10., 0.))),
      std::make_pair(0., std::make_pair(createENUPoint(10., 0., 0.),
                                        createENUPoint(0., 0., 10.))),
      std::make_pair(0., std::make_pair(createENUPoint(0., 10., 0.),
                                        createENUPoint(0., 0., 10.))),
      std::make_pair(0., std::make_pair(createENUPoint(0., 10., 0.),
                                        createENUPoint(10., 0., 0.))),
      std::make_pair(0., std::make_pair(createENUPoint(0., 0., 10.),
                                        createENUPoint(10., 0., 0.))),
      std::make_pair(0., std::make_pair(createENUPoint(0., 0., 10.),
                                        createENUPoint(0., 10., 0.))),
      std::make_pair(100., std::make_pair(createENUPoint(10., 0., 0.),
                                          createENUPoint(10., 0., 0.))),
      std::make_pair(100., std::make_pair(createENUPoint(0., 10., 0.),
                                          createENUPoint(0., 10., 0.))),
      std::make_pair(100., std::make_pair(createENUPoint(0., 0., 10.),
                                          createENUPoint(0., 0., 10.))),
      std::make_pair(-100., std::make_pair(createENUPoint(10., 0., 0.),
                                           createENUPoint(-10., 0., 0.))),
      std::make_pair(-100., std::make_pair(createENUPoint(0., 10., 0.),
      ...
      std::make_pair(-100., std::make_pair(createENUPoint(0., 0., 10.),
                                           createENUPoint(0., 0., -10.))),
      std::make_pair(300., std::make_pair(createENUPoint(10., 10., 10.),
                                          createENUPoint(10., 10., 10.))),
      std::make_pair(100., std::make_pair(createENUPoint(-10., 10., 10.),
                                          createENUPoint(10., 10., 10.))),
      std::make_pair(100., std::make_pair(createENUPoint(10., -10., 10.),
                                          createENUPoint(10., 10., 10.))),
      std::make_pair(100., std::make_pair(createENUPoint(10., 10., -10.),
...
TEST_F(PointOperationTest, cross_product) {
  std::vector<std::pair<ENUPoint, std::pair<ENUPoint, ENUPoint>>> testVectors{
      std::make_pair(createENUPoint(0., 0., 1.),
                     std::make_pair(createENUPoint(1., 0., 0.),
                                    createENUPoint(0., 1., 0.))),
      std::make_pair(createENUPoint(1., 0., 0.),
                     std::make_pair(createENUPoint(0., 1., 0.),
                                    createENUPoint(0., 0., 1.))),
      std::make_pair(createENUPoint(0., 1., 0.),
                     std::make_pair(createENUPoint(0., 0., 1.),
                                    createENUPoint(1., 0., 0.))),
  };
...
TEST_F(PointOperationTest, enu_heading_construction) {
  ...
  std::vector<std::pair<ENUPoint, double>> pointPairs{
      std::make_pair(createENUPoint(1., 0., 0.), 0.),
  ...
  for (auto pairElement : pointPairs) {
    ECEFHeading heading =
        createECEFHeading(enuReferencePointEcef, toECEF(pairElement.first));
