...
TEST(LaneChangeDirectionTests, testFromString) {
  ...
  ASSERT_EQ(fromString<::ad::map::route::LaneChangeDirection>(
                "::ad::map::route::LaneChangeDirection::LeftToRight"),
            ::ad::map::route::LaneChangeDirection::LeftToRight);
  ...
  EXPECT_ANY_THROW({
    fromString<::ad::map::route::LaneChangeDirection>(
...
TEST(LaneChangeDirectionTests, testToString) {
  ...
  minValue = std::min(
      minValue,
      static_cast<int32_t>(::ad::map::route::LaneChangeDirection::LeftToRight));
  maxValue = std::max(
      maxValue,
      static_cast<int32_t>(::ad::map::route::LaneChangeDirection::LeftToRight));
  ...
  minValue = std::min(
      minValue,
      static_cast<int32_t>(::ad::map::route::LaneChangeDirection::RightToLeft));
  maxValue = std::max(
      maxValue,
      static_cast<int32_t>(::ad::map::route::LaneChangeDirection::RightToLeft));

  ASSERT_EQ(toString(::ad::map::route::LaneChangeDirection::Invalid),
            "::ad::map::route::LaneChangeDirection::Invalid");
  minValue = std::min(
      minValue,
      static_cast<int32_t>(::ad::map::route::LaneChangeDirection::Invalid));
  maxValue = std::max(
      maxValue,
      static_cast<int32_t>(::ad::map::route::LaneChangeDirection::Invalid));

  ASSERT_EQ(toString(static_cast<::ad::map::route::LaneChangeDirection>(
                minValue - 1)),
            "UNKNOWN ENUM VALUE");
  ASSERT_EQ(toString(static_cast<::ad::map::route::LaneChangeDirection>(
                maxValue + 1)),
...
TEST(LaneChangeDirectionTests, ostreamOperatorTest) {
  ...
  ::ad::map::route::LaneChangeDirection value(
      ::ad::map::route::LaneChangeDirection::LeftToRight);
  stream << value;
