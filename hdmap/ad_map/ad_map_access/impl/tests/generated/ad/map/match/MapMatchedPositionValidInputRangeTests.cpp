...
TEST(MapMatchedPositionValidInputRangeTests, testValidInputRange) {
  ...
  valueLanePointParaPoint.parametricOffset =
      valueLanePointParaPointParametricOffset;
  valueLanePoint.paraPoint = valueLanePointParaPoint;
  ::ad::physics::RatioValue valueLanePointLateralT(
  ...
  ::ad::map::match::MapMatchedPositionType valueType(
...
TEST(MapMatchedPositionValidInputRangeTests,
     testValidInputRangeLanePointTooSmall) {
  ::ad::map::match::MapMatchedPosition value;
  ::ad::map::match::LanePoint valueLanePoint;
  ::ad::map::point::ParaPoint valueLanePointParaPoint;
  ::ad::map::lane::LaneId valueLanePointParaPointLaneId(1);
  ...
  ::ad::physics::ParametricValue
      invalidInitializedMemberParaPointParametricOffset(
          0. - ::ad::physics::ParametricValue::cPrecisionValue);
  invalidInitializedMemberParaPoint.parametricOffset =
      invalidInitializedMemberParaPointParametricOffset;
...
TEST(MapMatchedPositionValidInputRangeTests,
     testValidInputRangeLanePointTooBig) {
  ::ad::map::match::MapMatchedPosition value;
  ::ad::map::match::LanePoint valueLanePoint;
  ::ad::map::point::ParaPoint valueLanePointParaPoint;
  ::ad::map::lane::LaneId valueLanePointParaPointLaneId(1);
  ...
  ::ad::map::point::ParaPoint invalidInitializedMemberParaPoint;
  ::ad::physics::ParametricValue
      invalidInitializedMemberParaPointParametricOffset(1. * 1.1);
  invalidInitializedMemberParaPoint.parametricOffset =
      invalidInitializedMemberParaPointParametricOffset;
  invalidInitializedMember.paraPoint = invalidInitializedMemberParaPoint;
  value.lanePoint = invalidInitializedMember;
...
TEST(MapMatchedPositionValidInputRangeTests,
     testValidInputRangeMatchedPointTooSmall) {
  ::ad::map::match::MapMatchedPosition value;
  ::ad::map::match::LanePoint valueLanePoint;
  ::ad::map::point::ParaPoint valueLanePointParaPoint;
  ::ad::map::lane::LaneId valueLanePointParaPointLaneId(1);
...
TEST(MapMatchedPositionValidInputRangeTests,
     testValidInputRangeMatchedPointTooBig) {
  ::ad::map::match::MapMatchedPosition value;
  ::ad::map::match::LanePoint valueLanePoint;
  ::ad::map::point::ParaPoint valueLanePointParaPoint;
  ::ad::map::lane::LaneId valueLanePointParaPointLaneId(1);
...
TEST(MapMatchedPositionValidInputRangeTests,
     testValidInputRangeProbabilityTooSmall) {
  ::ad::map::match::MapMatchedPosition value;
  ::ad::map::match::LanePoint valueLanePoint;
  ::ad::map::point::ParaPoint valueLanePointParaPoint;
  ::ad::map::lane::LaneId valueLanePointParaPointLaneId(1);
  ...
  // override member with data type value below input range minimum
  ::ad::physics::Probability invalidInitializedMember(
      0. - ::ad::physics::Probability::cPrecisionValue);
  value.probability = invalidInitializedMember;
  ASSERT_FALSE(withinValidInputRange(value));
}

TEST(MapMatchedPositionValidInputRangeTests,
     testValidInputRangeProbabilityTooBig) {
  ::ad::map::match::MapMatchedPosition value;
  ::ad::map::match::LanePoint valueLanePoint;
  ::ad::map::point::ParaPoint valueLanePointParaPoint;
  ::ad::map::lane::LaneId valueLanePointParaPointLaneId(1);
...
TEST(MapMatchedPositionValidInputRangeTests,
     testValidInputRangeprobabilityDefault) {
  ::ad::map::match::MapMatchedPosition value;
...
TEST(MapMatchedPositionValidInputRangeTests,
     testValidInputRangeQueryPointTooSmall) {
  ::ad::map::match::MapMatchedPosition value;
  ::ad::map::match::LanePoint valueLanePoint;
  ::ad::map::point::ParaPoint valueLanePointParaPoint;
  ::ad::map::lane::LaneId valueLanePointParaPointLaneId(1);
...
TEST(MapMatchedPositionValidInputRangeTests,
     testValidInputRangeQueryPointTooBig) {
  ::ad::map::match::MapMatchedPosition value;
  ::ad::map::match::LanePoint valueLanePoint;
  ::ad::map::point::ParaPoint valueLanePointParaPoint;
  ::ad::map::lane::LaneId valueLanePointParaPointLaneId(1);
...
TEST(MapMatchedPositionValidInputRangeTests,
     testValidInputRangeMatchedPointDistanceTooSmall) {
  ::ad::map::match::MapMatchedPosition value;
  ::ad::map::match::LanePoint valueLanePoint;
  ::ad::map::point::ParaPoint valueLanePointParaPoint;
  ::ad::map::lane::LaneId valueLanePointParaPointLaneId(1);
...
TEST(MapMatchedPositionValidInputRangeTests,
     testValidInputRangeMatchedPointDistanceTooBig) {
  ::ad::map::match::MapMatchedPosition value;
  ::ad::map::match::LanePoint valueLanePoint;
  ::ad::map::point::ParaPoint valueLanePointParaPoint;
  ::ad::map::lane::LaneId valueLanePointParaPointLaneId(1);
...
TEST(MapMatchedPositionValidInputRangeTests,
     testValidInputRangematchedPointDistanceDefault) {
  ::ad::map::match::MapMatchedPosition value;
