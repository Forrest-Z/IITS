...
TEST(TrafficSignTypeValidInputRangeTests, testValidInputRangeValid) {
  ASSERT_TRUE(
      withinValidInputRange(::ad::map::landmark::TrafficSignType::INVALID));
  ASSERT_TRUE(withinValidInputRange(
  ...
  ASSERT_TRUE(withinValidInputRange(::ad::map::landmark::TrafficSignType::
                                        SUPPLEMENT_ARROW_APPLIES_LEFT_RIGHT));
  ASSERT_TRUE(withinValidInputRange(
      ::ad::map::landmark::TrafficSignType::SUPPLEMENT_ARROW_APPLIES_UP_DOWN));
  ASSERT_TRUE(
      withinValidInputRange(::ad::map::landmark::TrafficSignType::
  ...
  ASSERT_TRUE(
      withinValidInputRange(::ad::map::landmark::TrafficSignType::DANGER));
  ASSERT_TRUE(withinValidInputRange(
  ...
  ASSERT_TRUE(
      withinValidInputRange(::ad::map::landmark::TrafficSignType::YIELD_TRAIN));
  ASSERT_TRUE(
      withinValidInputRange(::ad::map::landmark::TrafficSignType::YIELD));
  ASSERT_TRUE(
      withinValidInputRange(::ad::map::landmark::TrafficSignType::STOP));
  ASSERT_TRUE(withinValidInputRange(
  ...
  ASSERT_TRUE(
      withinValidInputRange(::ad::map::landmark::TrafficSignType::ROUNDABOUT));
  ASSERT_TRUE(
      withinValidInputRange(::ad::map::landmark::TrafficSignType::PASS_RIGHT));
  ASSERT_TRUE(
      withinValidInputRange(::ad::map::landmark::TrafficSignType::PASS_LEFT));
  ASSERT_TRUE(withinValidInputRange(
      ::ad::map::landmark::TrafficSignType::BYBICLE_PATH));
  ASSERT_TRUE(
      withinValidInputRange(::ad::map::landmark::TrafficSignType::FOOTWALK));
  ASSERT_TRUE(withinValidInputRange(
  ...
  ASSERT_TRUE(
      withinValidInputRange(::ad::map::landmark::TrafficSignType::MAX_SPEED));
  ASSERT_TRUE(withinValidInputRange(
  ...
  ASSERT_TRUE(
      withinValidInputRange(::ad::map::landmark::TrafficSignType::CITY_BEGIN));
  ASSERT_TRUE(
      withinValidInputRange(::ad::map::landmark::TrafficSignType::CITY_END));
  ASSERT_TRUE(withinValidInputRange(
  ...
  ASSERT_TRUE(
      withinValidInputRange(::ad::map::landmark::TrafficSignType::CUL_DE_SAC));
  ASSERT_TRUE(withinValidInputRange(
  ...
  ASSERT_TRUE(
      withinValidInputRange(::ad::map::landmark::TrafficSignType::FREE_TEXT));
  ASSERT_TRUE(
      withinValidInputRange(::ad::map::landmark::TrafficSignType::UNKNOWN));
}
...
TEST(TrafficSignTypeValidInputRangeTests, testValidInputRangeInvalid) {
  ...
  ASSERT_FALSE(withinValidInputRange(
      static_cast<::ad::map::landmark::TrafficSignType>(minValue - 1)));
}
