...
TEST(LatitudeTestsStd, numericLimitsLowestIsMin) {
  EXPECT_DOUBLE_EQ(
      static_cast<double>(::ad::map::point::Latitude::getMin()),
      static_cast<double>(
...
TEST(LatitudeTestsStd, fabsIsWorkingCorrectly) {
  EXPECT_DOUBLE_EQ(
      0., static_cast<double>(std::fabs(::ad::map::point::Latitude(-0.))));
  EXPECT_DOUBLE_EQ(
      1., static_cast<double>(std::fabs(::ad::map::point::Latitude(-1.))));
  EXPECT_DOUBLE_EQ(::ad::map::point::Latitude::cPrecisionValue,
                   static_cast<double>(std::fabs(::ad::map::point::Latitude(
                       ::ad::map::point::Latitude::cPrecisionValue))));
...
TEST(LatitudeTests, copyConstructionFromValidValue) {
  ::ad::map::point::Latitude const validValue(
      ::ad::map::point::Latitude::cMinValue);
  ::ad::map::point::Latitude value(validValue);
  EXPECT_TRUE(value.isValid());
...
TEST(LatitudeTests, moveConstructionFromValidValue) {
  ...
  EXPECT_TRUE(value.isValid());
  EXPECT_DOUBLE_EQ(::ad::map::point::Latitude::cMinValue,
...
TEST(LatitudeTests, arithmeticOperatorsThrowOnInvalid) {
  ::ad::map::point::Latitude const minimalValue(
      ::ad::map::point::Latitude::cMinValue);
  ::ad::map::point::Latitude const maximalValue(
      ::ad::map::point::Latitude::cMaxValue);
  ::ad::map::point::Latitude const invalidValue;
  ...
  EXPECT_THROW(invalidValue / maximalValue, std::out_of_range);
  EXPECT_THROW(maximalValue / invalidValue, std::out_of_range);
  EXPECT_THROW(maximalValue / ::ad::map::point::Latitude(0.0),
               std::out_of_range);
...
TEST(LatitudeTests, comparisonOperatorsRespectPrecision) {
  double const precisionValueTimesTen =
      ::ad::map::point::Latitude::cPrecisionValue * 10.;
  ::ad::map::point::Latitude value;
  if (::ad::map::point::Latitude::cMinValue > precisionValueTimesTen) {
    value = ::ad::map::point::Latitude(::ad::map::point::Latitude::cMinValue +
                                       precisionValueTimesTen);
  } else if (::ad::map::point::Latitude::cMaxValue < precisionValueTimesTen) {
    value = ::ad::map::point::Latitude(::ad::map::point::Latitude::cMaxValue -
                                       precisionValueTimesTen);
  } else {
    value = ::ad::map::point::Latitude(precisionValueTimesTen);
  }
  ::ad::map::point::Latitude const sameValue = value;
  ::ad::map::point::Latitude const slightlyBiggerValue(
      static_cast<double>(value) +
      ::ad::map::point::Latitude::cPrecisionValue * 0.9);
  ::ad::map::point::Latitude const slightlySmallerValue(
      static_cast<double>(value) -
      ::ad::map::point::Latitude::cPrecisionValue * 0.9);
  ::ad::map::point::Latitude const actuallyBiggerValue(
      static_cast<double>(value) +
      ::ad::map::point::Latitude::cPrecisionValue * 1.1);
  ::ad::map::point::Latitude const actuallySmallerValue(
      static_cast<double>(value) -
      ::ad::map::point::Latitude::cPrecisionValue * 1.1);
