...
TEST(AltitudeTestsStd, numericLimitsLowestIsMin) {
  EXPECT_DOUBLE_EQ(
      static_cast<double>(::ad::map::point::Altitude::getMin()),
      static_cast<double>(
...
TEST(AltitudeTestsStd, fabsIsWorkingCorrectly) {
  EXPECT_DOUBLE_EQ(
      0., static_cast<double>(std::fabs(::ad::map::point::Altitude(-0.))));
  EXPECT_DOUBLE_EQ(
      1., static_cast<double>(std::fabs(::ad::map::point::Altitude(-1.))));
  EXPECT_DOUBLE_EQ(::ad::map::point::Altitude::cPrecisionValue,
                   static_cast<double>(std::fabs(::ad::map::point::Altitude(
                       ::ad::map::point::Altitude::cPrecisionValue))));
...
TEST(AltitudeTests, copyConstructionFromValidValue) {
  ::ad::map::point::Altitude const validValue(
      ::ad::map::point::Altitude::cMinValue);
  ::ad::map::point::Altitude value(validValue);
  EXPECT_TRUE(value.isValid());
...
TEST(AltitudeTests, moveConstructionFromValidValue) {
  ...
  EXPECT_TRUE(value.isValid());
  EXPECT_DOUBLE_EQ(::ad::map::point::Altitude::cMinValue,
...
TEST(AltitudeTests, arithmeticOperatorsThrowOnInvalid) {
  ::ad::map::point::Altitude const minimalValue(
      ::ad::map::point::Altitude::cMinValue);
  ::ad::map::point::Altitude const maximalValue(
      ::ad::map::point::Altitude::cMaxValue);
  ::ad::map::point::Altitude const invalidValue;
  ...
  EXPECT_THROW(invalidValue / maximalValue, std::out_of_range);
  EXPECT_THROW(maximalValue / invalidValue, std::out_of_range);
  EXPECT_THROW(maximalValue / ::ad::map::point::Altitude(0.0),
               std::out_of_range);
...
TEST(AltitudeTests, comparisonOperatorsRespectPrecision) {
  double const precisionValueTimesTen =
      ::ad::map::point::Altitude::cPrecisionValue * 10.;
  ::ad::map::point::Altitude value;
  if (::ad::map::point::Altitude::cMinValue > precisionValueTimesTen) {
    value = ::ad::map::point::Altitude(::ad::map::point::Altitude::cMinValue +
                                       precisionValueTimesTen);
  } else if (::ad::map::point::Altitude::cMaxValue < precisionValueTimesTen) {
    value = ::ad::map::point::Altitude(::ad::map::point::Altitude::cMaxValue -
                                       precisionValueTimesTen);
  } else {
    value = ::ad::map::point::Altitude(precisionValueTimesTen);
  }
  ::ad::map::point::Altitude const sameValue = value;
  ::ad::map::point::Altitude const slightlyBiggerValue(
      static_cast<double>(value) +
      ::ad::map::point::Altitude::cPrecisionValue * 0.9);
  ::ad::map::point::Altitude const slightlySmallerValue(
      static_cast<double>(value) -
      ::ad::map::point::Altitude::cPrecisionValue * 0.9);
  ::ad::map::point::Altitude const actuallyBiggerValue(
      static_cast<double>(value) +
      ::ad::map::point::Altitude::cPrecisionValue * 1.1);
  ::ad::map::point::Altitude const actuallySmallerValue(
      static_cast<double>(value) -
      ::ad::map::point::Altitude::cPrecisionValue * 1.1);
