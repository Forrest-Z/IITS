...
TEST(MapMatchedPositionTypeTests, testFromString) {
  ...
  ASSERT_EQ(fromString<::ad::map::match::MapMatchedPositionType>(
                "::ad::map::match::MapMatchedPositionType::INVALID"),
            ::ad::map::match::MapMatchedPositionType::INVALID);
  ...
  EXPECT_ANY_THROW({
    fromString<::ad::map::match::MapMatchedPositionType>(
...
TEST(MapMatchedPositionTypeTests, testToString) {
  ...
  ASSERT_EQ(toString(static_cast<::ad::map::match::MapMatchedPositionType>(
                minValue - 1)),
            "UNKNOWN ENUM VALUE");
  ASSERT_EQ(toString(static_cast<::ad::map::match::MapMatchedPositionType>(
                maxValue + 1)),
...
TEST(MapMatchedPositionTypeTests, ostreamOperatorTest) {
  ...
  ::ad::map::match::MapMatchedPositionType value(
      ::ad::map::match::MapMatchedPositionType::INVALID);
  stream << value;
