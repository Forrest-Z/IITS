...
TEST(ConnectingRouteTypeTests, testFromString) {
  ...
  ASSERT_EQ(fromString<::ad::map::route::ConnectingRouteType>(
                "::ad::map::route::ConnectingRouteType::Invalid"),
            ::ad::map::route::ConnectingRouteType::Invalid);
  ...
  EXPECT_ANY_THROW({
    fromString<::ad::map::route::ConnectingRouteType>(
...
TEST(ConnectingRouteTypeTests, testToString) {
  ...
  ASSERT_EQ(toString(::ad::map::route::ConnectingRouteType::Invalid),
            "::ad::map::route::ConnectingRouteType::Invalid");
  minValue = std::min(
      minValue,
  ...
  ASSERT_EQ(toString(::ad::map::route::ConnectingRouteType::Merging),
            "::ad::map::route::ConnectingRouteType::Merging");
  minValue = std::min(
      minValue,
  ...
  ASSERT_EQ(toString(static_cast<::ad::map::route::ConnectingRouteType>(
                minValue - 1)),
            "UNKNOWN ENUM VALUE");
  ASSERT_EQ(toString(static_cast<::ad::map::route::ConnectingRouteType>(
                maxValue + 1)),
...
TEST(ConnectingRouteTypeTests, ostreamOperatorTest) {
  ...
  ::ad::map::route::ConnectingRouteType value(
      ::ad::map::route::ConnectingRouteType::Invalid);
  stream << value;
