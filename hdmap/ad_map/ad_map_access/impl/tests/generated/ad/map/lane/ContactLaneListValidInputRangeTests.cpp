...
TEST(ContactLaneListValidInputRangeTests,
...
TEST(ContactLaneListValidInputRangeTests, testValidInputRangeElementValid) {
  ...
  elementRestrictionsConjunctionsElement.negated =
      elementRestrictionsConjunctionsElementNegated;
  ::ad::map::restriction::RoadUserTypeList
      elementRestrictionsConjunctionsElementRoadUserTypes;
  ::ad::map::restriction::RoadUserType
      elementRestrictionsConjunctionsElementRoadUserTypesElement(
  ...
  elementRestrictionsConjunctionsElement.roadUserTypes =
      elementRestrictionsConjunctionsElementRoadUserTypes;
  ::ad::map::restriction::PassengerCount
      elementRestrictionsConjunctionsElementPassengersMin(
          std::numeric_limits<
              ::ad::map::restriction::PassengerCount>::lowest());
  elementRestrictionsConjunctionsElement.passengersMin =
      elementRestrictionsConjunctionsElementPassengersMin;
  elementRestrictionsConjunctions.resize(
      1, elementRestrictionsConjunctionsElement);
  ...
  elementRestrictionsDisjunctionsElement.negated =
      elementRestrictionsDisjunctionsElementNegated;
  ::ad::map::restriction::RoadUserTypeList
      elementRestrictionsDisjunctionsElementRoadUserTypes;
  ::ad::map::restriction::RoadUserType
      elementRestrictionsDisjunctionsElementRoadUserTypesElement(
          ::ad::map::restriction::RoadUserType::INVALID);
  elementRestrictionsDisjunctionsElementRoadUserTypes.resize(
      1, elementRestrictionsDisjunctionsElementRoadUserTypesElement);
  elementRestrictionsDisjunctionsElement.roadUserTypes =
      elementRestrictionsDisjunctionsElementRoadUserTypes;
  ::ad::map::restriction::PassengerCount
      elementRestrictionsDisjunctionsElementPassengersMin(
          std::numeric_limits<
              ::ad::map::restriction::PassengerCount>::lowest());
  elementRestrictionsDisjunctionsElement.passengersMin =
      elementRestrictionsDisjunctionsElementPassengersMin;
  elementRestrictionsDisjunctions.resize(
      1, elementRestrictionsDisjunctionsElement);
  elementRestrictions.disjunctions = elementRestrictionsDisjunctions;
  element.restrictions = elementRestrictions;
  ::ad::map::landmark::LandmarkId elementTrafficLightId(
...
TEST(ContactLaneListValidInputRangeTests, testValidInputRangeElementInvalid) {
  ...
  ::ad::map::lane::ContactLane element;
  ::ad::map::lane::ContactLocation elementLocation(
      static_cast<::ad::map::lane::ContactLocation>(-1));
  element.location = elementLocation;
  value.push_back(element);
