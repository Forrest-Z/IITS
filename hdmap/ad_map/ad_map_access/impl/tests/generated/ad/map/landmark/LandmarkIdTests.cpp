...
TEST(LandmarkIdTests, aboveMinIsValid) {
  ::ad::map::landmark::LandmarkId value(
      ::ad::map::landmark::LandmarkId::cMinValue + 1);
...
TEST(LandmarkIdTests, belowMaxIsValid) {
  ::ad::map::landmark::LandmarkId value(
      ::ad::map::landmark::LandmarkId::cMaxValue - 1);
  EXPECT_TRUE(value.isValid());
}
...
TEST(LandmarkIdTestsStd, numericLimitsLowestIsMin) {
  EXPECT_EQ(
      static_cast<uint64_t>(::ad::map::landmark::LandmarkId::getMin()),
...
TEST(LandmarkIdTests, copyConstructionFromValidValue) {
  ::ad::map::landmark::LandmarkId const validValue(
...
TEST(LandmarkIdTests, moveConstructionFromValidValue) {
  ::ad::map::landmark::LandmarkId validValue(
      ::ad::map::landmark::LandmarkId::cMinValue);
  ::ad::map::landmark::LandmarkId value(std::move(validValue));
  EXPECT_TRUE(value.isValid());
  EXPECT_EQ(::ad::map::landmark::LandmarkId::cMinValue,
...
TEST(LandmarkIdTests, comparisonOperators) {
  ::ad::map::landmark::LandmarkId minValue(
      ::ad::map::landmark::LandmarkId::cMinValue);
  ::ad::map::landmark::LandmarkId maxValue(
