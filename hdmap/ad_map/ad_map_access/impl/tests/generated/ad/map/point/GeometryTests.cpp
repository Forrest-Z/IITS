...
class GeometryTests : public testing::Test {
 protected:
  virtual void SetUp() override {
    ...
    ::ad::map::point::ENUCoordinate valuePrivate_enuEdgeCacheEnuEdgeElementX(
        -16384);
    valuePrivate_enuEdgeCacheEnuEdgeElement.x =
        valuePrivate_enuEdgeCacheEnuEdgeElementX;
    ::ad::map::point::ENUCoordinate valuePrivate_enuEdgeCacheEnuEdgeElementY(
        -16384);
    valuePrivate_enuEdgeCacheEnuEdgeElement.y =
        valuePrivate_enuEdgeCacheEnuEdgeElementY;
    ::ad::map::point::ENUCoordinate valuePrivate_enuEdgeCacheEnuEdgeElementZ(
        -16384);
    valuePrivate_enuEdgeCacheEnuEdgeElement.z =
        valuePrivate_enuEdgeCacheEnuEdgeElementZ;
    valuePrivate_enuEdgeCacheEnuEdge.resize(
        1, valuePrivate_enuEdgeCacheEnuEdgeElement);
    valuePrivate_enuEdgeCache.enuEdge = valuePrivate_enuEdgeCacheEnuEdge;
    uint64_t valuePrivate_enuEdgeCacheEnuVersion{
