...
TEST(ENUHeadingTests, aboveMaxIsInvalid) {
  ::ad::map::point::ENUHeading value(::ad::map::point::ENUHeading::cMaxValue *
                                     1.1);
  EXPECT_FALSE(value.isValid());
}
...
TEST(ENUHeadingTestsStd, numericLimitsLowestIsMin) {
  EXPECT_DOUBLE_EQ(
      static_cast<double>(::ad::map::point::ENUHeading::getMin()),
      static_cast<double>(
...
TEST(ENUHeadingTestsStd, numericLimitsMaxIsMax) {
  EXPECT_DOUBLE_EQ(
      static_cast<double>(::ad::map::point::ENUHeading::getMax()),
      static_cast<double>(
...
TEST(ENUHeadingTestsStd, fabsIsWorkingCorrectly) {
  EXPECT_DOUBLE_EQ(
      0., static_cast<double>(std::fabs(::ad::map::point::ENUHeading(-0.))));
  EXPECT_DOUBLE_EQ(
      1., static_cast<double>(std::fabs(::ad::map::point::ENUHeading(-1.))));
  EXPECT_DOUBLE_EQ(::ad::map::point::ENUHeading::cPrecisionValue,
                   static_cast<double>(std::fabs(::ad::map::point::ENUHeading(
                       ::ad::map::point::ENUHeading::cPrecisionValue))));
...
TEST(ENUHeadingTests, copyConstructionFromValidValue) {
  ::ad::map::point::ENUHeading const validValue(
      ::ad::map::point::ENUHeading::cMinValue);
  ::ad::map::point::ENUHeading value(validValue);
  EXPECT_TRUE(value.isValid());
...
TEST(ENUHeadingTests, moveConstructionFromValidValue) {
  ::ad::map::point::ENUHeading validValue(
      ::ad::map::point::ENUHeading::cMinValue);
  ::ad::map::point::ENUHeading value(std::move(validValue));
  EXPECT_TRUE(value.isValid());
  EXPECT_DOUBLE_EQ(::ad::map::point::ENUHeading::cMinValue,
...
TEST(ENUHeadingTests, comparisonOperatorsThrowOnInvalid) {
  ::ad::map::point::ENUHeading const value(
      ::ad::map::point::ENUHeading::cMinValue);
  ::ad::map::point::ENUHeading const invalidValue;
...
TEST(ENUHeadingTests, arithmeticOperatorsThrowOnInvalid) {
  ::ad::map::point::ENUHeading const minimalValue(
      ::ad::map::point::ENUHeading::cMinValue);
  ::ad::map::point::ENUHeading const maximalValue(
      ::ad::map::point::ENUHeading::cMaxValue);
  ::ad::map::point::ENUHeading const invalidValue;
  ...
  EXPECT_THROW(invalidValue / maximalValue, std::out_of_range);
  EXPECT_THROW(maximalValue / invalidValue, std::out_of_range);
  EXPECT_THROW(maximalValue / ::ad::map::point::ENUHeading(0.0),
               std::out_of_range);
...
TEST(ENUHeadingTests, comparisonOperatorsRespectPrecision) {
  double const precisionValueTimesTen =
      ::ad::map::point::ENUHeading::cPrecisionValue * 10.;
  ::ad::map::point::ENUHeading value;
  if (::ad::map::point::ENUHeading::cMinValue > precisionValueTimesTen) {
    value = ::ad::map::point::ENUHeading(
        ::ad::map::point::ENUHeading::cMinValue + precisionValueTimesTen);
  } else if (::ad::map::point::ENUHeading::cMaxValue < precisionValueTimesTen) {
    value = ::ad::map::point::ENUHeading(
        ::ad::map::point::ENUHeading::cMaxValue - precisionValueTimesTen);
  } else {
    value = ::ad::map::point::ENUHeading(precisionValueTimesTen);
  }
  ::ad::map::point::ENUHeading const sameValue = value;
  ::ad::map::point::ENUHeading const slightlyBiggerValue(
      static_cast<double>(value) +
      ::ad::map::point::ENUHeading::cPrecisionValue * 0.9);
  ::ad::map::point::ENUHeading const slightlySmallerValue(
      static_cast<double>(value) -
      ::ad::map::point::ENUHeading::cPrecisionValue * 0.9);
  ::ad::map::point::ENUHeading const actuallyBiggerValue(
      static_cast<double>(value) +
      ::ad::map::point::ENUHeading::cPrecisionValue * 1.1);
  ::ad::map::point::ENUHeading const actuallySmallerValue(
      static_cast<double>(value) -
      ::ad::map::point::ENUHeading::cPrecisionValue * 1.1);
