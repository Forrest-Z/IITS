...
TEST(MapMatchedPositionConfidenceListValidInputRangeTests,
...
TEST(MapMatchedPositionConfidenceListValidInputRangeTests,
  ...
  elementLanePointParaPoint.parametricOffset =
      elementLanePointParaPointParametricOffset;
  elementLanePoint.paraPoint = elementLanePointParaPoint;
  ::ad::physics::RatioValue elementLanePointLateralT(
  ...
  ::ad::map::match::MapMatchedPositionType elementType(
