...
TEST(ENULandmarkListValidInputRangeTests,
...
TEST(ENULandmarkListValidInputRangeTests, testValidInputRangeElementValid) {
  ...
  ::ad::map::landmark::LandmarkId elementId(
      std::numeric_limits<::ad::map::landmark::LandmarkId>::lowest());
  element.id = elementId;
  ::ad::map::landmark::LandmarkType elementType(
  ...
  ::ad::map::landmark::TrafficLightType elementTrafficLightType(
