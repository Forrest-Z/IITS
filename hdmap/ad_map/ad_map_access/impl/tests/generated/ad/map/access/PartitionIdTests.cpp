...
TEST(PartitionIdTests, minIsDefinedAsExpected) {
  ...
  EXPECT_EQ(::ad::map::access::PartitionId::cMinValue,
            static_cast<uint64_t>(::ad::map::access::PartitionId::getMin()));
}
...
TEST(PartitionIdTests, aboveMinIsValid) {
  ::ad::map::access::PartitionId value(
      ::ad::map::access::PartitionId::cMinValue + 1);
...
TEST(PartitionIdTests, belowMaxIsValid) {
  ::ad::map::access::PartitionId value(
      ::ad::map::access::PartitionId::cMaxValue - 1);
  EXPECT_TRUE(value.isValid());
}
...
TEST(PartitionIdTests, copyConstructionFromValidValue) {
  ::ad::map::access::PartitionId const validValue(
...
TEST(PartitionIdTests, moveConstructionFromValidValue) {
  ::ad::map::access::PartitionId validValue(
      ::ad::map::access::PartitionId::cMinValue);
...
TEST(PartitionIdTests, comparisonOperators) {
  ::ad::map::access::PartitionId minValue(
      ::ad::map::access::PartitionId::cMinValue);
  ::ad::map::access::PartitionId maxValue(
