...
class LaneTests : public testing::Test {
 protected:
  virtual void SetUp() override {
    ...
    ::ad::map::lane::LaneDirection valueDirection(
    ...
    valueRestrictionsConjunctionsElement.negated =
        valueRestrictionsConjunctionsElementNegated;
    ::ad::map::restriction::RoadUserTypeList
        valueRestrictionsConjunctionsElementRoadUserTypes;
    ...
    valueRestrictionsConjunctionsElementRoadUserTypes.resize(
        1, valueRestrictionsConjunctionsElementRoadUserTypesElement);
    valueRestrictionsConjunctionsElement.roadUserTypes =
        valueRestrictionsConjunctionsElementRoadUserTypes;
    ::ad::map::restriction::PassengerCount
        valueRestrictionsConjunctionsElementPassengersMin(
            std::numeric_limits<
                ::ad::map::restriction::PassengerCount>::lowest());
    valueRestrictionsConjunctionsElement.passengersMin =
        valueRestrictionsConjunctionsElementPassengersMin;
    valueRestrictionsConjunctions.resize(1,
                                         valueRestrictionsConjunctionsElement);
    ...
    valueRestrictionsDisjunctionsElement.negated =
        valueRestrictionsDisjunctionsElementNegated;
    ::ad::map::restriction::RoadUserTypeList
        valueRestrictionsDisjunctionsElementRoadUserTypes;
    ::ad::map::restriction::RoadUserType
        valueRestrictionsDisjunctionsElementRoadUserTypesElement(
            ::ad::map::restriction::RoadUserType::INVALID);
    valueRestrictionsDisjunctionsElementRoadUserTypes.resize(
        1, valueRestrictionsDisjunctionsElementRoadUserTypesElement);
    valueRestrictionsDisjunctionsElement.roadUserTypes =
        valueRestrictionsDisjunctionsElementRoadUserTypes;
    ::ad::map::restriction::PassengerCount
        valueRestrictionsDisjunctionsElementPassengersMin(
            std::numeric_limits<
                ::ad::map::restriction::PassengerCount>::lowest());
    valueRestrictionsDisjunctionsElement.passengersMin =
        valueRestrictionsDisjunctionsElementPassengersMin;
    valueRestrictionsDisjunctions.resize(1,
                                         valueRestrictionsDisjunctionsElement);
    ...
    valueSpeedLimitsElementLanePiece.minimum =
        valueSpeedLimitsElementLanePieceMinimum;
    ::ad::physics::ParametricValue valueSpeedLimitsElementLanePieceMaximum(0.);
    valueSpeedLimitsElementLanePiece.maximum =
        valueSpeedLimitsElementLanePieceMaximum;
    valueSpeedLimitsElementLanePiece.maximum =
        valueSpeedLimitsElementLanePiece.minimum;
    valueSpeedLimitsElementLanePiece.minimum =
        valueSpeedLimitsElementLanePiece.maximum;
    ...
    ::ad::map::point::ENUCoordinate
        valueEdgeLeftPrivate_enuEdgeCacheEnuEdgeElementX(-16384);
    valueEdgeLeftPrivate_enuEdgeCacheEnuEdgeElement.x =
        valueEdgeLeftPrivate_enuEdgeCacheEnuEdgeElementX;
    ::ad::map::point::ENUCoordinate
        valueEdgeLeftPrivate_enuEdgeCacheEnuEdgeElementY(-16384);
    valueEdgeLeftPrivate_enuEdgeCacheEnuEdgeElement.y =
        valueEdgeLeftPrivate_enuEdgeCacheEnuEdgeElementY;
    ::ad::map::point::ENUCoordinate
        valueEdgeLeftPrivate_enuEdgeCacheEnuEdgeElementZ(-16384);
    valueEdgeLeftPrivate_enuEdgeCacheEnuEdgeElement.z =
        valueEdgeLeftPrivate_enuEdgeCacheEnuEdgeElementZ;
    valueEdgeLeftPrivate_enuEdgeCacheEnuEdge.resize(
        1, valueEdgeLeftPrivate_enuEdgeCacheEnuEdgeElement);
    valueEdgeLeftPrivate_enuEdgeCache.enuEdge =
        valueEdgeLeftPrivate_enuEdgeCacheEnuEdge;
    uint64_t valueEdgeLeftPrivate_enuEdgeCacheEnuVersion{
        std::numeric_limits<uint64_t>::min()};
    valueEdgeLeftPrivate_enuEdgeCache.enuVersion =
        valueEdgeLeftPrivate_enuEdgeCacheEnuVersion;
    ...
    ::ad::map::point::ENUCoordinate
        valueEdgeRightPrivate_enuEdgeCacheEnuEdgeElementX(-16384);
    valueEdgeRightPrivate_enuEdgeCacheEnuEdgeElement.x =
        valueEdgeRightPrivate_enuEdgeCacheEnuEdgeElementX;
    ::ad::map::point::ENUCoordinate
        valueEdgeRightPrivate_enuEdgeCacheEnuEdgeElementY(-16384);
    valueEdgeRightPrivate_enuEdgeCacheEnuEdgeElement.y =
        valueEdgeRightPrivate_enuEdgeCacheEnuEdgeElementY;
    ::ad::map::point::ENUCoordinate
        valueEdgeRightPrivate_enuEdgeCacheEnuEdgeElementZ(-16384);
    valueEdgeRightPrivate_enuEdgeCacheEnuEdgeElement.z =
        valueEdgeRightPrivate_enuEdgeCacheEnuEdgeElementZ;
    valueEdgeRightPrivate_enuEdgeCacheEnuEdge.resize(
        1, valueEdgeRightPrivate_enuEdgeCacheEnuEdgeElement);
    valueEdgeRightPrivate_enuEdgeCache.enuEdge =
        valueEdgeRightPrivate_enuEdgeCacheEnuEdge;
    uint64_t valueEdgeRightPrivate_enuEdgeCacheEnuVersion{
        std::numeric_limits<uint64_t>::min()};
    valueEdgeRightPrivate_enuEdgeCache.enuVersion =
        valueEdgeRightPrivate_enuEdgeCacheEnuVersion;
    ...
    ::ad::map::lane::ContactLocation valueContactLanesElementLocation(
    ...
    ::ad::map::lane::ContactType valueContactLanesElementTypesElement(
        ::ad::map::lane::ContactType::INVALID);
    valueContactLanesElementTypes.resize(1,
                                         valueContactLanesElementTypesElement);
    ...
    ::ad::map::restriction::RestrictionList
        valueContactLanesElementRestrictionsConjunctions;
    ::ad::map::restriction::Restriction
        valueContactLanesElementRestrictionsConjunctionsElement;
    ...
    ::ad::map::restriction::RoadUserType
        valueContactLanesElementRestrictionsConjunctionsElementRoadUserTypesElement(
            ::ad::map::restriction::RoadUserType::INVALID);
    ...
    valueContactLanesElementRestrictionsConjunctionsElement.passengersMin =
        valueContactLanesElementRestrictionsConjunctionsElementPassengersMin;
    valueContactLanesElementRestrictionsConjunctions.resize(
        1, valueContactLanesElementRestrictionsConjunctionsElement);
    valueContactLanesElementRestrictions.conjunctions =
        valueContactLanesElementRestrictionsConjunctions;
    ::ad::map::restriction::RestrictionList
        valueContactLanesElementRestrictionsDisjunctions;
    ::ad::map::restriction::Restriction
        valueContactLanesElementRestrictionsDisjunctionsElement;
    ...
    ::ad::map::restriction::RoadUserType
        valueContactLanesElementRestrictionsDisjunctionsElementRoadUserTypesElement(
            ::ad::map::restriction::RoadUserType::INVALID);
    ...
    valueContactLanesElementRestrictionsDisjunctionsElement.passengersMin =
        valueContactLanesElementRestrictionsDisjunctionsElementPassengersMin;
    valueContactLanesElementRestrictionsDisjunctions.resize(
        1, valueContactLanesElementRestrictionsDisjunctionsElement);
    valueContactLanesElementRestrictions.disjunctions =
        valueContactLanesElementRestrictionsDisjunctions;
    valueContactLanesElement.restrictions =
        valueContactLanesElementRestrictions;
    ::ad::map::landmark::LandmarkId valueContactLanesElementTrafficLightId(
        std::numeric_limits<::ad::map::landmark::LandmarkId>::lowest());
    valueContactLanesElement.trafficLightId =
        valueContactLanesElementTrafficLightId;
...
TEST_F(LaneTests, comparisonOperatorRestrictionsDiffers) {
  ...
  restrictionsConjunctionsElement.negated =
      restrictionsConjunctionsElementNegated;
  ::ad::map::restriction::RoadUserTypeList
      restrictionsConjunctionsElementRoadUserTypes;
  ::ad::map::restriction::RoadUserType
      restrictionsConjunctionsElementRoadUserTypesElement(
          ::ad::map::restriction::RoadUserType::CAR_DIESEL);
  restrictionsConjunctionsElementRoadUserTypes.resize(
      2, restrictionsConjunctionsElementRoadUserTypesElement);
  restrictionsConjunctionsElement.roadUserTypes =
      restrictionsConjunctionsElementRoadUserTypes;
  ::ad::map::restriction::PassengerCount
      restrictionsConjunctionsElementPassengersMin(
          std::numeric_limits<::ad::map::restriction::PassengerCount>::max());
  restrictionsConjunctionsElement.passengersMin =
      restrictionsConjunctionsElementPassengersMin;
  ...
  restrictionsDisjunctionsElement.negated =
      restrictionsDisjunctionsElementNegated;
  ::ad::map::restriction::RoadUserTypeList
      restrictionsDisjunctionsElementRoadUserTypes;
  ::ad::map::restriction::RoadUserType
      restrictionsDisjunctionsElementRoadUserTypesElement(
          ::ad::map::restriction::RoadUserType::CAR_DIESEL);
  restrictionsDisjunctionsElementRoadUserTypes.resize(
      2, restrictionsDisjunctionsElementRoadUserTypesElement);
  restrictionsDisjunctionsElement.roadUserTypes =
      restrictionsDisjunctionsElementRoadUserTypes;
  ::ad::map::restriction::PassengerCount
      restrictionsDisjunctionsElementPassengersMin(
          std::numeric_limits<::ad::map::restriction::PassengerCount>::max());
  restrictionsDisjunctionsElement.passengersMin =
      restrictionsDisjunctionsElementPassengersMin;
...
TEST_F(LaneTests, comparisonOperatorEdgeLeftDiffers) {
  ...
  ::ad::map::point::ENUCoordinate edgeLeftPrivate_enuEdgeCacheEnuEdgeElementX(
      16384);
  edgeLeftPrivate_enuEdgeCacheEnuEdgeElement.x =
      edgeLeftPrivate_enuEdgeCacheEnuEdgeElementX;
  ::ad::map::point::ENUCoordinate edgeLeftPrivate_enuEdgeCacheEnuEdgeElementY(
      16384);
  edgeLeftPrivate_enuEdgeCacheEnuEdgeElement.y =
      edgeLeftPrivate_enuEdgeCacheEnuEdgeElementY;
  ::ad::map::point::ENUCoordinate edgeLeftPrivate_enuEdgeCacheEnuEdgeElementZ(
      16384);
  edgeLeftPrivate_enuEdgeCacheEnuEdgeElement.z =
      edgeLeftPrivate_enuEdgeCacheEnuEdgeElementZ;
  edgeLeftPrivate_enuEdgeCacheEnuEdge.resize(
      2, edgeLeftPrivate_enuEdgeCacheEnuEdgeElement);
  edgeLeftPrivate_enuEdgeCache.enuEdge = edgeLeftPrivate_enuEdgeCacheEnuEdge;
  uint64_t edgeLeftPrivate_enuEdgeCacheEnuVersion{
      std::numeric_limits<uint64_t>::max()};
  edgeLeftPrivate_enuEdgeCache.enuVersion =
      edgeLeftPrivate_enuEdgeCacheEnuVersion;
...
TEST_F(LaneTests, comparisonOperatorEdgeRightDiffers) {
  ...
  ::ad::map::point::ENUCoordinate edgeRightPrivate_enuEdgeCacheEnuEdgeElementX(
      16384);
  edgeRightPrivate_enuEdgeCacheEnuEdgeElement.x =
      edgeRightPrivate_enuEdgeCacheEnuEdgeElementX;
  ::ad::map::point::ENUCoordinate edgeRightPrivate_enuEdgeCacheEnuEdgeElementY(
      16384);
  edgeRightPrivate_enuEdgeCacheEnuEdgeElement.y =
      edgeRightPrivate_enuEdgeCacheEnuEdgeElementY;
  ::ad::map::point::ENUCoordinate edgeRightPrivate_enuEdgeCacheEnuEdgeElementZ(
      16384);
  edgeRightPrivate_enuEdgeCacheEnuEdgeElement.z =
      edgeRightPrivate_enuEdgeCacheEnuEdgeElementZ;
  edgeRightPrivate_enuEdgeCacheEnuEdge.resize(
      2, edgeRightPrivate_enuEdgeCacheEnuEdgeElement);
  edgeRightPrivate_enuEdgeCache.enuEdge = edgeRightPrivate_enuEdgeCacheEnuEdge;
  uint64_t edgeRightPrivate_enuEdgeCacheEnuVersion{
      std::numeric_limits<uint64_t>::max()};
  edgeRightPrivate_enuEdgeCache.enuVersion =
      edgeRightPrivate_enuEdgeCacheEnuVersion;
...
TEST_F(LaneTests, comparisonOperatorContactLanesDiffers) {
  ...
  ::ad::map::lane::LaneId contactLanesElementToLane(
      std::numeric_limits<::ad::map::lane::LaneId>::max());
  contactLanesElement.toLane = contactLanesElementToLane;
  ::ad::map::lane::ContactLocation contactLanesElementLocation(
  ...
  ::ad::map::restriction::RestrictionList
      contactLanesElementRestrictionsConjunctions;
  ::ad::map::restriction::Restriction
      contactLanesElementRestrictionsConjunctionsElement;
  ...
  ::ad::map::restriction::RoadUserType
      contactLanesElementRestrictionsConjunctionsElementRoadUserTypesElement(
          ::ad::map::restriction::RoadUserType::CAR_DIESEL);
  ...
  contactLanesElementRestrictionsConjunctionsElement.passengersMin =
      contactLanesElementRestrictionsConjunctionsElementPassengersMin;
  contactLanesElementRestrictionsConjunctions.resize(
      2, contactLanesElementRestrictionsConjunctionsElement);
  contactLanesElementRestrictions.conjunctions =
      contactLanesElementRestrictionsConjunctions;
  ::ad::map::restriction::RestrictionList
      contactLanesElementRestrictionsDisjunctions;
  ::ad::map::restriction::Restriction
      contactLanesElementRestrictionsDisjunctionsElement;
  ...
  ::ad::map::restriction::RoadUserType
      contactLanesElementRestrictionsDisjunctionsElementRoadUserTypesElement(
          ::ad::map::restriction::RoadUserType::CAR_DIESEL);
  ...
  contactLanesElementRestrictionsDisjunctionsElement.passengersMin =
      contactLanesElementRestrictionsDisjunctionsElementPassengersMin;
  contactLanesElementRestrictionsDisjunctions.resize(
      2, contactLanesElementRestrictionsDisjunctionsElement);
  contactLanesElementRestrictions.disjunctions =
      contactLanesElementRestrictionsDisjunctions;
...
TEST_F(LaneTests, comparisonOperatorComplianceVersionDiffers) {
  ...
  ::ad::map::lane::ComplianceVersion complianceVersion(
      std::numeric_limits<::ad::map::lane::ComplianceVersion>::max());
...
TEST_F(LaneTests, comparisonOperatorVisibleLandmarksDiffers) {
  ...
  ::ad::map::landmark::LandmarkId visibleLandmarksElement(
      std::numeric_limits<::ad::map::landmark::LandmarkId>::max());
