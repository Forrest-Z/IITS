...
class FullRouteTests : public testing::Test {
 protected:
  virtual void SetUp() override {
    ...
    ::ad::map::lane::LaneId
        valueRoadSegmentsElementDrivableLaneSegmentsElementLeftNeighbor(1);
    ...
    ::ad::map::lane::LaneId
        valueRoadSegmentsElementDrivableLaneSegmentsElementRightNeighbor(1);
    ...
    ::ad::map::lane::LaneId
        valueRoadSegmentsElementDrivableLaneSegmentsElementPredecessorsElement(
            1);
    ...
    ::ad::map::lane::LaneId
        valueRoadSegmentsElementDrivableLaneSegmentsElementSuccessorsElement(1);
    valueRoadSegmentsElementDrivableLaneSegmentsElementSuccessors.resize(
        1,
        valueRoadSegmentsElementDrivableLaneSegmentsElementSuccessorsElement);
    ...
    valueRoadSegmentsElementDrivableLaneSegmentsElementLaneInterval.start =
        valueRoadSegmentsElementDrivableLaneSegmentsElementLaneIntervalStart;
    ::ad::physics::ParametricValue
        valueRoadSegmentsElementDrivableLaneSegmentsElementLaneIntervalEnd(0.);
    ...
    valueRoadSegmentsElementDrivableLaneSegmentsElement.routeLaneOffset =
        valueRoadSegmentsElementDrivableLaneSegmentsElementRouteLaneOffset;
    valueRoadSegmentsElementDrivableLaneSegments.resize(
        1, valueRoadSegmentsElementDrivableLaneSegmentsElement);
    valueRoadSegmentsElement.drivableLaneSegments =
        valueRoadSegmentsElementDrivableLaneSegments;
    ::ad::map::route::SegmentCounter
        valueRoadSegmentsElementSegmentCountFromDestination(
            std::numeric_limits<::ad::map::route::SegmentCounter>::lowest());
    valueRoadSegmentsElement.segmentCountFromDestination =
        valueRoadSegmentsElementSegmentCountFromDestination;
    ...
    ::ad::map::point::ECEFCoordinate
        valueRoadSegmentsElementBoundingSphereCenterX(-6400000);
    valueRoadSegmentsElementBoundingSphereCenter.x =
        valueRoadSegmentsElementBoundingSphereCenterX;
    ::ad::map::point::ECEFCoordinate
        valueRoadSegmentsElementBoundingSphereCenterY(-6400000);
    valueRoadSegmentsElementBoundingSphereCenter.y =
        valueRoadSegmentsElementBoundingSphereCenterY;
    ::ad::map::point::ECEFCoordinate
        valueRoadSegmentsElementBoundingSphereCenterZ(-6400000);
    valueRoadSegmentsElementBoundingSphereCenter.z =
        valueRoadSegmentsElementBoundingSphereCenterZ;
    valueRoadSegmentsElementBoundingSphere.center =
        valueRoadSegmentsElementBoundingSphereCenter;
    ::ad::physics::Distance valueRoadSegmentsElementBoundingSphereRadius(-1e9);
    valueRoadSegmentsElementBoundingSphere.radius =
        valueRoadSegmentsElementBoundingSphereRadius;
    valueRoadSegmentsElement.boundingSphere =
        valueRoadSegmentsElementBoundingSphere;
    ...
    ::ad::map::route::RouteCreationMode valueRouteCreationMode(
...
TEST_F(FullRouteTests, comparisonOperatorRoadSegmentsDiffers) {
  ...
  ::ad::map::lane::LaneId
      roadSegmentsElementDrivableLaneSegmentsElementPredecessorsElement(
          std::numeric_limits<::ad::map::lane::LaneId>::max());
  ...
  roadSegmentsElementDrivableLaneSegmentsElement.predecessors =
      roadSegmentsElementDrivableLaneSegmentsElementPredecessors;
  ::ad::map::lane::LaneIdList
      roadSegmentsElementDrivableLaneSegmentsElementSuccessors;
  ::ad::map::lane::LaneId
      roadSegmentsElementDrivableLaneSegmentsElementSuccessorsElement(
          std::numeric_limits<::ad::map::lane::LaneId>::max());
  ...
  roadSegmentsElementDrivableLaneSegmentsElement.successors =
      roadSegmentsElementDrivableLaneSegmentsElementSuccessors;
  ::ad::map::route::LaneInterval
  ...
  roadSegmentsElementDrivableLaneSegmentsElementLaneInterval.laneId =
      roadSegmentsElementDrivableLaneSegmentsElementLaneIntervalLaneId;
  ::ad::physics::ParametricValue
      roadSegmentsElementDrivableLaneSegmentsElementLaneIntervalStart(1.);
  ...
  ::ad::physics::ParametricValue
      roadSegmentsElementDrivableLaneSegmentsElementLaneIntervalEnd(1.);
  ...
  bool roadSegmentsElementDrivableLaneSegmentsElementLaneIntervalWrongWay{
      false};
  ...
  roadSegmentsElementDrivableLaneSegmentsElement.routeLaneOffset =
      roadSegmentsElementDrivableLaneSegmentsElementRouteLaneOffset;
  roadSegmentsElementDrivableLaneSegments.resize(
      2, roadSegmentsElementDrivableLaneSegmentsElement);
  roadSegmentsElement.drivableLaneSegments =
      roadSegmentsElementDrivableLaneSegments;
  ::ad::map::route::SegmentCounter
      roadSegmentsElementSegmentCountFromDestination(
          std::numeric_limits<::ad::map::route::SegmentCounter>::max());
  roadSegmentsElement.segmentCountFromDestination =
      roadSegmentsElementSegmentCountFromDestination;
  ...
  ::ad::map::point::ECEFCoordinate roadSegmentsElementBoundingSphereCenterX(
      6400000);
  roadSegmentsElementBoundingSphereCenter.x =
      roadSegmentsElementBoundingSphereCenterX;
  ::ad::map::point::ECEFCoordinate roadSegmentsElementBoundingSphereCenterY(
      6400000);
  roadSegmentsElementBoundingSphereCenter.y =
      roadSegmentsElementBoundingSphereCenterY;
  ::ad::map::point::ECEFCoordinate roadSegmentsElementBoundingSphereCenterZ(
      6400000);
  roadSegmentsElementBoundingSphereCenter.z =
      roadSegmentsElementBoundingSphereCenterZ;
  roadSegmentsElementBoundingSphere.center =
      roadSegmentsElementBoundingSphereCenter;
  ::ad::physics::Distance roadSegmentsElementBoundingSphereRadius(1e9);
  roadSegmentsElementBoundingSphere.radius =
      roadSegmentsElementBoundingSphereRadius;
...
TEST_F(FullRouteTests, comparisonOperatorFullRouteSegmentCountDiffers) {
  ::ad::map::route::FullRoute valueA = mValue;
  ::ad::map::route::SegmentCounter fullRouteSegmentCount(
      std::numeric_limits<::ad::map::route::SegmentCounter>::max());
