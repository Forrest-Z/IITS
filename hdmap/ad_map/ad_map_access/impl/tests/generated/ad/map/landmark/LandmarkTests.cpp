 ...
 protected:
  virtual void SetUp() override {
    ...
    ::ad::map::point::ENUPoint
        valueBoundingBoxPrivate_enuEdgeCacheEnuEdgeElement;
    ::ad::map::point::ENUCoordinate
        valueBoundingBoxPrivate_enuEdgeCacheEnuEdgeElementX(-16384);
    valueBoundingBoxPrivate_enuEdgeCacheEnuEdgeElement.x =
        valueBoundingBoxPrivate_enuEdgeCacheEnuEdgeElementX;
    ::ad::map::point::ENUCoordinate
        valueBoundingBoxPrivate_enuEdgeCacheEnuEdgeElementY(-16384);
    valueBoundingBoxPrivate_enuEdgeCacheEnuEdgeElement.y =
        valueBoundingBoxPrivate_enuEdgeCacheEnuEdgeElementY;
    ::ad::map::point::ENUCoordinate
        valueBoundingBoxPrivate_enuEdgeCacheEnuEdgeElementZ(-16384);
    valueBoundingBoxPrivate_enuEdgeCacheEnuEdgeElement.z =
        valueBoundingBoxPrivate_enuEdgeCacheEnuEdgeElementZ;
    valueBoundingBoxPrivate_enuEdgeCacheEnuEdge.resize(
        1, valueBoundingBoxPrivate_enuEdgeCacheEnuEdgeElement);
    valueBoundingBoxPrivate_enuEdgeCache.enuEdge =
        valueBoundingBoxPrivate_enuEdgeCacheEnuEdge;
    uint64_t valueBoundingBoxPrivate_enuEdgeCacheEnuVersion{
        std::numeric_limits<uint64_t>::min()};
    valueBoundingBoxPrivate_enuEdgeCache.enuVersion =
        valueBoundingBoxPrivate_enuEdgeCacheEnuVersion;
    valueBoundingBox.private_enuEdgeCache =
        valueBoundingBoxPrivate_enuEdgeCache;
    ...
    ::ad::map::landmark::TrafficSignType valueTrafficSignType(
...
TEST_F(LandmarkTests, comparisonOperatorBoundingBoxDiffers) {
  ...
  ::ad::map::point::ENUCoordinate
      boundingBoxPrivate_enuEdgeCacheEnuEdgeElementX(16384);
  boundingBoxPrivate_enuEdgeCacheEnuEdgeElement.x =
      boundingBoxPrivate_enuEdgeCacheEnuEdgeElementX;
  ::ad::map::point::ENUCoordinate
      boundingBoxPrivate_enuEdgeCacheEnuEdgeElementY(16384);
  boundingBoxPrivate_enuEdgeCacheEnuEdgeElement.y =
      boundingBoxPrivate_enuEdgeCacheEnuEdgeElementY;
  ::ad::map::point::ENUCoordinate
      boundingBoxPrivate_enuEdgeCacheEnuEdgeElementZ(16384);
  boundingBoxPrivate_enuEdgeCacheEnuEdgeElement.z =
      boundingBoxPrivate_enuEdgeCacheEnuEdgeElementZ;
  boundingBoxPrivate_enuEdgeCacheEnuEdge.resize(
      2, boundingBoxPrivate_enuEdgeCacheEnuEdgeElement);
  boundingBoxPrivate_enuEdgeCache.enuEdge =
      boundingBoxPrivate_enuEdgeCacheEnuEdge;
  uint64_t boundingBoxPrivate_enuEdgeCacheEnuVersion{
      std::numeric_limits<uint64_t>::max()};
  boundingBoxPrivate_enuEdgeCache.enuVersion =
      boundingBoxPrivate_enuEdgeCacheEnuVersion;
