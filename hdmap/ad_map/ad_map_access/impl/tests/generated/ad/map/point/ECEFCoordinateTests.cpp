...
TEST(ECEFCoordinateTests, aboveMinIsValid) {
  ::ad::map::point::ECEFCoordinate value(
      ::ad::map::point::ECEFCoordinate::cMinValue * 0.9);
  EXPECT_TRUE(value.isValid());
}

TEST(ECEFCoordinateTests, belowMinIsInvalid) {
  ::ad::map::point::ECEFCoordinate value(
      ::ad::map::point::ECEFCoordinate::cMinValue * 1.1);
  EXPECT_FALSE(value.isValid());
}
...
TEST(ECEFCoordinateTests, aboveMaxIsInvalid) {
  ::ad::map::point::ECEFCoordinate value(
      ::ad::map::point::ECEFCoordinate::cMaxValue * 1.1);
  EXPECT_FALSE(value.isValid());
}

TEST(ECEFCoordinateTests, belowMaxIsValid) {
  ::ad::map::point::ECEFCoordinate value(
      ::ad::map::point::ECEFCoordinate::cMaxValue * 0.9);
  EXPECT_TRUE(value.isValid());
}
...
TEST(ECEFCoordinateTestsStd, fabsIsWorkingCorrectly) {
  EXPECT_DOUBLE_EQ(0., static_cast<double>(
                           std::fabs(::ad::map::point::ECEFCoordinate(-0.))));
  EXPECT_DOUBLE_EQ(1., static_cast<double>(
                           std::fabs(::ad::map::point::ECEFCoordinate(-1.))));
  EXPECT_DOUBLE_EQ(
      ::ad::map::point::ECEFCoordinate::cPrecisionValue,
      static_cast<double>(std::fabs(::ad::map::point::ECEFCoordinate(
          ::ad::map::point::ECEFCoordinate::cPrecisionValue))));
  EXPECT_DOUBLE_EQ(
...
TEST(ECEFCoordinateTests, copyConstructionFromValidValue) {
  ::ad::map::point::ECEFCoordinate const validValue(
      ::ad::map::point::ECEFCoordinate::cMinValue);
  ::ad::map::point::ECEFCoordinate value(validValue);
  EXPECT_TRUE(value.isValid());
...
TEST(ECEFCoordinateTests, moveConstructionFromValidValue) {
  ::ad::map::point::ECEFCoordinate validValue(
      ::ad::map::point::ECEFCoordinate::cMinValue);
...
TEST(ECEFCoordinateTests, comparisonOperatorsThrowOnInvalid) {
  ::ad::map::point::ECEFCoordinate const value(
      ::ad::map::point::ECEFCoordinate::cMinValue);
  ::ad::map::point::ECEFCoordinate const invalidValue;
...
TEST(ECEFCoordinateTests, arithmeticOperatorsThrowOnInvalid) {
  ::ad::map::point::ECEFCoordinate const minimalValue(
      ::ad::map::point::ECEFCoordinate::cMinValue);
  ::ad::map::point::ECEFCoordinate const maximalValue(
      ::ad::map::point::ECEFCoordinate::cMaxValue);
  ::ad::map::point::ECEFCoordinate const invalidValue;
  ...
  EXPECT_THROW(invalidValue / maximalValue, std::out_of_range);
  EXPECT_THROW(maximalValue / invalidValue, std::out_of_range);
  EXPECT_THROW(maximalValue / ::ad::map::point::ECEFCoordinate(0.0),
               std::out_of_range);
...
TEST(ECEFCoordinateTests, comparisonOperatorsRespectPrecision) {
  double const precisionValueTimesTen =
      ::ad::map::point::ECEFCoordinate::cPrecisionValue * 10.;
  ::ad::map::point::ECEFCoordinate value;
  if (::ad::map::point::ECEFCoordinate::cMinValue > precisionValueTimesTen) {
    value = ::ad::map::point::ECEFCoordinate(
        ::ad::map::point::ECEFCoordinate::cMinValue + precisionValueTimesTen);
  } else if (::ad::map::point::ECEFCoordinate::cMaxValue <
             precisionValueTimesTen) {
    value = ::ad::map::point::ECEFCoordinate(
        ::ad::map::point::ECEFCoordinate::cMaxValue - precisionValueTimesTen);
  } else {
    value = ::ad::map::point::ECEFCoordinate(precisionValueTimesTen);
  }
  ::ad::map::point::ECEFCoordinate const sameValue = value;
  ::ad::map::point::ECEFCoordinate const slightlyBiggerValue(
      static_cast<double>(value) +
      ::ad::map::point::ECEFCoordinate::cPrecisionValue * 0.9);
  ::ad::map::point::ECEFCoordinate const slightlySmallerValue(
      static_cast<double>(value) -
      ::ad::map::point::ECEFCoordinate::cPrecisionValue * 0.9);
  ::ad::map::point::ECEFCoordinate const actuallyBiggerValue(
      static_cast<double>(value) +
...
TEST(ECEFCoordinateTests, arithmeticOperatorsComputeCorrectly) {
  ...
  //  operator-()
  if ((::ad::map::point::ECEFCoordinate::cMinValue <
       -static_cast<double>(value)) &&
      (-static_cast<double>(value) <
       ::ad::map::point::ECEFCoordinate::cMaxValue)) {
    result = -value;
