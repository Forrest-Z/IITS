...
TEST(TrafficLightTypeTests, testFromString) {
  ...
  ASSERT_EQ(
      fromString<::ad::map::landmark::TrafficLightType>("SOLID_RED_YELLOW"),
  ...
  ASSERT_EQ(
      fromString<::ad::map::landmark::TrafficLightType>(
          "::ad::map::landmark::TrafficLightType::SOLID_RED_YELLOW_GREEN"),
      ::ad::map::landmark::TrafficLightType::SOLID_RED_YELLOW_GREEN);
  ...
  ASSERT_EQ(
      fromString<::ad::map::landmark::TrafficLightType>("PEDESTRIAN_RED_GREEN"),
...
TEST(TrafficLightTypeTests, testToString) {
  ...
  ASSERT_EQ(toString(::ad::map::landmark::TrafficLightType::INVALID),
            "::ad::map::landmark::TrafficLightType::INVALID");
  minValue = std::min(
      minValue,
      static_cast<int32_t>(::ad::map::landmark::TrafficLightType::INVALID));
  maxValue = std::max(
      maxValue,
      static_cast<int32_t>(::ad::map::landmark::TrafficLightType::INVALID));

  ASSERT_EQ(toString(::ad::map::landmark::TrafficLightType::UNKNOWN),
            "::ad::map::landmark::TrafficLightType::UNKNOWN");
  minValue = std::min(
      minValue,
      static_cast<int32_t>(::ad::map::landmark::TrafficLightType::UNKNOWN));
  maxValue = std::max(
      maxValue,
      static_cast<int32_t>(::ad::map::landmark::TrafficLightType::UNKNOWN));
  ...
  ASSERT_EQ(
      toString(::ad::map::landmark::TrafficLightType::SOLID_RED_YELLOW_GREEN),
      "::ad::map::landmark::TrafficLightType::SOLID_RED_YELLOW_GREEN");
  minValue = std::min(
      minValue,
      static_cast<int32_t>(
  ...
  ASSERT_EQ(
      toString(::ad::map::landmark::TrafficLightType::LEFT_RED_YELLOW_GREEN),
      "::ad::map::landmark::TrafficLightType::LEFT_RED_YELLOW_GREEN");
  minValue = std::min(
      minValue,
      static_cast<int32_t>(
  ...
  ASSERT_EQ(
      toString(::ad::map::landmark::TrafficLightType::RIGHT_RED_YELLOW_GREEN),
      "::ad::map::landmark::TrafficLightType::RIGHT_RED_YELLOW_GREEN");
  minValue = std::min(
      minValue,
      static_cast<int32_t>(
  ...
  ASSERT_EQ(
      toString(::ad::map::landmark::TrafficLightType::
                   LEFT_STRAIGHT_RED_YELLOW_GREEN),
      "::ad::map::landmark::TrafficLightType::LEFT_STRAIGHT_RED_YELLOW_GREEN");
  minValue = std::min(
      minValue, static_cast<int32_t>(::ad::map::landmark::TrafficLightType::
                                         LEFT_STRAIGHT_RED_YELLOW_GREEN));
  maxValue = std::max(
      maxValue, static_cast<int32_t>(::ad::map::landmark::TrafficLightType::
                                         LEFT_STRAIGHT_RED_YELLOW_GREEN));
  ...
  ASSERT_EQ(
      toString(::ad::map::landmark::TrafficLightType::PEDESTRIAN_RED_GREEN),
      "::ad::map::landmark::TrafficLightType::PEDESTRIAN_RED_GREEN");
  minValue = std::min(
      minValue,
      static_cast<int32_t>(
  ...
  ASSERT_EQ(
      toString(::ad::map::landmark::TrafficLightType::BIKE_RED_YELLOW_GREEN),
      "::ad::map::landmark::TrafficLightType::BIKE_RED_YELLOW_GREEN");
  minValue = std::min(
      minValue,
      static_cast<int32_t>(
  ...
  ASSERT_EQ(toString(::ad::map::landmark::TrafficLightType::
                         BIKE_PEDESTRIAN_RED_YELLOW_GREEN),
            "::ad::map::landmark::TrafficLightType::BIKE_PEDESTRIAN_RED_YELLOW_"
            "GREEN");
  minValue = std::min(
  ...
  ASSERT_EQ(toString(static_cast<::ad::map::landmark::TrafficLightType>(
                minValue - 1)),
            "UNKNOWN ENUM VALUE");
  ASSERT_EQ(toString(static_cast<::ad::map::landmark::TrafficLightType>(
                maxValue + 1)),
...
TEST(TrafficLightTypeTests, ostreamOperatorTest) {
  ...
  ::ad::map::landmark::TrafficLightType value(
      ::ad::map::landmark::TrafficLightType::INVALID);
  stream << value;
