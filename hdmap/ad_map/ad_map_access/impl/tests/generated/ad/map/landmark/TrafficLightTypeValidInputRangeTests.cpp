...
TEST(TrafficLightTypeValidInputRangeTests, testValidInputRangeValid) {
  ASSERT_TRUE(
      withinValidInputRange(::ad::map::landmark::TrafficLightType::INVALID));
  ASSERT_TRUE(
      withinValidInputRange(::ad::map::landmark::TrafficLightType::UNKNOWN));
...
TEST(TrafficLightTypeValidInputRangeTests, testValidInputRangeInvalid) {
  ...
  ASSERT_FALSE(withinValidInputRange(
      static_cast<::ad::map::landmark::TrafficLightType>(minValue - 1)));
}
