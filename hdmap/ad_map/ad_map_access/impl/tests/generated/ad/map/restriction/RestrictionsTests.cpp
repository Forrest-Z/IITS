 ...
 protected:
  virtual void SetUp() override {
    ...
    ::ad::map::restriction::RoadUserTypeList
        valueConjunctionsElementRoadUserTypes;
    ::ad::map::restriction::RoadUserType
        valueConjunctionsElementRoadUserTypesElement(
            ::ad::map::restriction::RoadUserType::INVALID);
    valueConjunctionsElementRoadUserTypes.resize(
        1, valueConjunctionsElementRoadUserTypesElement);
    valueConjunctionsElement.roadUserTypes =
        valueConjunctionsElementRoadUserTypes;
    ::ad::map::restriction::PassengerCount
        valueConjunctionsElementPassengersMin(
            std::numeric_limits<
                ::ad::map::restriction::PassengerCount>::lowest());
    valueConjunctionsElement.passengersMin =
        valueConjunctionsElementPassengersMin;
    ...
    ::ad::map::restriction::RoadUserType
        valueDisjunctionsElementRoadUserTypesElement(
            ::ad::map::restriction::RoadUserType::INVALID);
    valueDisjunctionsElementRoadUserTypes.resize(
        1, valueDisjunctionsElementRoadUserTypesElement);
    valueDisjunctionsElement.roadUserTypes =
        valueDisjunctionsElementRoadUserTypes;
    ::ad::map::restriction::PassengerCount
        valueDisjunctionsElementPassengersMin(
            std::numeric_limits<
                ::ad::map::restriction::PassengerCount>::lowest());
    valueDisjunctionsElement.passengersMin =
        valueDisjunctionsElementPassengersMin;
...
TEST_F(RestrictionsTests, comparisonOperatorConjunctionsDiffers) {
  ...
  conjunctionsElementRoadUserTypes.resize(
      2, conjunctionsElementRoadUserTypesElement);
...
TEST_F(RestrictionsTests, comparisonOperatorDisjunctionsDiffers) {
  ...
  ::ad::map::restriction::RoadUserType disjunctionsElementRoadUserTypesElement(
      ::ad::map::restriction::RoadUserType::CAR_DIESEL);
  disjunctionsElementRoadUserTypes.resize(
      2, disjunctionsElementRoadUserTypesElement);
