...
TEST(LaneValidInputRangeTests, testValidInputRangeTypeTooSmall) {
  ...
  ::ad::map::lane::LaneType invalidInitializedMember(
      static_cast<::ad::map::lane::LaneType>(-1));
...
TEST(LaneValidInputRangeTests, testValidInputRangeDirectionTooSmall) {
  ...
  // override member with data type value below input range minimum
  ::ad::map::lane::LaneDirection invalidInitializedMember(
      static_cast<::ad::map::lane::LaneDirection>(-1));
...
TEST(LaneValidInputRangeTests, testValidInputRangeBoundingSphereTooSmall) {
  ...
  ::ad::map::point::ECEFCoordinate invalidInitializedMemberCenterX(-6400000 *
                                                                   1.1);
