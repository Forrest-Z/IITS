...
TEST(FullRouteValidInputRangeTests, testValidInputRange) {
  ...
  ::ad::map::lane::LaneId
      valueRoadSegmentsElementDrivableLaneSegmentsElementPredecessorsElement(1);
  ...
  ::ad::map::lane::LaneId
      valueRoadSegmentsElementDrivableLaneSegmentsElementLaneIntervalLaneId(1);
  ...
  ::ad::physics::ParametricValue
      valueRoadSegmentsElementDrivableLaneSegmentsElementLaneIntervalStart(0.);
  ...
  bool valueRoadSegmentsElementDrivableLaneSegmentsElementLaneIntervalWrongWay{
      true};
...
TEST(FullRouteValidInputRangeTests,
     testValidInputRangeRouteCreationModeTooSmall) {
  ::ad::map::route::FullRoute value;
  ::ad::map::route::RoadSegmentList valueRoadSegments;
  ::ad::map::route::RoadSegment valueRoadSegmentsElement;
  ::ad::map::route::LaneSegmentList
  ...
  ::ad::map::route::RouteCreationMode invalidInitializedMember(
...
TEST(FullRouteValidInputRangeTests,
     testValidInputRangeRouteCreationModeTooBig) {
  ::ad::map::route::FullRoute value;
  ::ad::map::route::RoadSegmentList valueRoadSegments;
  ::ad::map::route::RoadSegment valueRoadSegmentsElement;
  ::ad::map::route::LaneSegmentList
