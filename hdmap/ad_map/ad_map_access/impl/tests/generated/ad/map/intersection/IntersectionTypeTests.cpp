...
TEST(IntersectionTypeTests, testFromString) {
  ...
  ASSERT_EQ(
      fromString<::ad::map::intersection::IntersectionType>("PriorityToRight"),
  ...
  ASSERT_EQ(
      fromString<::ad::map::intersection::IntersectionType>(
  ...
  ASSERT_EQ(
      fromString<::ad::map::intersection::IntersectionType>("TrafficLight"),
...
TEST(IntersectionTypeTests, testToString) {
  ...
  minValue = std::min(
      minValue,
      static_cast<int32_t>(::ad::map::intersection::IntersectionType::Unknown));
  maxValue = std::max(
      maxValue,
      static_cast<int32_t>(::ad::map::intersection::IntersectionType::Unknown));
  ...
  minValue = std::min(
      minValue,
      static_cast<int32_t>(::ad::map::intersection::IntersectionType::Yield));
  maxValue = std::max(
      maxValue,
      static_cast<int32_t>(::ad::map::intersection::IntersectionType::Yield));
  ...
  minValue = std::min(
      minValue,
      static_cast<int32_t>(::ad::map::intersection::IntersectionType::Stop));
  maxValue = std::max(
      maxValue,
      static_cast<int32_t>(::ad::map::intersection::IntersectionType::Stop));
  ...
  minValue = std::min(
      minValue,
      static_cast<int32_t>(::ad::map::intersection::IntersectionType::HasWay));
  maxValue = std::max(
      maxValue,
      static_cast<int32_t>(::ad::map::intersection::IntersectionType::HasWay));
  ...
  ASSERT_EQ(
      toString(::ad::map::intersection::IntersectionType::PriorityToRight),
      "::ad::map::intersection::IntersectionType::PriorityToRight");
  minValue =
      std::min(minValue,
               static_cast<int32_t>(
  ...
  ASSERT_EQ(
      toString(::ad::map::intersection::IntersectionType::
                   PriorityToRightAndStraight),
      "::ad::map::intersection::IntersectionType::PriorityToRightAndStraight");
  minValue = std::min(
      minValue, static_cast<int32_t>(::ad::map::intersection::IntersectionType::
                                         PriorityToRightAndStraight));
  maxValue = std::max(
      maxValue, static_cast<int32_t>(::ad::map::intersection::IntersectionType::
                                         PriorityToRightAndStraight));
  ...
  ASSERT_EQ(toString(static_cast<::ad::map::intersection::IntersectionType>(
                minValue - 1)),
            "UNKNOWN ENUM VALUE");
  ASSERT_EQ(toString(static_cast<::ad::map::intersection::IntersectionType>(
                maxValue + 1)),
...
TEST(IntersectionTypeTests, ostreamOperatorTest) {
  ...
  ::ad::map::intersection::IntersectionType value(
      ::ad::map::intersection::IntersectionType::Unknown);
  stream << value;
