...
class ObjectTests : public testing::Test {
 protected:
  virtual void SetUp() override {
    ...
    ::ad::map::point::Longitude valueEnuPositionEnuReferencePointLongitude(
        -180);
    valueEnuPositionEnuReferencePoint.longitude =
        valueEnuPositionEnuReferencePointLongitude;
    ::ad::map::point::Latitude valueEnuPositionEnuReferencePointLatitude(-90);
    valueEnuPositionEnuReferencePoint.latitude =
        valueEnuPositionEnuReferencePointLatitude;
    ::ad::map::point::Altitude valueEnuPositionEnuReferencePointAltitude(
        -11000);
    valueEnuPositionEnuReferencePoint.altitude =
        valueEnuPositionEnuReferencePointAltitude;
    ...
    ::ad::map::match::LaneOccupiedRegionList
        valueMapMatchedBoundingBoxLaneOccupiedRegions;
    ::ad::map::match::LaneOccupiedRegion
        valueMapMatchedBoundingBoxLaneOccupiedRegionsElement;
    ::ad::map::lane::LaneId
        valueMapMatchedBoundingBoxLaneOccupiedRegionsElementLaneId(1);
    ...
    valueMapMatchedBoundingBoxLaneOccupiedRegionsElement.lateralRange =
        valueMapMatchedBoundingBoxLaneOccupiedRegionsElementLateralRange;
    valueMapMatchedBoundingBoxLaneOccupiedRegions.resize(
        1, valueMapMatchedBoundingBoxLaneOccupiedRegionsElement);
    valueMapMatchedBoundingBox.laneOccupiedRegions =
        valueMapMatchedBoundingBoxLaneOccupiedRegions;
    std::vector<::ad::map::match::MapMatchedPositionConfidenceList>
        valueMapMatchedBoundingBoxReferencePointPositions;
    ...
    ::ad::map::match::MapMatchedPosition
        valueMapMatchedBoundingBoxReferencePointPositionsElementElement;
    ...
    valueMapMatchedBoundingBoxReferencePointPositions.push_back(
        valueMapMatchedBoundingBoxReferencePointPositionsElement);
    valueMapMatchedBoundingBox.referencePointPositions =
        valueMapMatchedBoundingBoxReferencePointPositions;
...
TEST_F(ObjectTests, comparisonOperatorEnuPositionDiffers) {
  ...
  enuPositionEnuReferencePoint.longitude =
      enuPositionEnuReferencePointLongitude;
...
TEST_F(ObjectTests, comparisonOperatorMapMatchedBoundingBoxDiffers) {
  ...
  ::ad::map::match::LaneOccupiedRegionList
      mapMatchedBoundingBoxLaneOccupiedRegions;
  ::ad::map::match::LaneOccupiedRegion
      mapMatchedBoundingBoxLaneOccupiedRegionsElement;
  ::ad::map::lane::LaneId mapMatchedBoundingBoxLaneOccupiedRegionsElementLaneId(
      std::numeric_limits<::ad::map::lane::LaneId>::max());
  mapMatchedBoundingBoxLaneOccupiedRegionsElement.laneId =
      mapMatchedBoundingBoxLaneOccupiedRegionsElementLaneId;
  ::ad::physics::ParametricRange
  ...
  ::ad::physics::ParametricValue
      mapMatchedBoundingBoxLaneOccupiedRegionsElementLateralRangeMinimum(1.);
  ...
  ::ad::physics::ParametricValue
      mapMatchedBoundingBoxLaneOccupiedRegionsElementLateralRangeMaximum(1.);
  ...
  mapMatchedBoundingBoxLaneOccupiedRegionsElement.lateralRange =
      mapMatchedBoundingBoxLaneOccupiedRegionsElementLateralRange;
  mapMatchedBoundingBoxLaneOccupiedRegions.resize(
      2, mapMatchedBoundingBoxLaneOccupiedRegionsElement);
  mapMatchedBoundingBox.laneOccupiedRegions =
      mapMatchedBoundingBoxLaneOccupiedRegions;
  std::vector<::ad::map::match::MapMatchedPositionConfidenceList>
      mapMatchedBoundingBoxReferencePointPositions;
  ::ad::map::match::MapMatchedPositionConfidenceList
      mapMatchedBoundingBoxReferencePointPositionsElement;
  ::ad::map::match::MapMatchedPosition
      mapMatchedBoundingBoxReferencePointPositionsElementElement;
  ::ad::map::match::LanePoint
  ...
  mapMatchedBoundingBoxReferencePointPositionsElementElement.matchedPoint =
      mapMatchedBoundingBoxReferencePointPositionsElementElementMatchedPoint;
  ::ad::physics::Probability
      mapMatchedBoundingBoxReferencePointPositionsElementElementProbability(1.);
  ...
  mapMatchedBoundingBoxReferencePointPositions.push_back(
      mapMatchedBoundingBoxReferencePointPositionsElement);
  mapMatchedBoundingBox.referencePointPositions =
      mapMatchedBoundingBoxReferencePointPositions;
