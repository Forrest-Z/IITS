...
TEST(LaneOccupiedRegionValidInputRangeTests,
     testValidInputRangeLongitudinalRangeTooSmall) {
  ::ad::map::match::LaneOccupiedRegion value;
  ::ad::map::lane::LaneId valueLaneId(1);
  value.laneId = valueLaneId;
  ::ad::physics::ParametricRange valueLongitudinalRange;
  ...
  ::ad::physics::ParametricValue invalidInitializedMemberMinimum(
...
TEST(LaneOccupiedRegionValidInputRangeTests,
     testValidInputRangeLateralRangeTooSmall) {
  ::ad::map::match::LaneOccupiedRegion value;
  ::ad::map::lane::LaneId valueLaneId(1);
  value.laneId = valueLaneId;
  ::ad::physics::ParametricRange valueLongitudinalRange;
