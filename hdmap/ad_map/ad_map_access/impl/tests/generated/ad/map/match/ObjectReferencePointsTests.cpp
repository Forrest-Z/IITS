...
TEST(ObjectReferencePointsTests, testFromString) {
  ...
  ASSERT_EQ(fromString<::ad::map::match::ObjectReferencePoints>(
                "::ad::map::match::ObjectReferencePoints::FrontLeft"),
            ::ad::map::match::ObjectReferencePoints::FrontLeft);
  ...
  EXPECT_ANY_THROW({
    fromString<::ad::map::match::ObjectReferencePoints>(
...
TEST(ObjectReferencePointsTests, testToString) {
  ...
  ASSERT_EQ(toString(static_cast<::ad::map::match::ObjectReferencePoints>(
                minValue - 1)),
            "UNKNOWN ENUM VALUE");
  ASSERT_EQ(toString(static_cast<::ad::map::match::ObjectReferencePoints>(
                maxValue + 1)),
...
TEST(ObjectReferencePointsTests, ostreamOperatorTest) {
  ...
  ::ad::map::match::ObjectReferencePoints value(
      ::ad::map::match::ObjectReferencePoints::FrontLeft);
  stream << value;
