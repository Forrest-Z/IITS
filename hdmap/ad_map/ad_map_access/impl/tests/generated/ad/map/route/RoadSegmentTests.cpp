...
class RoadSegmentTests : public testing::Test {
 protected:
  virtual void SetUp() override {
    ...
    valueDrivableLaneSegmentsElement.leftNeighbor =
        valueDrivableLaneSegmentsElementLeftNeighbor;
    ::ad::map::lane::LaneId valueDrivableLaneSegmentsElementRightNeighbor(1);
    valueDrivableLaneSegmentsElement.rightNeighbor =
        valueDrivableLaneSegmentsElementRightNeighbor;
    ::ad::map::lane::LaneIdList valueDrivableLaneSegmentsElementPredecessors;
    ::ad::map::lane::LaneId valueDrivableLaneSegmentsElementPredecessorsElement(
        1);
    valueDrivableLaneSegmentsElementPredecessors.resize(
        1, valueDrivableLaneSegmentsElementPredecessorsElement);
    valueDrivableLaneSegmentsElement.predecessors =
        valueDrivableLaneSegmentsElementPredecessors;
    ::ad::map::lane::LaneIdList valueDrivableLaneSegmentsElementSuccessors;
    ::ad::map::lane::LaneId valueDrivableLaneSegmentsElementSuccessorsElement(
        1);
    valueDrivableLaneSegmentsElementSuccessors.resize(
        1, valueDrivableLaneSegmentsElementSuccessorsElement);
    valueDrivableLaneSegmentsElement.successors =
        valueDrivableLaneSegmentsElementSuccessors;
    ::ad::map::route::LaneInterval valueDrivableLaneSegmentsElementLaneInterval;
    ::ad::map::lane::LaneId valueDrivableLaneSegmentsElementLaneIntervalLaneId(
        1);
    valueDrivableLaneSegmentsElementLaneInterval.laneId =
        valueDrivableLaneSegmentsElementLaneIntervalLaneId;
    ::ad::physics::ParametricValue
        valueDrivableLaneSegmentsElementLaneIntervalStart(0.);
    valueDrivableLaneSegmentsElementLaneInterval.start =
        valueDrivableLaneSegmentsElementLaneIntervalStart;
    ::ad::physics::ParametricValue
        valueDrivableLaneSegmentsElementLaneIntervalEnd(0.);
    valueDrivableLaneSegmentsElementLaneInterval.end =
        valueDrivableLaneSegmentsElementLaneIntervalEnd;
    bool valueDrivableLaneSegmentsElementLaneIntervalWrongWay{true};
    valueDrivableLaneSegmentsElementLaneInterval.wrongWay =
        valueDrivableLaneSegmentsElementLaneIntervalWrongWay;
    valueDrivableLaneSegmentsElement.laneInterval =
        valueDrivableLaneSegmentsElementLaneInterval;
    ::ad::map::route::RouteLaneOffset
        valueDrivableLaneSegmentsElementRouteLaneOffset(
            std::numeric_limits<::ad::map::route::RouteLaneOffset>::lowest());
    valueDrivableLaneSegmentsElement.routeLaneOffset =
        valueDrivableLaneSegmentsElementRouteLaneOffset;
...
TEST_F(RoadSegmentTests, comparisonOperatorDrivableLaneSegmentsDiffers) {
  ...
  ::ad::map::lane::LaneId drivableLaneSegmentsElementLeftNeighbor(
      std::numeric_limits<::ad::map::lane::LaneId>::max());
  drivableLaneSegmentsElement.leftNeighbor =
      drivableLaneSegmentsElementLeftNeighbor;
  ::ad::map::lane::LaneId drivableLaneSegmentsElementRightNeighbor(
      std::numeric_limits<::ad::map::lane::LaneId>::max());
  drivableLaneSegmentsElement.rightNeighbor =
      drivableLaneSegmentsElementRightNeighbor;
  ...
  ::ad::map::lane::LaneId drivableLaneSegmentsElementPredecessorsElement(
      std::numeric_limits<::ad::map::lane::LaneId>::max());
  drivableLaneSegmentsElementPredecessors.resize(
      2, drivableLaneSegmentsElementPredecessorsElement);
  drivableLaneSegmentsElement.predecessors =
      drivableLaneSegmentsElementPredecessors;
  ...
  ::ad::map::lane::LaneId drivableLaneSegmentsElementSuccessorsElement(
      std::numeric_limits<::ad::map::lane::LaneId>::max());
  drivableLaneSegmentsElementSuccessors.resize(
      2, drivableLaneSegmentsElementSuccessorsElement);
  drivableLaneSegmentsElement.successors =
      drivableLaneSegmentsElementSuccessors;
  ...
  ::ad::map::lane::LaneId drivableLaneSegmentsElementLaneIntervalLaneId(
      std::numeric_limits<::ad::map::lane::LaneId>::max());
  drivableLaneSegmentsElementLaneInterval.laneId =
      drivableLaneSegmentsElementLaneIntervalLaneId;
  ::ad::physics::ParametricValue drivableLaneSegmentsElementLaneIntervalStart(
      1.);
  drivableLaneSegmentsElementLaneInterval.start =
      drivableLaneSegmentsElementLaneIntervalStart;
  ::ad::physics::ParametricValue drivableLaneSegmentsElementLaneIntervalEnd(1.);
  drivableLaneSegmentsElementLaneInterval.end =
      drivableLaneSegmentsElementLaneIntervalEnd;
  bool drivableLaneSegmentsElementLaneIntervalWrongWay{false};
  drivableLaneSegmentsElementLaneInterval.wrongWay =
      drivableLaneSegmentsElementLaneIntervalWrongWay;
  drivableLaneSegmentsElement.laneInterval =
      drivableLaneSegmentsElementLaneInterval;
  ...
  drivableLaneSegmentsElement.routeLaneOffset =
      drivableLaneSegmentsElementRouteLaneOffset;
