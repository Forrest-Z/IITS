...
TEST(RoadSegmentListValidInputRangeTests,
     testValidInputRangeValidInputRangeMin) {
...
TEST(RoadSegmentListValidInputRangeTests, testValidInputRangeElementValid) {
  ...
  elementDrivableLaneSegmentsElement.leftNeighbor =
      elementDrivableLaneSegmentsElementLeftNeighbor;
  ::ad::map::lane::LaneId elementDrivableLaneSegmentsElementRightNeighbor(1);
  elementDrivableLaneSegmentsElement.rightNeighbor =
      elementDrivableLaneSegmentsElementRightNeighbor;
  ::ad::map::lane::LaneIdList elementDrivableLaneSegmentsElementPredecessors;
  ::ad::map::lane::LaneId elementDrivableLaneSegmentsElementPredecessorsElement(
      1);
  elementDrivableLaneSegmentsElementPredecessors.resize(
      1, elementDrivableLaneSegmentsElementPredecessorsElement);
  elementDrivableLaneSegmentsElement.predecessors =
      elementDrivableLaneSegmentsElementPredecessors;
  ::ad::map::lane::LaneIdList elementDrivableLaneSegmentsElementSuccessors;
  ::ad::map::lane::LaneId elementDrivableLaneSegmentsElementSuccessorsElement(
      1);
  elementDrivableLaneSegmentsElementSuccessors.resize(
      1, elementDrivableLaneSegmentsElementSuccessorsElement);
  elementDrivableLaneSegmentsElement.successors =
      elementDrivableLaneSegmentsElementSuccessors;
  ::ad::map::route::LaneInterval elementDrivableLaneSegmentsElementLaneInterval;
  ::ad::map::lane::LaneId elementDrivableLaneSegmentsElementLaneIntervalLaneId(
      1);
  elementDrivableLaneSegmentsElementLaneInterval.laneId =
      elementDrivableLaneSegmentsElementLaneIntervalLaneId;
  ::ad::physics::ParametricValue
      elementDrivableLaneSegmentsElementLaneIntervalStart(0.);
  elementDrivableLaneSegmentsElementLaneInterval.start =
      elementDrivableLaneSegmentsElementLaneIntervalStart;
  ::ad::physics::ParametricValue
      elementDrivableLaneSegmentsElementLaneIntervalEnd(0.);
  elementDrivableLaneSegmentsElementLaneInterval.end =
      elementDrivableLaneSegmentsElementLaneIntervalEnd;
  bool elementDrivableLaneSegmentsElementLaneIntervalWrongWay{true};
  elementDrivableLaneSegmentsElementLaneInterval.wrongWay =
      elementDrivableLaneSegmentsElementLaneIntervalWrongWay;
  elementDrivableLaneSegmentsElement.laneInterval =
      elementDrivableLaneSegmentsElementLaneInterval;
  ::ad::map::route::RouteLaneOffset
      elementDrivableLaneSegmentsElementRouteLaneOffset(
          std::numeric_limits<::ad::map::route::RouteLaneOffset>::lowest());
  elementDrivableLaneSegmentsElement.routeLaneOffset =
      elementDrivableLaneSegmentsElementRouteLaneOffset;
