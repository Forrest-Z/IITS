...
TEST(TrafficSignTypeTests, testFromString) {
  ASSERT_EQ(fromString<::ad::map::landmark::TrafficSignType>("INVALID"),
  ...
  ASSERT_EQ(
      fromString<::ad::map::landmark::TrafficSignType>(
  ...
  ASSERT_EQ(fromString<::ad::map::landmark::TrafficSignType>(
            ...
            ::ad::map::landmark::TrafficSignType::
                SUPPLEMENT_ARROW_APPLIES_LEFT_RIGHT);
  ASSERT_EQ(fromString<::ad::map::landmark::TrafficSignType>(
                "::ad::map::landmark::TrafficSignType::SUPPLEMENT_ARROW_"
                "APPLIES_LEFT_RIGHT"),
            ::ad::map::landmark::TrafficSignType::
                SUPPLEMENT_ARROW_APPLIES_LEFT_RIGHT);
  ...
  ASSERT_EQ(fromString<::ad::map::landmark::TrafficSignType>(
            ...
            ::ad::map::landmark::TrafficSignType::
                SUPPLEMENT_ENVIRONMENT_ZONE_YELLOW_GREEN);
  ASSERT_EQ(fromString<::ad::map::landmark::TrafficSignType>(
                "::ad::map::landmark::TrafficSignType::SUPPLEMENT_ENVIRONMENT_"
                "ZONE_YELLOW_GREEN"),
            ::ad::map::landmark::TrafficSignType::
                SUPPLEMENT_ENVIRONMENT_ZONE_YELLOW_GREEN);
  ...
  ASSERT_EQ(fromString<::ad::map::landmark::TrafficSignType>("DANGER"),
  ...
  ASSERT_EQ(
      fromString<::ad::map::landmark::TrafficSignType>("CAUTION_PEDESTRIAN"),
  ...
  ASSERT_EQ(
      fromString<::ad::map::landmark::TrafficSignType>("CAUTION_CHILDREN"),
  ...
  ASSERT_EQ(
      fromString<::ad::map::landmark::TrafficSignType>("CAUTION_RAIL_CROSSING"),
  ...
  ASSERT_EQ(fromString<::ad::map::landmark::TrafficSignType>("YIELD"),
            ::ad::map::landmark::TrafficSignType::YIELD);
  ASSERT_EQ(fromString<::ad::map::landmark::TrafficSignType>(
                "::ad::map::landmark::TrafficSignType::YIELD"),
            ::ad::map::landmark::TrafficSignType::YIELD);

  ASSERT_EQ(fromString<::ad::map::landmark::TrafficSignType>("STOP"),
  ...
  ASSERT_EQ(
      fromString<::ad::map::landmark::TrafficSignType>("REQUIRED_RIGHT_TURN"),
  ...
  ASSERT_EQ(
      fromString<::ad::map::landmark::TrafficSignType>("REQUIRED_LEFT_TURN"),
  ...
  ASSERT_EQ(
      fromString<::ad::map::landmark::TrafficSignType>("REQUIRED_STRAIGHT"),
  ...
  ASSERT_EQ(
      fromString<::ad::map::landmark::TrafficSignType>("PEDESTRIAN_AREA_BEGIN"),
  ...
  ASSERT_EQ(
      fromString<::ad::map::landmark::TrafficSignType>("ACCESS_FORBIDDEN"),
  ...
  ASSERT_EQ(
      fromString<::ad::map::landmark::TrafficSignType>("ENVIORNMENT_ZONE_END"),
  ...
  ASSERT_EQ(
      fromString<::ad::map::landmark::TrafficSignType>("SPEED_ZONE_30_BEGIN"),
  ...
  ASSERT_EQ(
      fromString<::ad::map::landmark::TrafficSignType>("SPEED_ZONE_30_END"),
  ...
  ASSERT_EQ(
      fromString<::ad::map::landmark::TrafficSignType>("MOTORVEHICLE_BEGIN"),
  ...
  ASSERT_EQ(
      fromString<::ad::map::landmark::TrafficSignType>("MOTORVEHICLE_END"),
  ...
  ASSERT_EQ(
      fromString<::ad::map::landmark::TrafficSignType>("INFO_MOTORWAY_INFO"),
  ...
  ASSERT_EQ(
      fromString<::ad::map::landmark::TrafficSignType>("DESTINATION_BOARD"),
  ...
  ASSERT_EQ(fromString<::ad::map::landmark::TrafficSignType>("UNKNOWN"),
...
TEST(TrafficSignTypeTests, testToString) {
  ...
  ASSERT_EQ(toString(::ad::map::landmark::TrafficSignType::INVALID),
            "::ad::map::landmark::TrafficSignType::INVALID");
  minValue = std::min(
      minValue,
      static_cast<int32_t>(::ad::map::landmark::TrafficSignType::INVALID));
  maxValue = std::max(
      maxValue,
      static_cast<int32_t>(::ad::map::landmark::TrafficSignType::INVALID));
  ...
  ASSERT_EQ(
      ...
      "::ad::map::landmark::TrafficSignType::SUPPLEMENT_ARROW_APPLIES_RIGHT");
  minValue = std::min(
      minValue, static_cast<int32_t>(::ad::map::landmark::TrafficSignType::
                                         SUPPLEMENT_ARROW_APPLIES_RIGHT));
  maxValue = std::max(
      maxValue, static_cast<int32_t>(::ad::map::landmark::TrafficSignType::
                                         SUPPLEMENT_ARROW_APPLIES_RIGHT));

  ASSERT_EQ(toString(::ad::map::landmark::TrafficSignType::
                         SUPPLEMENT_ARROW_APPLIES_LEFT_RIGHT),
            "::ad::map::landmark::TrafficSignType::SUPPLEMENT_ARROW_APPLIES_"
            "LEFT_RIGHT");
  minValue = std::min(
  ...
  ASSERT_EQ(
      toString(::ad::map::landmark::TrafficSignType::
                   SUPPLEMENT_ARROW_APPLIES_UP_DOWN),
      "::ad::map::landmark::TrafficSignType::SUPPLEMENT_ARROW_APPLIES_UP_DOWN");
  minValue = std::min(
      minValue, static_cast<int32_t>(::ad::map::landmark::TrafficSignType::
  ...
  minValue = std::min(
      minValue,
      static_cast<int32_t>(::ad::map::landmark::TrafficSignType::
                               SUPPLEMENT_ARROW_APPLIES_LEFT_RIGHT_BICYCLE));
  maxValue = std::max(
      maxValue,
      static_cast<int32_t>(::ad::map::landmark::TrafficSignType::
  ...
  ASSERT_EQ(toString(::ad::map::landmark::TrafficSignType::
                         SUPPLEMENT_APPLIES_NEXT_N_KM_TIME),
            "::ad::map::landmark::TrafficSignType::SUPPLEMENT_APPLIES_NEXT_N_"
            "KM_TIME");
  minValue = std::min(
      minValue, static_cast<int32_t>(::ad::map::landmark::TrafficSignType::
                                         SUPPLEMENT_APPLIES_NEXT_N_KM_TIME));
  ...
  ASSERT_EQ(
      toString(::ad::map::landmark::TrafficSignType::SUPPLEMENT_MOPED_ALLOWED),
      "::ad::map::landmark::TrafficSignType::SUPPLEMENT_MOPED_ALLOWED");
  minValue = std::min(
      minValue,
      static_cast<int32_t>(
  ...
  ASSERT_EQ(
      toString(::ad::map::landmark::TrafficSignType::SUPPLEMENT_TRAM_ALLOWED),
      "::ad::map::landmark::TrafficSignType::SUPPLEMENT_TRAM_ALLOWED");
  minValue = std::min(
      minValue,
      static_cast<int32_t>(
  ...
  ASSERT_EQ(
      toString(::ad::map::landmark::TrafficSignType::SUPPLEMENT_RAILWAY_ONLY),
      "::ad::map::landmark::TrafficSignType::SUPPLEMENT_RAILWAY_ONLY");
  minValue = std::min(
      minValue,
      static_cast<int32_t>(
  ...
  ASSERT_EQ(toString(::ad::map::landmark::TrafficSignType::DANGER),
            "::ad::map::landmark::TrafficSignType::DANGER");
  minValue = std::min(
      minValue,
      static_cast<int32_t>(::ad::map::landmark::TrafficSignType::DANGER));
  maxValue = std::max(
      maxValue,
      static_cast<int32_t>(::ad::map::landmark::TrafficSignType::DANGER));
  ...
  ASSERT_EQ(
      toString(::ad::map::landmark::TrafficSignType::CAUTION_RAIL_CROSSING),
      "::ad::map::landmark::TrafficSignType::CAUTION_RAIL_CROSSING");
  minValue = std::min(
      minValue,
      static_cast<int32_t>(
  ...
  minValue = std::min(
      minValue,
      static_cast<int32_t>(::ad::map::landmark::TrafficSignType::YIELD_TRAIN));
  maxValue = std::max(
      maxValue,
      static_cast<int32_t>(::ad::map::landmark::TrafficSignType::YIELD_TRAIN));

  ASSERT_EQ(toString(::ad::map::landmark::TrafficSignType::YIELD),
            "::ad::map::landmark::TrafficSignType::YIELD");
  minValue = std::min(
      minValue,
      static_cast<int32_t>(::ad::map::landmark::TrafficSignType::YIELD));
  maxValue = std::max(
      maxValue,
      static_cast<int32_t>(::ad::map::landmark::TrafficSignType::YIELD));

  ASSERT_EQ(toString(::ad::map::landmark::TrafficSignType::STOP),
            "::ad::map::landmark::TrafficSignType::STOP");
  minValue = std::min(
      minValue,
      static_cast<int32_t>(::ad::map::landmark::TrafficSignType::STOP));
  maxValue = std::max(
      maxValue,
      static_cast<int32_t>(::ad::map::landmark::TrafficSignType::STOP));
  ...
  minValue = std::min(
      minValue,
      static_cast<int32_t>(::ad::map::landmark::TrafficSignType::ROUNDABOUT));
  maxValue = std::max(
      maxValue,
      static_cast<int32_t>(::ad::map::landmark::TrafficSignType::ROUNDABOUT));
  ...
  minValue = std::min(
      minValue,
      static_cast<int32_t>(::ad::map::landmark::TrafficSignType::PASS_RIGHT));
  maxValue = std::max(
      maxValue,
      static_cast<int32_t>(::ad::map::landmark::TrafficSignType::PASS_RIGHT));
  ...
  minValue = std::min(
      minValue,
      static_cast<int32_t>(::ad::map::landmark::TrafficSignType::PASS_LEFT));
  maxValue = std::max(
      maxValue,
      static_cast<int32_t>(::ad::map::landmark::TrafficSignType::PASS_LEFT));
  ...
  minValue = std::min(
      minValue,
      static_cast<int32_t>(::ad::map::landmark::TrafficSignType::BYBICLE_PATH));
  maxValue = std::max(
      maxValue,
      static_cast<int32_t>(::ad::map::landmark::TrafficSignType::BYBICLE_PATH));

  ASSERT_EQ(toString(::ad::map::landmark::TrafficSignType::FOOTWALK),
            "::ad::map::landmark::TrafficSignType::FOOTWALK");
  minValue = std::min(
      minValue,
      static_cast<int32_t>(::ad::map::landmark::TrafficSignType::FOOTWALK));
  maxValue = std::max(
      maxValue,
      static_cast<int32_t>(::ad::map::landmark::TrafficSignType::FOOTWALK));

  ASSERT_EQ(
      toString(::ad::map::landmark::TrafficSignType::FOOTWALK_BICYCLE_SHARED),
      "::ad::map::landmark::TrafficSignType::FOOTWALK_BICYCLE_SHARED");
  minValue = std::min(
      minValue,
      static_cast<int32_t>(
  ...
  ASSERT_EQ(
      toString(::ad::map::landmark::TrafficSignType::FOOTWALK_BICYCLE_SEP_LEFT),
      "::ad::map::landmark::TrafficSignType::FOOTWALK_BICYCLE_SEP_LEFT");
  minValue = std::min(
      minValue,
      static_cast<int32_t>(
  ...
  ASSERT_EQ(
      toString(::ad::map::landmark::TrafficSignType::PEDESTRIAN_AREA_BEGIN),
      "::ad::map::landmark::TrafficSignType::PEDESTRIAN_AREA_BEGIN");
  minValue = std::min(
      minValue,
      static_cast<int32_t>(
  ...
  ASSERT_EQ(
      toString(::ad::map::landmark::TrafficSignType::ACCESS_FORBIDDEN_TRUCKS),
      "::ad::map::landmark::TrafficSignType::ACCESS_FORBIDDEN_TRUCKS");
  minValue = std::min(
      minValue,
      static_cast<int32_t>(
  ...
  ASSERT_EQ(
      toString(::ad::map::landmark::TrafficSignType::ACCESS_FORBIDDEN_BICYCLE),
      "::ad::map::landmark::TrafficSignType::ACCESS_FORBIDDEN_BICYCLE");
  minValue = std::min(
      minValue,
      static_cast<int32_t>(
  ...
  ASSERT_EQ(
      toString(::ad::map::landmark::TrafficSignType::ACCESS_FORBIDDEN_WEIGHT),
      "::ad::map::landmark::TrafficSignType::ACCESS_FORBIDDEN_WEIGHT");
  minValue = std::min(
      minValue,
      static_cast<int32_t>(
  ...
  ASSERT_EQ(
      toString(::ad::map::landmark::TrafficSignType::ACCESS_FORBIDDEN_WIDTH),
      "::ad::map::landmark::TrafficSignType::ACCESS_FORBIDDEN_WIDTH");
  minValue = std::min(
      minValue,
      static_cast<int32_t>(
  ...
  ASSERT_EQ(
      toString(::ad::map::landmark::TrafficSignType::ACCESS_FORBIDDEN_HEIGHT),
      "::ad::map::landmark::TrafficSignType::ACCESS_FORBIDDEN_HEIGHT");
  minValue = std::min(
      minValue,
      static_cast<int32_t>(
  ...
  ASSERT_EQ(
      toString(::ad::map::landmark::TrafficSignType::ENVIORNMENT_ZONE_BEGIN),
      "::ad::map::landmark::TrafficSignType::ENVIORNMENT_ZONE_BEGIN");
  minValue = std::min(
      minValue,
      static_cast<int32_t>(
  ...
  ASSERT_EQ(
      toString(::ad::map::landmark::TrafficSignType::ENVIORNMENT_ZONE_END),
      "::ad::map::landmark::TrafficSignType::ENVIORNMENT_ZONE_END");
  minValue =
      std::min(minValue,
               static_cast<int32_t>(
  ...
  minValue = std::min(
      minValue,
      static_cast<int32_t>(::ad::map::landmark::TrafficSignType::MAX_SPEED));
  maxValue = std::max(
      maxValue,
      static_cast<int32_t>(::ad::map::landmark::TrafficSignType::MAX_SPEED));
  ...
  ASSERT_EQ(
      toString(::ad::map::landmark::TrafficSignType::HAS_WAY_NEXT_INTERSECTION),
      "::ad::map::landmark::TrafficSignType::HAS_WAY_NEXT_INTERSECTION");
  minValue = std::min(
      minValue,
      static_cast<int32_t>(
  ...
  minValue = std::min(
      minValue,
      static_cast<int32_t>(::ad::map::landmark::TrafficSignType::PRIORITY_WAY));
  maxValue = std::max(
      maxValue,
      static_cast<int32_t>(::ad::map::landmark::TrafficSignType::PRIORITY_WAY));
  ...
  minValue = std::min(
      minValue,
      static_cast<int32_t>(::ad::map::landmark::TrafficSignType::CITY_BEGIN));
  maxValue = std::max(
      maxValue,
      static_cast<int32_t>(::ad::map::landmark::TrafficSignType::CITY_BEGIN));

  ASSERT_EQ(toString(::ad::map::landmark::TrafficSignType::CITY_END),
            "::ad::map::landmark::TrafficSignType::CITY_END");
  minValue = std::min(
      minValue,
      static_cast<int32_t>(::ad::map::landmark::TrafficSignType::CITY_END));
  maxValue = std::max(
      maxValue,
      static_cast<int32_t>(::ad::map::landmark::TrafficSignType::CITY_END));
  ...
  minValue = std::min(
      minValue,
      static_cast<int32_t>(::ad::map::landmark::TrafficSignType::MOTORWAY_END));
  maxValue = std::max(
      maxValue,
      static_cast<int32_t>(::ad::map::landmark::TrafficSignType::MOTORWAY_END));
  ...
  minValue = std::min(
      minValue,
      static_cast<int32_t>(::ad::map::landmark::TrafficSignType::CUL_DE_SAC));
  maxValue = std::max(
      maxValue,
      static_cast<int32_t>(::ad::map::landmark::TrafficSignType::CUL_DE_SAC));
  ...
  ASSERT_EQ(
      toString(::ad::map::landmark::TrafficSignType::INFO_NUMBER_OF_AUTOBAHN),
      "::ad::map::landmark::TrafficSignType::INFO_NUMBER_OF_AUTOBAHN");
  minValue = std::min(
      minValue,
      static_cast<int32_t>(
  ...
  ASSERT_EQ(
      toString(::ad::map::landmark::TrafficSignType::DIRECTION_TURN_TO_LOCAL),
      "::ad::map::landmark::TrafficSignType::DIRECTION_TURN_TO_LOCAL");
  minValue = std::min(
      minValue,
      static_cast<int32_t>(
  ...
  minValue = std::min(
      minValue,
      static_cast<int32_t>(::ad::map::landmark::TrafficSignType::FREE_TEXT));
  maxValue = std::max(
      maxValue,
      static_cast<int32_t>(::ad::map::landmark::TrafficSignType::FREE_TEXT));

  ASSERT_EQ(toString(::ad::map::landmark::TrafficSignType::UNKNOWN),
            "::ad::map::landmark::TrafficSignType::UNKNOWN");
  minValue = std::min(
      minValue,
      static_cast<int32_t>(::ad::map::landmark::TrafficSignType::UNKNOWN));
  maxValue = std::max(
      maxValue,
      static_cast<int32_t>(::ad::map::landmark::TrafficSignType::UNKNOWN));

  ASSERT_EQ(
      toString(static_cast<::ad::map::landmark::TrafficSignType>(minValue - 1)),
      "UNKNOWN ENUM VALUE");
  ASSERT_EQ(
      toString(static_cast<::ad::map::landmark::TrafficSignType>(maxValue + 1)),
      "UNKNOWN ENUM VALUE");
}

TEST(TrafficSignTypeTests, ostreamOperatorTest) {
  std::stringstream stream;
  ::ad::map::landmark::TrafficSignType value(
      ::ad::map::landmark::TrafficSignType::INVALID);
  stream << value;
