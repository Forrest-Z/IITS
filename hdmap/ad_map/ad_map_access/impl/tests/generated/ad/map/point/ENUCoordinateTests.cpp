...
TEST(ENUCoordinateTests, aboveMinIsValid) {
  ::ad::map::point::ENUCoordinate value(
      ::ad::map::point::ENUCoordinate::cMinValue * 0.9);
  EXPECT_TRUE(value.isValid());
}

TEST(ENUCoordinateTests, belowMinIsInvalid) {
  ::ad::map::point::ENUCoordinate value(
      ::ad::map::point::ENUCoordinate::cMinValue * 1.1);
  EXPECT_FALSE(value.isValid());
}
...
TEST(ENUCoordinateTests, aboveMaxIsInvalid) {
  ::ad::map::point::ENUCoordinate value(
      ::ad::map::point::ENUCoordinate::cMaxValue * 1.1);
  EXPECT_FALSE(value.isValid());
}

TEST(ENUCoordinateTests, belowMaxIsValid) {
  ::ad::map::point::ENUCoordinate value(
      ::ad::map::point::ENUCoordinate::cMaxValue * 0.9);
  EXPECT_TRUE(value.isValid());
}
...
TEST(ENUCoordinateTestsStd, fabsIsWorkingCorrectly) {
  EXPECT_DOUBLE_EQ(
      0., static_cast<double>(std::fabs(::ad::map::point::ENUCoordinate(-0.))));
  EXPECT_DOUBLE_EQ(
      1., static_cast<double>(std::fabs(::ad::map::point::ENUCoordinate(-1.))));
  EXPECT_DOUBLE_EQ(
      ::ad::map::point::ENUCoordinate::cPrecisionValue,
      static_cast<double>(std::fabs(::ad::map::point::ENUCoordinate(
          ::ad::map::point::ENUCoordinate::cPrecisionValue))));
  EXPECT_DOUBLE_EQ(
...
TEST(ENUCoordinateTests, copyConstructionFromValidValue) {
  ::ad::map::point::ENUCoordinate const validValue(
      ::ad::map::point::ENUCoordinate::cMinValue);
  ::ad::map::point::ENUCoordinate value(validValue);
  EXPECT_TRUE(value.isValid());
...
TEST(ENUCoordinateTests, moveConstructionFromValidValue) {
  ::ad::map::point::ENUCoordinate validValue(
      ::ad::map::point::ENUCoordinate::cMinValue);
...
TEST(ENUCoordinateTests, comparisonOperatorsThrowOnInvalid) {
  ::ad::map::point::ENUCoordinate const value(
      ::ad::map::point::ENUCoordinate::cMinValue);
  ::ad::map::point::ENUCoordinate const invalidValue;
...
TEST(ENUCoordinateTests, arithmeticOperatorsThrowOnInvalid) {
  ::ad::map::point::ENUCoordinate const minimalValue(
      ::ad::map::point::ENUCoordinate::cMinValue);
  ::ad::map::point::ENUCoordinate const maximalValue(
      ::ad::map::point::ENUCoordinate::cMaxValue);
  ::ad::map::point::ENUCoordinate const invalidValue;
  ...
  EXPECT_THROW(invalidValue / maximalValue, std::out_of_range);
  EXPECT_THROW(maximalValue / invalidValue, std::out_of_range);
  EXPECT_THROW(maximalValue / ::ad::map::point::ENUCoordinate(0.0),
               std::out_of_range);
...
TEST(ENUCoordinateTests, comparisonOperatorsRespectPrecision) {
  double const precisionValueTimesTen =
      ::ad::map::point::ENUCoordinate::cPrecisionValue * 10.;
  ::ad::map::point::ENUCoordinate value;
  if (::ad::map::point::ENUCoordinate::cMinValue > precisionValueTimesTen) {
    value = ::ad::map::point::ENUCoordinate(
        ::ad::map::point::ENUCoordinate::cMinValue + precisionValueTimesTen);
  } else if (::ad::map::point::ENUCoordinate::cMaxValue <
             precisionValueTimesTen) {
    value = ::ad::map::point::ENUCoordinate(
        ::ad::map::point::ENUCoordinate::cMaxValue - precisionValueTimesTen);
  } else {
    value = ::ad::map::point::ENUCoordinate(precisionValueTimesTen);
  }
  ::ad::map::point::ENUCoordinate const sameValue = value;
  ::ad::map::point::ENUCoordinate const slightlyBiggerValue(
      static_cast<double>(value) +
      ::ad::map::point::ENUCoordinate::cPrecisionValue * 0.9);
  ::ad::map::point::ENUCoordinate const slightlySmallerValue(
      static_cast<double>(value) -
      ::ad::map::point::ENUCoordinate::cPrecisionValue * 0.9);
  ::ad::map::point::ENUCoordinate const actuallyBiggerValue(
      static_cast<double>(value) +
      ::ad::map::point::ENUCoordinate::cPrecisionValue * 1.1);
  ::ad::map::point::ENUCoordinate const actuallySmallerValue(
      static_cast<double>(value) -
      ::ad::map::point::ENUCoordinate::cPrecisionValue * 1.1);
...
TEST(ENUCoordinateTests, arithmeticOperatorsComputeCorrectly) {
  ...
  //  operator-()
  if ((::ad::map::point::ENUCoordinate::cMinValue <
       -static_cast<double>(value)) &&
      (-static_cast<double>(value) <
       ::ad::map::point::ENUCoordinate::cMaxValue)) {
    result = -value;
