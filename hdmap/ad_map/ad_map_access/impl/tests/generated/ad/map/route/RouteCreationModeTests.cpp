...
TEST(RouteCreationModeTests, testFromString) {
  ...
  ASSERT_EQ(fromString<::ad::map::route::RouteCreationMode>(
                "::ad::map::route::RouteCreationMode::Undefined"),
            ::ad::map::route::RouteCreationMode::Undefined);

  ASSERT_EQ(
      fromString<::ad::map::route::RouteCreationMode>("SameDrivingDirection"),
  ...
  EXPECT_ANY_THROW({
    fromString<::ad::map::route::RouteCreationMode>("NOT A VALID ENUM LITERAL");
  });
}
...
TEST(RouteCreationModeTests, testToString) {
  ...
  ASSERT_EQ(toString(::ad::map::route::RouteCreationMode::Undefined),
            "::ad::map::route::RouteCreationMode::Undefined");
  minValue = std::min(
      minValue,
      static_cast<int32_t>(::ad::map::route::RouteCreationMode::Undefined));
  maxValue = std::max(
      maxValue,
      static_cast<int32_t>(::ad::map::route::RouteCreationMode::Undefined));
  ...
  ASSERT_EQ(
      toString(static_cast<::ad::map::route::RouteCreationMode>(minValue - 1)),
      "UNKNOWN ENUM VALUE");
  ASSERT_EQ(
      toString(static_cast<::ad::map::route::RouteCreationMode>(maxValue + 1)),
      "UNKNOWN ENUM VALUE");
}

TEST(RouteCreationModeTests, ostreamOperatorTest) {
  std::stringstream stream;
  ::ad::map::route::RouteCreationMode value(
      ::ad::map::route::RouteCreationMode::Undefined);
  stream << value;
