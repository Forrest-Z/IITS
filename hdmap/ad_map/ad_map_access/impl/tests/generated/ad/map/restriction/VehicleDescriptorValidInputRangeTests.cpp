...
TEST(VehicleDescriptorValidInputRangeTests, testValidInputRange) {
  ...
  ::ad::map::restriction::RoadUserType valueType(
...
TEST(VehicleDescriptorValidInputRangeTests, testValidInputRangeTypeTooSmall) {
  ...
  ::ad::map::restriction::RoadUserType invalidInitializedMember(
      static_cast<::ad::map::restriction::RoadUserType>(-1));
