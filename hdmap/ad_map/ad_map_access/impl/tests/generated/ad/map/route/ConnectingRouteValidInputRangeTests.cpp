...
TEST(ConnectingRouteValidInputRangeTests, testValidInputRange) {
  ...
  ::ad::map::lane::LaneId
      valueRouteARoadSegmentsElementDrivableLaneSegmentsElementLeftNeighbor(1);
  ...
  ::ad::map::lane::LaneId
      valueRouteARoadSegmentsElementDrivableLaneSegmentsElementRightNeighbor(1);
  ...
  ::ad::map::lane::LaneId
      valueRouteBRoadSegmentsElementDrivableLaneSegmentsElementLeftNeighbor(1);
  ...
  ::ad::map::lane::LaneId
      valueRouteBRoadSegmentsElementDrivableLaneSegmentsElementRightNeighbor(1);
...
TEST(ConnectingRouteValidInputRangeTests, testValidInputRangeRouteATooSmall) {
  ...
  invalidInitializedMember.routeCreationMode =
      invalidInitializedMemberRouteCreationMode;
