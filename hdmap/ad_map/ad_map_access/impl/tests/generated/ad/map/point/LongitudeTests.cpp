...
TEST(LongitudeTests, aboveMaxIsInvalid) {
  ::ad::map::point::Longitude value(::ad::map::point::Longitude::cMaxValue *
                                    1.1);
  EXPECT_FALSE(value.isValid());
}
...
TEST(LongitudeTestsStd, numericLimitsLowestIsMin) {
  EXPECT_DOUBLE_EQ(
      static_cast<double>(::ad::map::point::Longitude::getMin()),
      static_cast<double>(
...
TEST(LongitudeTestsStd, numericLimitsMaxIsMax) {
  EXPECT_DOUBLE_EQ(
      static_cast<double>(::ad::map::point::Longitude::getMax()),
      static_cast<double>(
...
TEST(LongitudeTestsStd, fabsIsWorkingCorrectly) {
  EXPECT_DOUBLE_EQ(
      0., static_cast<double>(std::fabs(::ad::map::point::Longitude(-0.))));
  EXPECT_DOUBLE_EQ(
      1., static_cast<double>(std::fabs(::ad::map::point::Longitude(-1.))));
  EXPECT_DOUBLE_EQ(::ad::map::point::Longitude::cPrecisionValue,
                   static_cast<double>(std::fabs(::ad::map::point::Longitude(
                       ::ad::map::point::Longitude::cPrecisionValue))));
...
TEST(LongitudeTests, copyConstructionFromValidValue) {
  ::ad::map::point::Longitude const validValue(
      ::ad::map::point::Longitude::cMinValue);
  ::ad::map::point::Longitude value(validValue);
  EXPECT_TRUE(value.isValid());
...
TEST(LongitudeTests, moveConstructionFromValidValue) {
  ::ad::map::point::Longitude validValue(
      ::ad::map::point::Longitude::cMinValue);
  ::ad::map::point::Longitude value(std::move(validValue));
  EXPECT_TRUE(value.isValid());
  EXPECT_DOUBLE_EQ(::ad::map::point::Longitude::cMinValue,
...
TEST(LongitudeTests, arithmeticOperatorsThrowOnInvalid) {
  ::ad::map::point::Longitude const minimalValue(
      ::ad::map::point::Longitude::cMinValue);
  ::ad::map::point::Longitude const maximalValue(
      ::ad::map::point::Longitude::cMaxValue);
  ::ad::map::point::Longitude const invalidValue;
  ...
  EXPECT_THROW(invalidValue / maximalValue, std::out_of_range);
  EXPECT_THROW(maximalValue / invalidValue, std::out_of_range);
  EXPECT_THROW(maximalValue / ::ad::map::point::Longitude(0.0),
               std::out_of_range);
...
TEST(LongitudeTests, comparisonOperatorsRespectPrecision) {
  double const precisionValueTimesTen =
      ::ad::map::point::Longitude::cPrecisionValue * 10.;
  ::ad::map::point::Longitude value;
  if (::ad::map::point::Longitude::cMinValue > precisionValueTimesTen) {
    value = ::ad::map::point::Longitude(::ad::map::point::Longitude::cMinValue +
                                        precisionValueTimesTen);
  } else if (::ad::map::point::Longitude::cMaxValue < precisionValueTimesTen) {
    value = ::ad::map::point::Longitude(::ad::map::point::Longitude::cMaxValue -
                                        precisionValueTimesTen);
  } else {
    value = ::ad::map::point::Longitude(precisionValueTimesTen);
  }
  ::ad::map::point::Longitude const sameValue = value;
  ::ad::map::point::Longitude const slightlyBiggerValue(
      static_cast<double>(value) +
      ::ad::map::point::Longitude::cPrecisionValue * 0.9);
  ::ad::map::point::Longitude const slightlySmallerValue(
      static_cast<double>(value) -
      ::ad::map::point::Longitude::cPrecisionValue * 0.9);
  ::ad::map::point::Longitude const actuallyBiggerValue(
      static_cast<double>(value) +
      ::ad::map::point::Longitude::cPrecisionValue * 1.1);
  ::ad::map::point::Longitude const actuallySmallerValue(
      static_cast<double>(value) -
      ::ad::map::point::Longitude::cPrecisionValue * 1.1);
