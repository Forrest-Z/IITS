...
TEST(MapEntryValidInputRangeTests, testValidInputRange) {
  ...
  ::ad::map::intersection::IntersectionType
      valueOpenDriveDefaultIntersectionType(
          ::ad::map::intersection::IntersectionType::Unknown);
  value.openDriveDefaultIntersectionType =
      valueOpenDriveDefaultIntersectionType;
  ::ad::map::landmark::TrafficLightType valueOpenDriveDefaultTrafficLightType(
      ::ad::map::landmark::TrafficLightType::INVALID);
  value.openDriveDefaultTrafficLightType =
      valueOpenDriveDefaultTrafficLightType;
  ASSERT_TRUE(withinValidInputRange(value));
}

TEST(MapEntryValidInputRangeTests,
     testValidInputRangeOpenDriveOverlapMarginTooSmall) {
  ::ad::map::config::MapEntry value;
  std::string valueFilename{"min"};
  value.filename = valueFilename;
  ::ad::physics::Distance valueOpenDriveOverlapMargin(-1e9);
...
TEST(MapEntryValidInputRangeTests,
     testValidInputRangeOpenDriveOverlapMarginTooBig) {
  ::ad::map::config::MapEntry value;
  std::string valueFilename{"min"};
  value.filename = valueFilename;
  ::ad::physics::Distance valueOpenDriveOverlapMargin(-1e9);
...
TEST(MapEntryValidInputRangeTests,
     testValidInputRangeopenDriveOverlapMarginDefault) {
  ::ad::map::config::MapEntry value;
...
TEST(MapEntryValidInputRangeTests,
     testValidInputRangeOpenDriveDefaultIntersectionTypeTooSmall) {
  ::ad::map::config::MapEntry value;
  std::string valueFilename{"min"};
  value.filename = valueFilename;
  ::ad::physics::Distance valueOpenDriveOverlapMargin(-1e9);
...
TEST(MapEntryValidInputRangeTests,
     testValidInputRangeOpenDriveDefaultIntersectionTypeTooBig) {
  ::ad::map::config::MapEntry value;
  std::string valueFilename{"min"};
  value.filename = valueFilename;
  ::ad::physics::Distance valueOpenDriveOverlapMargin(-1e9);
...
TEST(MapEntryValidInputRangeTests,
     testValidInputRangeOpenDriveDefaultTrafficLightTypeTooSmall) {
  ::ad::map::config::MapEntry value;
  std::string valueFilename{"min"};
  value.filename = valueFilename;
  ::ad::physics::Distance valueOpenDriveOverlapMargin(-1e9);
...
TEST(MapEntryValidInputRangeTests,
     testValidInputRangeOpenDriveDefaultTrafficLightTypeTooBig) {
  ::ad::map::config::MapEntry value;
  std::string valueFilename{"min"};
  value.filename = valueFilename;
  ::ad::physics::Distance valueOpenDriveOverlapMargin(-1e9);
