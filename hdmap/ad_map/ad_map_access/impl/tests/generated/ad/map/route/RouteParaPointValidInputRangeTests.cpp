...
TEST(RouteParaPointValidInputRangeTests,
     testValidInputRangeParametricOffsetTooSmall) {
  ::ad::map::route::RouteParaPoint value;
  ::ad::map::route::RoutePlanningCounter valueRoutePlanningCounter(
      std::numeric_limits<::ad::map::route::RoutePlanningCounter>::lowest());
  value.routePlanningCounter = valueRoutePlanningCounter;
  ...
  ::ad::physics::ParametricValue invalidInitializedMember(
...
TEST(RouteParaPointValidInputRangeTests,
     testValidInputRangeParametricOffsetTooBig) {
  ::ad::map::route::RouteParaPoint value;
  ::ad::map::route::RoutePlanningCounter valueRoutePlanningCounter(
      std::numeric_limits<::ad::map::route::RoutePlanningCounter>::lowest());
  value.routePlanningCounter = valueRoutePlanningCounter;
...
TEST(RouteParaPointValidInputRangeTests,
     testValidInputRangeparametricOffsetDefault) {
  ::ad::map::route::RouteParaPoint value;
