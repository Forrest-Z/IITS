...
class ConnectingRouteTests : public testing::Test {
 protected:
  virtual void SetUp() override {
    ...
    ::ad::map::route::ConnectingRouteType valueType(
    ...
    ::ad::map::route::LaneSegmentList
        valueRouteARoadSegmentsElementDrivableLaneSegments;
    ...
    ::ad::map::lane::LaneId
        valueRouteARoadSegmentsElementDrivableLaneSegmentsElementPredecessorsElement(
            1);
    ...
    ::ad::map::lane::LaneId
        valueRouteARoadSegmentsElementDrivableLaneSegmentsElementSuccessorsElement(
            1);
    ...
    valueRouteARoadSegmentsElement.drivableLaneSegments =
        valueRouteARoadSegmentsElementDrivableLaneSegments;
    ...
    ::ad::map::point::ECEFPoint
        valueRouteARoadSegmentsElementBoundingSphereCenter;
    ::ad::map::point::ECEFCoordinate
        valueRouteARoadSegmentsElementBoundingSphereCenterX(-6400000);
    valueRouteARoadSegmentsElementBoundingSphereCenter.x =
        valueRouteARoadSegmentsElementBoundingSphereCenterX;
    ::ad::map::point::ECEFCoordinate
        valueRouteARoadSegmentsElementBoundingSphereCenterY(-6400000);
    valueRouteARoadSegmentsElementBoundingSphereCenter.y =
        valueRouteARoadSegmentsElementBoundingSphereCenterY;
    ::ad::map::point::ECEFCoordinate
        valueRouteARoadSegmentsElementBoundingSphereCenterZ(-6400000);
    valueRouteARoadSegmentsElementBoundingSphereCenter.z =
        valueRouteARoadSegmentsElementBoundingSphereCenterZ;
    valueRouteARoadSegmentsElementBoundingSphere.center =
        valueRouteARoadSegmentsElementBoundingSphereCenter;
    ::ad::physics::Distance valueRouteARoadSegmentsElementBoundingSphereRadius(
        -1e9);
    valueRouteARoadSegmentsElementBoundingSphere.radius =
        valueRouteARoadSegmentsElementBoundingSphereRadius;
    valueRouteARoadSegmentsElement.boundingSphere =
        valueRouteARoadSegmentsElementBoundingSphere;
    ...
    ::ad::map::route::RouteCreationMode valueRouteARouteCreationMode(
    ...
    ::ad::map::lane::LaneId
        valueRouteBRoadSegmentsElementDrivableLaneSegmentsElementPredecessorsElement(
            1);
    ...
    ::ad::map::lane::LaneId
        valueRouteBRoadSegmentsElementDrivableLaneSegmentsElementSuccessorsElement(
            1);
    ...
    valueRouteBRoadSegmentsElement.drivableLaneSegments =
        valueRouteBRoadSegmentsElementDrivableLaneSegments;
    ::ad::map::route::SegmentCounter
    ...
    ::ad::map::point::ECEFCoordinate
        valueRouteBRoadSegmentsElementBoundingSphereCenterX(-6400000);
    valueRouteBRoadSegmentsElementBoundingSphereCenter.x =
        valueRouteBRoadSegmentsElementBoundingSphereCenterX;
    ::ad::map::point::ECEFCoordinate
        valueRouteBRoadSegmentsElementBoundingSphereCenterY(-6400000);
    valueRouteBRoadSegmentsElementBoundingSphereCenter.y =
        valueRouteBRoadSegmentsElementBoundingSphereCenterY;
    ::ad::map::point::ECEFCoordinate
        valueRouteBRoadSegmentsElementBoundingSphereCenterZ(-6400000);
    valueRouteBRoadSegmentsElementBoundingSphereCenter.z =
        valueRouteBRoadSegmentsElementBoundingSphereCenterZ;
    valueRouteBRoadSegmentsElementBoundingSphere.center =
        valueRouteBRoadSegmentsElementBoundingSphereCenter;
    ::ad::physics::Distance valueRouteBRoadSegmentsElementBoundingSphereRadius(
        -1e9);
    valueRouteBRoadSegmentsElementBoundingSphere.radius =
        valueRouteBRoadSegmentsElementBoundingSphereRadius;
    valueRouteBRoadSegmentsElement.boundingSphere =
        valueRouteBRoadSegmentsElementBoundingSphere;
    ...
    ::ad::map::route::RouteCreationMode valueRouteBRouteCreationMode(
        ::ad::map::route::RouteCreationMode::Undefined);
...
TEST_F(ConnectingRouteTests, comparisonOperatorTypeDiffers) {
  ::ad::map::route::ConnectingRoute valueA = mValue;
  ::ad::map::route::ConnectingRouteType type(
...
TEST_F(ConnectingRouteTests, comparisonOperatorRouteADiffers) {
  ...
  ::ad::map::route::LaneSegment
      routeARoadSegmentsElementDrivableLaneSegmentsElement;
  ::ad::map::lane::LaneId
  ...
  ::ad::map::lane::LaneId
      routeARoadSegmentsElementDrivableLaneSegmentsElementPredecessorsElement(
          std::numeric_limits<::ad::map::lane::LaneId>::max());
  ...
  ::ad::map::lane::LaneId
      routeARoadSegmentsElementDrivableLaneSegmentsElementSuccessorsElement(
          std::numeric_limits<::ad::map::lane::LaneId>::max());
  ...
  routeARoadSegmentsElementDrivableLaneSegmentsElementLaneInterval.laneId =
      routeARoadSegmentsElementDrivableLaneSegmentsElementLaneIntervalLaneId;
  ::ad::physics::ParametricValue
      routeARoadSegmentsElementDrivableLaneSegmentsElementLaneIntervalStart(1.);
  ...
  ::ad::physics::ParametricValue
      routeARoadSegmentsElementDrivableLaneSegmentsElementLaneIntervalEnd(1.);
  ...
  bool routeARoadSegmentsElementDrivableLaneSegmentsElementLaneIntervalWrongWay{
      false};
  ...
  routeARoadSegmentsElementDrivableLaneSegmentsElement.routeLaneOffset =
      routeARoadSegmentsElementDrivableLaneSegmentsElementRouteLaneOffset;
  routeARoadSegmentsElementDrivableLaneSegments.resize(
      2, routeARoadSegmentsElementDrivableLaneSegmentsElement);
  routeARoadSegmentsElement.drivableLaneSegments =
      routeARoadSegmentsElementDrivableLaneSegments;
  ::ad::map::route::SegmentCounter
      routeARoadSegmentsElementSegmentCountFromDestination(
          std::numeric_limits<::ad::map::route::SegmentCounter>::max());
  routeARoadSegmentsElement.segmentCountFromDestination =
      routeARoadSegmentsElementSegmentCountFromDestination;
  ...
  ::ad::map::point::ECEFCoordinate
      routeARoadSegmentsElementBoundingSphereCenterX(6400000);
  routeARoadSegmentsElementBoundingSphereCenter.x =
      routeARoadSegmentsElementBoundingSphereCenterX;
  ::ad::map::point::ECEFCoordinate
      routeARoadSegmentsElementBoundingSphereCenterY(6400000);
  routeARoadSegmentsElementBoundingSphereCenter.y =
      routeARoadSegmentsElementBoundingSphereCenterY;
  ::ad::map::point::ECEFCoordinate
      routeARoadSegmentsElementBoundingSphereCenterZ(6400000);
  routeARoadSegmentsElementBoundingSphereCenter.z =
      routeARoadSegmentsElementBoundingSphereCenterZ;
  routeARoadSegmentsElementBoundingSphere.center =
      routeARoadSegmentsElementBoundingSphereCenter;
  ::ad::physics::Distance routeARoadSegmentsElementBoundingSphereRadius(1e9);
  routeARoadSegmentsElementBoundingSphere.radius =
      routeARoadSegmentsElementBoundingSphereRadius;
  routeARoadSegmentsElement.boundingSphere =
      routeARoadSegmentsElementBoundingSphere;
  ...
  ::ad::map::route::RouteLaneOffset routeAMinLaneOffset(
      std::numeric_limits<::ad::map::route::RouteLaneOffset>::max());
  routeA.minLaneOffset = routeAMinLaneOffset;
  ::ad::map::route::RouteLaneOffset routeAMaxLaneOffset(
      std::numeric_limits<::ad::map::route::RouteLaneOffset>::max());
  routeA.maxLaneOffset = routeAMaxLaneOffset;
  ::ad::map::route::RouteCreationMode routeARouteCreationMode(
...
TEST_F(ConnectingRouteTests, comparisonOperatorRouteBDiffers) {
  ...
  ::ad::map::route::LaneSegment
      routeBRoadSegmentsElementDrivableLaneSegmentsElement;
  ::ad::map::lane::LaneId
  ...
  ::ad::map::lane::LaneId
      routeBRoadSegmentsElementDrivableLaneSegmentsElementPredecessorsElement(
          std::numeric_limits<::ad::map::lane::LaneId>::max());
  ...
  ::ad::map::lane::LaneId
      routeBRoadSegmentsElementDrivableLaneSegmentsElementSuccessorsElement(
          std::numeric_limits<::ad::map::lane::LaneId>::max());
  ...
  routeBRoadSegmentsElementDrivableLaneSegmentsElementLaneInterval.laneId =
      routeBRoadSegmentsElementDrivableLaneSegmentsElementLaneIntervalLaneId;
  ::ad::physics::ParametricValue
      routeBRoadSegmentsElementDrivableLaneSegmentsElementLaneIntervalStart(1.);
  ...
  ::ad::physics::ParametricValue
      routeBRoadSegmentsElementDrivableLaneSegmentsElementLaneIntervalEnd(1.);
  ...
  bool routeBRoadSegmentsElementDrivableLaneSegmentsElementLaneIntervalWrongWay{
      false};
  ...
  routeBRoadSegmentsElementDrivableLaneSegmentsElement.routeLaneOffset =
      routeBRoadSegmentsElementDrivableLaneSegmentsElementRouteLaneOffset;
  routeBRoadSegmentsElementDrivableLaneSegments.resize(
      2, routeBRoadSegmentsElementDrivableLaneSegmentsElement);
  routeBRoadSegmentsElement.drivableLaneSegments =
      routeBRoadSegmentsElementDrivableLaneSegments;
  ::ad::map::route::SegmentCounter
      routeBRoadSegmentsElementSegmentCountFromDestination(
          std::numeric_limits<::ad::map::route::SegmentCounter>::max());
  routeBRoadSegmentsElement.segmentCountFromDestination =
      routeBRoadSegmentsElementSegmentCountFromDestination;
  ...
  ::ad::map::point::ECEFCoordinate
      routeBRoadSegmentsElementBoundingSphereCenterX(6400000);
  routeBRoadSegmentsElementBoundingSphereCenter.x =
      routeBRoadSegmentsElementBoundingSphereCenterX;
  ::ad::map::point::ECEFCoordinate
      routeBRoadSegmentsElementBoundingSphereCenterY(6400000);
  routeBRoadSegmentsElementBoundingSphereCenter.y =
      routeBRoadSegmentsElementBoundingSphereCenterY;
  ::ad::map::point::ECEFCoordinate
      routeBRoadSegmentsElementBoundingSphereCenterZ(6400000);
  routeBRoadSegmentsElementBoundingSphereCenter.z =
      routeBRoadSegmentsElementBoundingSphereCenterZ;
  routeBRoadSegmentsElementBoundingSphere.center =
      routeBRoadSegmentsElementBoundingSphereCenter;
  ::ad::physics::Distance routeBRoadSegmentsElementBoundingSphereRadius(1e9);
  routeBRoadSegmentsElementBoundingSphere.radius =
      routeBRoadSegmentsElementBoundingSphereRadius;
  routeBRoadSegmentsElement.boundingSphere =
      routeBRoadSegmentsElementBoundingSphere;
  ...
  ::ad::map::route::RouteLaneOffset routeBMinLaneOffset(
      std::numeric_limits<::ad::map::route::RouteLaneOffset>::max());
  routeB.minLaneOffset = routeBMinLaneOffset;
  ::ad::map::route::RouteLaneOffset routeBMaxLaneOffset(
      std::numeric_limits<::ad::map::route::RouteLaneOffset>::max());
  routeB.maxLaneOffset = routeBMaxLaneOffset;
  ::ad::map::route::RouteCreationMode routeBRouteCreationMode(
      ::ad::map::route::RouteCreationMode::AllNeighborLanes);
