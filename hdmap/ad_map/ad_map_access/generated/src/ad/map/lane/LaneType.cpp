...
std::string toString(::ad::map::lane::LaneType const e) {
  switch (e) {
    case ::ad::map::lane::LaneType::INVALID:
      return std::string(
          "::ad::map::lane::LaneType::INVALID");  // LCOV_EXCL_BR_LINE
    case ::ad::map::lane::LaneType::UNKNOWN:
      return std::string(
          "::ad::map::lane::LaneType::UNKNOWN");  // LCOV_EXCL_BR_LINE
    case ::ad::map::lane::LaneType::NORMAL:
      return std::string(
          "::ad::map::lane::LaneType::NORMAL");  // LCOV_EXCL_BR_LINE
    case ::ad::map::lane::LaneType::INTERSECTION:
      return std::string(
          "::ad::map::lane::LaneType::INTERSECTION");  // LCOV_EXCL_BR_LINE
    case ::ad::map::lane::LaneType::SHOULDER:
      return std::string(
          "::ad::map::lane::LaneType::SHOULDER");  // LCOV_EXCL_BR_LINE
    case ::ad::map::lane::LaneType::EMERGENCY:
      return std::string(
          "::ad::map::lane::LaneType::EMERGENCY");  // LCOV_EXCL_BR_LINE
    case ::ad::map::lane::LaneType::MULTI:
      return std::string(
          "::ad::map::lane::LaneType::MULTI");  // LCOV_EXCL_BR_LINE
    case ::ad::map::lane::LaneType::PEDESTRIAN:
      return std::string(
          "::ad::map::lane::LaneType::PEDESTRIAN");  // LCOV_EXCL_BR_LINE
    case ::ad::map::lane::LaneType::OVERTAKING:
      return std::string(
          "::ad::map::lane::LaneType::OVERTAKING");  // LCOV_EXCL_BR_LINE
    case ::ad::map::lane::LaneType::TURN:
      return std::string(
          "::ad::map::lane::LaneType::TURN");  // LCOV_EXCL_BR_LINE
    case ::ad::map::lane::LaneType::BIKE:
      return std::string(
          "::ad::map::lane::LaneType::BIKE");  // LCOV_EXCL_BR_LINE
    default:
...
::ad::map::lane::LaneType fromString(std::string const &str) {
  if (str ==
      std::string("::ad::map::lane::LaneType::INVALID"))  // LCOV_EXCL_BR_LINE
  {
  ...
  if (str ==
      std::string("::ad::map::lane::LaneType::UNKNOWN"))  // LCOV_EXCL_BR_LINE
  {
  ...
  if (str ==
      std::string("::ad::map::lane::LaneType::NORMAL"))  // LCOV_EXCL_BR_LINE
  {
  ...
  if (str ==
      std::string("::ad::map::lane::LaneType::SHOULDER"))  // LCOV_EXCL_BR_LINE
  {
  ...
  if (str ==
      std::string("::ad::map::lane::LaneType::EMERGENCY"))  // LCOV_EXCL_BR_LINE
  {
  ...
  if (str ==
      std::string("::ad::map::lane::LaneType::MULTI"))  // LCOV_EXCL_BR_LINE
  {
  ...
  if (str ==
      std::string("::ad::map::lane::LaneType::TURN"))  // LCOV_EXCL_BR_LINE
  {
  ...
  if (str ==
      std::string("::ad::map::lane::LaneType::BIKE"))  // LCOV_EXCL_BR_LINE
  {
