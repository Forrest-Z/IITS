...
std::string toString(::ad::map::lane::ContactLocation const e) {
  switch (e) {
    case ::ad::map::lane::ContactLocation::INVALID:
      return std::string(
          "::ad::map::lane::ContactLocation::INVALID");  // LCOV_EXCL_BR_LINE
    case ::ad::map::lane::ContactLocation::UNKNOWN:
      return std::string(
          "::ad::map::lane::ContactLocation::UNKNOWN");  // LCOV_EXCL_BR_LINE
    case ::ad::map::lane::ContactLocation::LEFT:
      return std::string(
          "::ad::map::lane::ContactLocation::LEFT");  // LCOV_EXCL_BR_LINE
    case ::ad::map::lane::ContactLocation::RIGHT:
      return std::string(
          "::ad::map::lane::ContactLocation::RIGHT");  // LCOV_EXCL_BR_LINE
    case ::ad::map::lane::ContactLocation::SUCCESSOR:
      return std::string(
          "::ad::map::lane::ContactLocation::SUCCESSOR");  // LCOV_EXCL_BR_LINE
    case ::ad::map::lane::ContactLocation::PREDECESSOR:
      return std::string(
          "::ad::map::lane::ContactLocation::PREDECESSOR");  // LCOV_EXCL_BR_LINE
    case ::ad::map::lane::ContactLocation::OVERLAP:
      return std::string(
          "::ad::map::lane::ContactLocation::OVERLAP");  // LCOV_EXCL_BR_LINE
    default:
...
template <>
::ad::map::lane::ContactLocation fromString(std::string const &str) {
  if (str ==
      std::string(
          "::ad::map::lane::ContactLocation::INVALID"))  // LCOV_EXCL_BR_LINE
  {
