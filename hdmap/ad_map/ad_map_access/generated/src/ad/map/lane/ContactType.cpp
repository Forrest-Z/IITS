...
std::string toString(::ad::map::lane::ContactType const e) {
  switch (e) {
    case ::ad::map::lane::ContactType::INVALID:
      return std::string(
          "::ad::map::lane::ContactType::INVALID");  // LCOV_EXCL_BR_LINE
    case ::ad::map::lane::ContactType::UNKNOWN:
      return std::string(
          "::ad::map::lane::ContactType::UNKNOWN");  // LCOV_EXCL_BR_LINE
    case ::ad::map::lane::ContactType::FREE:
      return std::string(
          "::ad::map::lane::ContactType::FREE");  // LCOV_EXCL_BR_LINE
    case ::ad::map::lane::ContactType::LANE_CHANGE:
      return std::string(
          "::ad::map::lane::ContactType::LANE_CHANGE");  // LCOV_EXCL_BR_LINE
    case ::ad::map::lane::ContactType::LANE_CONTINUATION:
      return std::string(
          "::ad::map::lane::ContactType::LANE_CONTINUATION");  // LCOV_EXCL_BR_LINE
    case ::ad::map::lane::ContactType::LANE_END:
      return std::string(
          "::ad::map::lane::ContactType::LANE_END");  // LCOV_EXCL_BR_LINE
    case ::ad::map::lane::ContactType::SINGLE_POINT:
      return std::string(
          "::ad::map::lane::ContactType::SINGLE_POINT");  // LCOV_EXCL_BR_LINE
    case ::ad::map::lane::ContactType::STOP:
      return std::string(
          "::ad::map::lane::ContactType::STOP");  // LCOV_EXCL_BR_LINE
    case ::ad::map::lane::ContactType::STOP_ALL:
      return std::string(
          "::ad::map::lane::ContactType::STOP_ALL");  // LCOV_EXCL_BR_LINE
    case ::ad::map::lane::ContactType::YIELD:
      return std::string(
          "::ad::map::lane::ContactType::YIELD");  // LCOV_EXCL_BR_LINE
    case ::ad::map::lane::ContactType::GATE_BARRIER:
      return std::string(
          "::ad::map::lane::ContactType::GATE_BARRIER");  // LCOV_EXCL_BR_LINE
    case ::ad::map::lane::ContactType::GATE_TOLBOOTH:
      return std::string(
          "::ad::map::lane::ContactType::GATE_TOLBOOTH");  // LCOV_EXCL_BR_LINE
    case ::ad::map::lane::ContactType::GATE_SPIKES:
      return std::string(
          "::ad::map::lane::ContactType::GATE_SPIKES");  // LCOV_EXCL_BR_LINE
    case ::ad::map::lane::ContactType::GATE_SPIKES_CONTRA:
      return std::string(
          "::ad::map::lane::ContactType::GATE_SPIKES_CONTRA");  // LCOV_EXCL_BR_LINE
    case ::ad::map::lane::ContactType::CURB_UP:
      return std::string(
          "::ad::map::lane::ContactType::CURB_UP");  // LCOV_EXCL_BR_LINE
    case ::ad::map::lane::ContactType::CURB_DOWN:
      return std::string(
          "::ad::map::lane::ContactType::CURB_DOWN");  // LCOV_EXCL_BR_LINE
    case ::ad::map::lane::ContactType::SPEED_BUMP:
      return std::string(
          "::ad::map::lane::ContactType::SPEED_BUMP");  // LCOV_EXCL_BR_LINE
    case ::ad::map::lane::ContactType::TRAFFIC_LIGHT:
      return std::string(
          "::ad::map::lane::ContactType::TRAFFIC_LIGHT");  // LCOV_EXCL_BR_LINE
    case ::ad::map::lane::ContactType::CROSSWALK:
      return std::string(
          "::ad::map::lane::ContactType::CROSSWALK");  // LCOV_EXCL_BR_LINE
    case ::ad::map::lane::ContactType::PRIO_TO_RIGHT:
      return std::string(
          "::ad::map::lane::ContactType::PRIO_TO_RIGHT");  // LCOV_EXCL_BR_LINE
    case ::ad::map::lane::ContactType::RIGHT_OF_WAY:
      return std::string(
          "::ad::map::lane::ContactType::RIGHT_OF_WAY");  // LCOV_EXCL_BR_LINE
    case ::ad::map::lane::ContactType::PRIO_TO_RIGHT_AND_STRAIGHT:
      return std::string(
          "::ad::map::lane::ContactType::PRIO_TO_RIGHT_AND_STRAIGHT");  // LCOV_EXCL_BR_LINE
    default:
...
::ad::map::lane::ContactType fromString(std::string const &str) {
  ...
  if (str ==
      std::string("::ad::map::lane::ContactType::FREE"))  // LCOV_EXCL_BR_LINE
  {
  ...
  if (str ==
      std::string("::ad::map::lane::ContactType::STOP"))  // LCOV_EXCL_BR_LINE
  {
  ...
  if (str ==
      std::string("::ad::map::lane::ContactType::YIELD"))  // LCOV_EXCL_BR_LINE
  {
  ...
  if (str == std::string("::ad::map::lane::ContactType::PRIO_TO_RIGHT_AND_"
