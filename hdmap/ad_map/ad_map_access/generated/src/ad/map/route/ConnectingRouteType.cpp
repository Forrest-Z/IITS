...
std::string toString(::ad::map::route::ConnectingRouteType const e) {
  switch (e) {
    case ::ad::map::route::ConnectingRouteType::Invalid:
      return std::string(
          "::ad::map::route::ConnectingRouteType::Invalid");  // LCOV_EXCL_BR_LINE
    case ::ad::map::route::ConnectingRouteType::Following:
      return std::string(
          "::ad::map::route::ConnectingRouteType::Following");  // LCOV_EXCL_BR_LINE
    case ::ad::map::route::ConnectingRouteType::Opposing:
      return std::string(
          "::ad::map::route::ConnectingRouteType::Opposing");  // LCOV_EXCL_BR_LINE
    case ::ad::map::route::ConnectingRouteType::Merging:
      return std::string(
          "::ad::map::route::ConnectingRouteType::Merging");  // LCOV_EXCL_BR_LINE
    default:
...
template <>
::ad::map::route::ConnectingRouteType fromString(std::string const &str) {
  if (str ==
      std::string(
          "::ad::map::route::ConnectingRouteType::Invalid"))  // LCOV_EXCL_BR_LINE
  {
