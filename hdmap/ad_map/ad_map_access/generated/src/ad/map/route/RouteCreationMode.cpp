...
std::string toString(::ad::map::route::RouteCreationMode const e) {
  switch (e) {
    case ::ad::map::route::RouteCreationMode::Undefined:
      return std::string(
          "::ad::map::route::RouteCreationMode::Undefined");  // LCOV_EXCL_BR_LINE
    case ::ad::map::route::RouteCreationMode::SameDrivingDirection:
      return std::string(
          "::ad::map::route::RouteCreationMode::SameDrivingDirection");  // LCOV_EXCL_BR_LINE
    case ::ad::map::route::RouteCreationMode::AllRoutableLanes:
      return std::string(
          "::ad::map::route::RouteCreationMode::AllRoutableLanes");  // LCOV_EXCL_BR_LINE
    case ::ad::map::route::RouteCreationMode::AllNeighborLanes:
      return std::string(
          "::ad::map::route::RouteCreationMode::AllNeighborLanes");  // LCOV_EXCL_BR_LINE
    default:
...
template <>
::ad::map::route::RouteCreationMode fromString(std::string const &str) {
  if (str ==
      std::string(
          "::ad::map::route::RouteCreationMode::Undefined"))  // LCOV_EXCL_BR_LINE
  {
  ...
  if (str == std::string("::ad::map::route::RouteCreationMode::"
                         "SameDrivingDirection"))  // LCOV_EXCL_BR_LINE
  {
  ...
  if (str == std::string("::ad::map::route::RouteCreationMode::"
                         "AllRoutableLanes"))  // LCOV_EXCL_BR_LINE
  {
  ...
  if (str == std::string("::ad::map::route::RouteCreationMode::"
                         "AllNeighborLanes"))  // LCOV_EXCL_BR_LINE
  {
