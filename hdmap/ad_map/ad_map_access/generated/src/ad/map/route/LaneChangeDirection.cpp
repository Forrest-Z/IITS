...
std::string toString(::ad::map::route::LaneChangeDirection const e) {
  switch (e) {
    case ::ad::map::route::LaneChangeDirection::LeftToRight:
      return std::string(
          "::ad::map::route::LaneChangeDirection::LeftToRight");  // LCOV_EXCL_BR_LINE
    case ::ad::map::route::LaneChangeDirection::RightToLeft:
      return std::string(
          "::ad::map::route::LaneChangeDirection::RightToLeft");  // LCOV_EXCL_BR_LINE
    case ::ad::map::route::LaneChangeDirection::Invalid:
      return std::string(
          "::ad::map::route::LaneChangeDirection::Invalid");  // LCOV_EXCL_BR_LINE
    default:
...
template <>
::ad::map::route::LaneChangeDirection fromString(std::string const &str) {
  if (str ==
      std::string(
          "::ad::map::route::LaneChangeDirection::LeftToRight"))  // LCOV_EXCL_BR_LINE
  {
