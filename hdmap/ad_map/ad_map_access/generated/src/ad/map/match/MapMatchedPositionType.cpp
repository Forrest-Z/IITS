...
std::string toString(::ad::map::match::MapMatchedPositionType const e) {
  switch (e) {
    case ::ad::map::match::MapMatchedPositionType::INVALID:
      return std::string(
          "::ad::map::match::MapMatchedPositionType::INVALID");  // LCOV_EXCL_BR_LINE
    case ::ad::map::match::MapMatchedPositionType::UNKNOWN:
      return std::string(
          "::ad::map::match::MapMatchedPositionType::UNKNOWN");  // LCOV_EXCL_BR_LINE
    case ::ad::map::match::MapMatchedPositionType::LANE_IN:
      return std::string(
          "::ad::map::match::MapMatchedPositionType::LANE_IN");  // LCOV_EXCL_BR_LINE
    case ::ad::map::match::MapMatchedPositionType::LANE_LEFT:
      return std::string(
          "::ad::map::match::MapMatchedPositionType::LANE_LEFT");  // LCOV_EXCL_BR_LINE
    case ::ad::map::match::MapMatchedPositionType::LANE_RIGHT:
      return std::string(
          "::ad::map::match::MapMatchedPositionType::LANE_RIGHT");  // LCOV_EXCL_BR_LINE
    default:
...
template <>
::ad::map::match::MapMatchedPositionType fromString(std::string const &str) {
  if (str ==
      std::string(
          "::ad::map::match::MapMatchedPositionType::INVALID"))  // LCOV_EXCL_BR_LINE
  {
  ...
  if (str == std::string("::ad::map::match::MapMatchedPositionType::LANE_"
