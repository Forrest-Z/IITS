...
std::string toString(::ad::map::restriction::RoadUserType const e) {
  switch (e) {
    case ::ad::map::restriction::RoadUserType::INVALID:
      return std::string(
          "::ad::map::restriction::RoadUserType::INVALID");  // LCOV_EXCL_BR_LINE
    case ::ad::map::restriction::RoadUserType::UNKNOWN:
      return std::string(
          "::ad::map::restriction::RoadUserType::UNKNOWN");  // LCOV_EXCL_BR_LINE
    case ::ad::map::restriction::RoadUserType::CAR:
      return std::string(
          "::ad::map::restriction::RoadUserType::CAR");  // LCOV_EXCL_BR_LINE
    case ::ad::map::restriction::RoadUserType::BUS:
      return std::string(
          "::ad::map::restriction::RoadUserType::BUS");  // LCOV_EXCL_BR_LINE
    case ::ad::map::restriction::RoadUserType::TRUCK:
      return std::string(
          "::ad::map::restriction::RoadUserType::TRUCK");  // LCOV_EXCL_BR_LINE
    case ::ad::map::restriction::RoadUserType::PEDESTRIAN:
      return std::string(
          "::ad::map::restriction::RoadUserType::PEDESTRIAN");  // LCOV_EXCL_BR_LINE
    case ::ad::map::restriction::RoadUserType::MOTORBIKE:
      return std::string(
          "::ad::map::restriction::RoadUserType::MOTORBIKE");  // LCOV_EXCL_BR_LINE
    case ::ad::map::restriction::RoadUserType::BICYCLE:
      return std::string(
          "::ad::map::restriction::RoadUserType::BICYCLE");  // LCOV_EXCL_BR_LINE
    case ::ad::map::restriction::RoadUserType::CAR_ELECTRIC:
      return std::string(
          "::ad::map::restriction::RoadUserType::CAR_ELECTRIC");  // LCOV_EXCL_BR_LINE
    case ::ad::map::restriction::RoadUserType::CAR_HYBRID:
      return std::string(
          "::ad::map::restriction::RoadUserType::CAR_HYBRID");  // LCOV_EXCL_BR_LINE
    case ::ad::map::restriction::RoadUserType::CAR_PETROL:
      return std::string(
          "::ad::map::restriction::RoadUserType::CAR_PETROL");  // LCOV_EXCL_BR_LINE
    case ::ad::map::restriction::RoadUserType::CAR_DIESEL:
      return std::string(
          "::ad::map::restriction::RoadUserType::CAR_DIESEL");  // LCOV_EXCL_BR_LINE
    default:
