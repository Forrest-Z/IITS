...
std::string toString(::ad::map::intersection::IntersectionType const e) {
  switch (e) {
    case ::ad::map::intersection::IntersectionType::Unknown:
      return std::string(
          "::ad::map::intersection::IntersectionType::Unknown");  // LCOV_EXCL_BR_LINE
    case ::ad::map::intersection::IntersectionType::Yield:
      return std::string(
          "::ad::map::intersection::IntersectionType::Yield");  // LCOV_EXCL_BR_LINE
    case ::ad::map::intersection::IntersectionType::Stop:
      return std::string(
          "::ad::map::intersection::IntersectionType::Stop");  // LCOV_EXCL_BR_LINE
    case ::ad::map::intersection::IntersectionType::AllWayStop:
      return std::string(
          "::ad::map::intersection::IntersectionType::AllWayStop");  // LCOV_EXCL_BR_LINE
    case ::ad::map::intersection::IntersectionType::HasWay:
      return std::string(
          "::ad::map::intersection::IntersectionType::HasWay");  // LCOV_EXCL_BR_LINE
    case ::ad::map::intersection::IntersectionType::Crosswalk:
      return std::string(
          "::ad::map::intersection::IntersectionType::Crosswalk");  // LCOV_EXCL_BR_LINE
    case ::ad::map::intersection::IntersectionType::PriorityToRight:
      return std::string(
          "::ad::map::intersection::IntersectionType::PriorityToRight");  // LCOV_EXCL_BR_LINE
    case ::ad::map::intersection::IntersectionType::PriorityToRightAndStraight:
      return std::string(
          "::ad::map::intersection::IntersectionType::"
          "PriorityToRightAndStraight");  // LCOV_EXCL_BR_LINE
    case ::ad::map::intersection::IntersectionType::TrafficLight:
      return std::string(
          "::ad::map::intersection::IntersectionType::TrafficLight");  // LCOV_EXCL_BR_LINE
    default:
...
template <>
::ad::map::intersection::IntersectionType fromString(std::string const &str) {
  if (str ==
      std::string(
          "::ad::map::intersection::IntersectionType::Unknown"))  // LCOV_EXCL_BR_LINE
  {
  ...
  if (str == std::string("::ad::map::intersection::IntersectionType::"
                         "AllWayStop"))  // LCOV_EXCL_BR_LINE
  {
  ...
  if (str == std::string("::ad::map::intersection::IntersectionType::"
                         "PriorityToRight"))  // LCOV_EXCL_BR_LINE
  {
  ...
  if (str == std::string("::ad::map::intersection::IntersectionType::"
                         "PriorityToRightAndStraight"))  // LCOV_EXCL_BR_LINE
  {
    return ::ad::map::intersection::IntersectionType::
  ...
  if (str == std::string("::ad::map::intersection::IntersectionType::"
                         "TrafficLight"))  // LCOV_EXCL_BR_LINE
  {
