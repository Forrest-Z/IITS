...
std::string toString(::ad::map::access::TrafficType const e) {
  switch (e) {
    case ::ad::map::access::TrafficType::INVALID:
      return std::string(
          "::ad::map::access::TrafficType::INVALID");  // LCOV_EXCL_BR_LINE
    case ::ad::map::access::TrafficType::LEFT_HAND_TRAFFIC:
      return std::string(
          "::ad::map::access::TrafficType::LEFT_HAND_TRAFFIC");  // LCOV_EXCL_BR_LINE
    case ::ad::map::access::TrafficType::RIGHT_HAND_TRAFFIC:
      return std::string(
          "::ad::map::access::TrafficType::RIGHT_HAND_TRAFFIC");  // LCOV_EXCL_BR_LINE
    default:
...
template <>
::ad::map::access::TrafficType fromString(std::string const &str) {
  if (str ==
      std::string(
          "::ad::map::access::TrafficType::INVALID"))  // LCOV_EXCL_BR_LINE
  {
