...
std::string toString(::ad::map::landmark::LandmarkType const e) {
  switch (e) {
    case ::ad::map::landmark::LandmarkType::INVALID:
      return std::string(
          "::ad::map::landmark::LandmarkType::INVALID");  // LCOV_EXCL_BR_LINE
    case ::ad::map::landmark::LandmarkType::UNKNOWN:
      return std::string(
          "::ad::map::landmark::LandmarkType::UNKNOWN");  // LCOV_EXCL_BR_LINE
    case ::ad::map::landmark::LandmarkType::TRAFFIC_SIGN:
      return std::string(
          "::ad::map::landmark::LandmarkType::TRAFFIC_SIGN");  // LCOV_EXCL_BR_LINE
    case ::ad::map::landmark::LandmarkType::TRAFFIC_LIGHT:
      return std::string(
          "::ad::map::landmark::LandmarkType::TRAFFIC_LIGHT");  // LCOV_EXCL_BR_LINE
    case ::ad::map::landmark::LandmarkType::POLE:
      return std::string(
          "::ad::map::landmark::LandmarkType::POLE");  // LCOV_EXCL_BR_LINE
    case ::ad::map::landmark::LandmarkType::GUIDE_POST:
      return std::string(
          "::ad::map::landmark::LandmarkType::GUIDE_POST");  // LCOV_EXCL_BR_LINE
    case ::ad::map::landmark::LandmarkType::TREE:
      return std::string(
          "::ad::map::landmark::LandmarkType::TREE");  // LCOV_EXCL_BR_LINE
    case ::ad::map::landmark::LandmarkType::STREET_LAMP:
      return std::string(
          "::ad::map::landmark::LandmarkType::STREET_LAMP");  // LCOV_EXCL_BR_LINE
    case ::ad::map::landmark::LandmarkType::POSTBOX:
      return std::string(
          "::ad::map::landmark::LandmarkType::POSTBOX");  // LCOV_EXCL_BR_LINE
    case ::ad::map::landmark::LandmarkType::MANHOLE:
      return std::string(
          "::ad::map::landmark::LandmarkType::MANHOLE");  // LCOV_EXCL_BR_LINE
    case ::ad::map::landmark::LandmarkType::POWERCABINET:
      return std::string(
          "::ad::map::landmark::LandmarkType::POWERCABINET");  // LCOV_EXCL_BR_LINE
    case ::ad::map::landmark::LandmarkType::FIRE_HYDRANT:
      return std::string(
          "::ad::map::landmark::LandmarkType::FIRE_HYDRANT");  // LCOV_EXCL_BR_LINE
    case ::ad::map::landmark::LandmarkType::BOLLARD:
      return std::string(
          "::ad::map::landmark::LandmarkType::BOLLARD");  // LCOV_EXCL_BR_LINE
    case ::ad::map::landmark::LandmarkType::OTHER:
      return std::string(
          "::ad::map::landmark::LandmarkType::OTHER");  // LCOV_EXCL_BR_LINE
    default:
