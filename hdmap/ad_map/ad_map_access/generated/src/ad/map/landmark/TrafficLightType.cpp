...
std::string toString(::ad::map::landmark::TrafficLightType const e) {
  switch (e) {
    case ::ad::map::landmark::TrafficLightType::INVALID:
      return std::string(
          "::ad::map::landmark::TrafficLightType::INVALID");  // LCOV_EXCL_BR_LINE
    case ::ad::map::landmark::TrafficLightType::UNKNOWN:
      return std::string(
          "::ad::map::landmark::TrafficLightType::UNKNOWN");  // LCOV_EXCL_BR_LINE
    case ::ad::map::landmark::TrafficLightType::SOLID_RED_YELLOW:
      return std::string(
          "::ad::map::landmark::TrafficLightType::SOLID_RED_YELLOW");  // LCOV_EXCL_BR_LINE
    case ::ad::map::landmark::TrafficLightType::SOLID_RED_YELLOW_GREEN:
      return std::string(
          "::ad::map::landmark::TrafficLightType::SOLID_RED_YELLOW_GREEN");  // LCOV_EXCL_BR_LINE
    case ::ad::map::landmark::TrafficLightType::LEFT_RED_YELLOW_GREEN:
      return std::string(
          "::ad::map::landmark::TrafficLightType::LEFT_RED_YELLOW_GREEN");  // LCOV_EXCL_BR_LINE
    case ::ad::map::landmark::TrafficLightType::RIGHT_RED_YELLOW_GREEN:
      return std::string(
          "::ad::map::landmark::TrafficLightType::RIGHT_RED_YELLOW_GREEN");  // LCOV_EXCL_BR_LINE
    case ::ad::map::landmark::TrafficLightType::STRAIGHT_RED_YELLOW_GREEN:
      return std::
          string(
              "::ad::map::landmark::TrafficLightType::STRAIGHT_RED_YELLOW_"
              "GREEN");  // LCOV_EXCL_BR_LINE
    case ::ad::map::landmark::TrafficLightType::LEFT_STRAIGHT_RED_YELLOW_GREEN:
      return std::string(
          "::ad::map::landmark::TrafficLightType::LEFT_STRAIGHT_RED_YELLOW_"
          "GREEN");  // LCOV_EXCL_BR_LINE
    case ::ad::map::landmark::TrafficLightType::RIGHT_STRAIGHT_RED_YELLOW_GREEN:
      return std::string(
          "::ad::map::landmark::TrafficLightType::RIGHT_STRAIGHT_RED_YELLOW_"
          "GREEN");  // LCOV_EXCL_BR_LINE
    case ::ad::map::landmark::TrafficLightType::PEDESTRIAN_RED_GREEN:
      return std::string(
          "::ad::map::landmark::TrafficLightType::PEDESTRIAN_RED_GREEN");  // LCOV_EXCL_BR_LINE
    case ::ad::map::landmark::TrafficLightType::BIKE_RED_GREEN:
      return std::string(
          "::ad::map::landmark::TrafficLightType::BIKE_RED_GREEN");  // LCOV_EXCL_BR_LINE
    case ::ad::map::landmark::TrafficLightType::BIKE_PEDESTRIAN_RED_GREEN:
      return std::
          string(
              "::ad::map::landmark::TrafficLightType::BIKE_PEDESTRIAN_RED_"
              "GREEN");  // LCOV_EXCL_BR_LINE
    case ::ad::map::landmark::TrafficLightType::PEDESTRIAN_RED_YELLOW_GREEN:
      return std::
          string(
              "::ad::map::landmark::TrafficLightType::PEDESTRIAN_RED_YELLOW_"
              "GREEN");  // LCOV_EXCL_BR_LINE
    case ::ad::map::landmark::TrafficLightType::BIKE_RED_YELLOW_GREEN:
      return std::string(
          "::ad::map::landmark::TrafficLightType::BIKE_RED_YELLOW_GREEN");  // LCOV_EXCL_BR_LINE
    case ::ad::map::landmark::TrafficLightType::
        BIKE_PEDESTRIAN_RED_YELLOW_GREEN:
      return std::string(
          "::ad::map::landmark::TrafficLightType::BIKE_PEDESTRIAN_RED_YELLOW_"
          "GREEN");  // LCOV_EXCL_BR_LINE
    default:
...
template <>
::ad::map::landmark::TrafficLightType fromString(std::string const &str) {
  if (str ==
      std::string(
          "::ad::map::landmark::TrafficLightType::INVALID"))  // LCOV_EXCL_BR_LINE
  {
  ...
  if (str == std::string("::ad::map::landmark::TrafficLightType::SOLID_RED_"
                         "YELLOW"))  // LCOV_EXCL_BR_LINE
  {
  ...
  if (str == std::string("::ad::map::landmark::TrafficLightType::LEFT_RED_"
                         "YELLOW_GREEN"))  // LCOV_EXCL_BR_LINE
  {
  ...
  if (str == std::string("::ad::map::landmark::TrafficLightType::RIGHT_RED_"
                         "YELLOW_GREEN"))  // LCOV_EXCL_BR_LINE
  {
  ...
  if (str == std::string("::ad::map::landmark::TrafficLightType::STRAIGHT_RED_"
                         "YELLOW_GREEN"))  // LCOV_EXCL_BR_LINE
  {
  ...
  if (str == std::string("::ad::map::landmark::TrafficLightType::LEFT_STRAIGHT_"
                         "RED_YELLOW_GREEN"))  // LCOV_EXCL_BR_LINE
  {
    return ::ad::map::landmark::TrafficLightType::
        LEFT_STRAIGHT_RED_YELLOW_GREEN;
  }
  if (str ==
      std::string("LEFT_STRAIGHT_RED_YELLOW_GREEN"))  // LCOV_EXCL_BR_LINE
  {
    return ::ad::map::landmark::TrafficLightType::
        LEFT_STRAIGHT_RED_YELLOW_GREEN;
  }
  if (str == std::string("::ad::map::landmark::TrafficLightType::RIGHT_"
                         "STRAIGHT_RED_YELLOW_GREEN"))  // LCOV_EXCL_BR_LINE
  {
    return ::ad::map::landmark::TrafficLightType::
        RIGHT_STRAIGHT_RED_YELLOW_GREEN;
  }
  if (str ==
      std::string("RIGHT_STRAIGHT_RED_YELLOW_GREEN"))  // LCOV_EXCL_BR_LINE
  {
    return ::ad::map::landmark::TrafficLightType::
        RIGHT_STRAIGHT_RED_YELLOW_GREEN;
  }
  if (str == std::string("::ad::map::landmark::TrafficLightType::PEDESTRIAN_"
                         "RED_GREEN"))  // LCOV_EXCL_BR_LINE
  {
  ...
  if (str == std::string("::ad::map::landmark::TrafficLightType::BIKE_RED_"
                         "GREEN"))  // LCOV_EXCL_BR_LINE
  {
  ...
  if (str == std::string("::ad::map::landmark::TrafficLightType::BIKE_"
                         "PEDESTRIAN_RED_GREEN"))  // LCOV_EXCL_BR_LINE
  {
  ...
  if (str == std::string("::ad::map::landmark::TrafficLightType::BIKE_"
                         "PEDESTRIAN_RED_YELLOW_GREEN"))  // LCOV_EXCL_BR_LINE
  {
    return ::ad::map::landmark::TrafficLightType::
        BIKE_PEDESTRIAN_RED_YELLOW_GREEN;
  }
  if (str ==
      std::string("BIKE_PEDESTRIAN_RED_YELLOW_GREEN"))  // LCOV_EXCL_BR_LINE
  {
    return ::ad::map::landmark::TrafficLightType::
        BIKE_PEDESTRIAN_RED_YELLOW_GREEN;
  }
