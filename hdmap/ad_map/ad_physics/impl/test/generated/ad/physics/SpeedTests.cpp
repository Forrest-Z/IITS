...
TEST(SpeedTests, minIsDefinedAsExpected) {
  ...
  EXPECT_DOUBLE_EQ(::ad::physics::Speed::cMinValue,
                   static_cast<double>(::ad::physics::Speed::getMin()));
}

TEST(SpeedTests, maxIsDefinedAsExpected) {
  EXPECT_DOUBLE_EQ(1e3, ::ad::physics::Speed::cMaxValue);
  EXPECT_DOUBLE_EQ(::ad::physics::Speed::cMaxValue,
                   static_cast<double>(::ad::physics::Speed::getMax()));
}
...
TEST(SpeedTests, precisionIsDefinedAsExpected) {
  ...
  EXPECT_DOUBLE_EQ(::ad::physics::Speed::cPrecisionValue,
                   static_cast<double>(::ad::physics::Speed::getPrecision()));
}
...
TEST(SpeedTestsStd, fabsIsWorkingCorrectly) {
  EXPECT_DOUBLE_EQ(0.,
                   static_cast<double>(std::fabs(::ad::physics::Speed(-0.))));
  EXPECT_DOUBLE_EQ(1.,
                   static_cast<double>(std::fabs(::ad::physics::Speed(-1.))));
  EXPECT_DOUBLE_EQ(::ad::physics::Speed::cPrecisionValue,
                   static_cast<double>(std::fabs(::ad::physics::Speed(
                       ::ad::physics::Speed::cPrecisionValue))));
  EXPECT_DOUBLE_EQ(std::fabs(::ad::physics::Speed::cMinValue),
                   static_cast<double>(std::fabs(
                       ::ad::physics::Speed(::ad::physics::Speed::cMinValue))));
  EXPECT_DOUBLE_EQ(std::fabs(::ad::physics::Speed::cMinValue),
                   static_cast<double>(std::fabs(::ad::physics::Speed(
                       -::ad::physics::Speed::cMinValue))));
  EXPECT_DOUBLE_EQ(std::fabs(::ad::physics::Speed::cMaxValue),
                   static_cast<double>(std::fabs(
                       ::ad::physics::Speed(::ad::physics::Speed::cMaxValue))));
  EXPECT_DOUBLE_EQ(std::fabs(::ad::physics::Speed::cMaxValue),
                   static_cast<double>(std::fabs(::ad::physics::Speed(
...
TEST(SpeedTests, comparisonOperatorsRespectPrecision) {
  double const precisionValueTimesTen =
      ::ad::physics::Speed::cPrecisionValue * 10.;
  ::ad::physics::Speed value;
  if (::ad::physics::Speed::cMinValue > precisionValueTimesTen) {
    value = ::ad::physics::Speed(::ad::physics::Speed::cMinValue +
                                 precisionValueTimesTen);
  } else if (::ad::physics::Speed::cMaxValue < precisionValueTimesTen) {
    value = ::ad::physics::Speed(::ad::physics::Speed::cMaxValue -
                                 precisionValueTimesTen);
  } else {
    value = ::ad::physics::Speed(precisionValueTimesTen);
  }
  ::ad::physics::Speed const sameValue = value;
  ::ad::physics::Speed const slightlyBiggerValue(
      static_cast<double>(value) + ::ad::physics::Speed::cPrecisionValue * 0.9);
  ::ad::physics::Speed const slightlySmallerValue(
      static_cast<double>(value) - ::ad::physics::Speed::cPrecisionValue * 0.9);
  ::ad::physics::Speed const actuallyBiggerValue(
      static_cast<double>(value) + ::ad::physics::Speed::cPrecisionValue * 1.1);
  ::ad::physics::Speed const actuallySmallerValue(
      static_cast<double>(value) - ::ad::physics::Speed::cPrecisionValue * 1.1);
...
TEST(SpeedTests, arithmeticOperatorsComputeCorrectly) {
  ...
  EXPECT_NEAR(static_cast<double>(value) * static_cast<double>(value),
              static_cast<double>(squaredResult), cDoubleNear);
