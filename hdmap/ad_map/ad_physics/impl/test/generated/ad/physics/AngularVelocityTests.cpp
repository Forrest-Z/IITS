...
TEST(AngularVelocityTests, aboveMinIsValid) {
  ::ad::physics::AngularVelocity value(
      ::ad::physics::AngularVelocity::cMinValue * 0.9);
  EXPECT_TRUE(value.isValid());
}

TEST(AngularVelocityTests, belowMinIsInvalid) {
  ::ad::physics::AngularVelocity value(
      ::ad::physics::AngularVelocity::cMinValue * 1.1);
  EXPECT_FALSE(value.isValid());
}
...
TEST(AngularVelocityTests, aboveMaxIsInvalid) {
  ::ad::physics::AngularVelocity value(
      ::ad::physics::AngularVelocity::cMaxValue * 1.1);
  EXPECT_FALSE(value.isValid());
}

TEST(AngularVelocityTests, belowMaxIsValid) {
  ::ad::physics::AngularVelocity value(
      ::ad::physics::AngularVelocity::cMaxValue * 0.9);
  EXPECT_TRUE(value.isValid());
}
...
TEST(AngularVelocityTestsStd, fabsIsWorkingCorrectly) {
  EXPECT_DOUBLE_EQ(
      0., static_cast<double>(std::fabs(::ad::physics::AngularVelocity(-0.))));
  EXPECT_DOUBLE_EQ(
      1., static_cast<double>(std::fabs(::ad::physics::AngularVelocity(-1.))));
  EXPECT_DOUBLE_EQ(::ad::physics::AngularVelocity::cPrecisionValue,
                   static_cast<double>(std::fabs(::ad::physics::AngularVelocity(
                       ::ad::physics::AngularVelocity::cPrecisionValue))));
  EXPECT_DOUBLE_EQ(std::fabs(::ad::physics::AngularVelocity::cMinValue),
                   static_cast<double>(std::fabs(::ad::physics::AngularVelocity(
                       ::ad::physics::AngularVelocity::cMinValue))));
  EXPECT_DOUBLE_EQ(std::fabs(::ad::physics::AngularVelocity::cMinValue),
                   static_cast<double>(std::fabs(::ad::physics::AngularVelocity(
                       -::ad::physics::AngularVelocity::cMinValue))));
  EXPECT_DOUBLE_EQ(std::fabs(::ad::physics::AngularVelocity::cMaxValue),
                   static_cast<double>(std::fabs(::ad::physics::AngularVelocity(
                       ::ad::physics::AngularVelocity::cMaxValue))));
  EXPECT_DOUBLE_EQ(std::fabs(::ad::physics::AngularVelocity::cMaxValue),
                   static_cast<double>(std::fabs(::ad::physics::AngularVelocity(
...
TEST(AngularVelocityTests, copyConstructionFromValidValue) {
  ::ad::physics::AngularVelocity const validValue(
      ::ad::physics::AngularVelocity::cMinValue);
  ::ad::physics::AngularVelocity value(validValue);
  EXPECT_TRUE(value.isValid());
...
TEST(AngularVelocityTests, moveConstructionFromValidValue) {
  ::ad::physics::AngularVelocity validValue(
      ::ad::physics::AngularVelocity::cMinValue);
...
TEST(AngularVelocityTests, arithmeticOperatorsThrowOnInvalid) {
  ::ad::physics::AngularVelocity const minimalValue(
      ::ad::physics::AngularVelocity::cMinValue);
  ::ad::physics::AngularVelocity const maximalValue(
      ::ad::physics::AngularVelocity::cMaxValue);
  ::ad::physics::AngularVelocity const invalidValue;
  ...
  EXPECT_THROW(invalidValue / maximalValue, std::out_of_range);
  EXPECT_THROW(maximalValue / invalidValue, std::out_of_range);
  EXPECT_THROW(maximalValue / ::ad::physics::AngularVelocity(0.0),
               std::out_of_range);
...
TEST(AngularVelocityTests, comparisonOperatorsRespectPrecision) {
  double const precisionValueTimesTen =
      ::ad::physics::AngularVelocity::cPrecisionValue * 10.;
  ::ad::physics::AngularVelocity value;
  if (::ad::physics::AngularVelocity::cMinValue > precisionValueTimesTen) {
    value = ::ad::physics::AngularVelocity(
        ::ad::physics::AngularVelocity::cMinValue + precisionValueTimesTen);
  } else if (::ad::physics::AngularVelocity::cMaxValue <
             precisionValueTimesTen) {
    value = ::ad::physics::AngularVelocity(
        ::ad::physics::AngularVelocity::cMaxValue - precisionValueTimesTen);
  } else {
    value = ::ad::physics::AngularVelocity(precisionValueTimesTen);
  }
  ::ad::physics::AngularVelocity const sameValue = value;
  ::ad::physics::AngularVelocity const slightlyBiggerValue(
      static_cast<double>(value) +
      ::ad::physics::AngularVelocity::cPrecisionValue * 0.9);
  ::ad::physics::AngularVelocity const slightlySmallerValue(
      static_cast<double>(value) -
      ::ad::physics::AngularVelocity::cPrecisionValue * 0.9);
  ::ad::physics::AngularVelocity const actuallyBiggerValue(
      static_cast<double>(value) +
      ::ad::physics::AngularVelocity::cPrecisionValue * 1.1);
  ::ad::physics::AngularVelocity const actuallySmallerValue(
      static_cast<double>(value) -
      ::ad::physics::AngularVelocity::cPrecisionValue * 1.1);
...
TEST(AngularVelocityTests, arithmeticOperatorsComputeCorrectly) {
  ...
  //  operator-()
  if ((::ad::physics::AngularVelocity::cMinValue <
       -static_cast<double>(value)) &&
      (-static_cast<double>(value) <
       ::ad::physics::AngularVelocity::cMaxValue)) {
    result = -value;
