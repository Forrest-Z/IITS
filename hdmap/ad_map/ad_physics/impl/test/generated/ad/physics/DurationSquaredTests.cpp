...
TEST(DurationSquaredTests, minIsDefinedAsExpected) {
  ...
  EXPECT_DOUBLE_EQ(
      ::ad::physics::DurationSquared::cMinValue,
...
TEST(DurationSquaredTests, maxIsDefinedAsExpected) {
  ...
  EXPECT_DOUBLE_EQ(
      ::ad::physics::DurationSquared::cMaxValue,
...
TEST(DurationSquaredTests, aboveMinIsValid) {
  ::ad::physics::DurationSquared value(
      ::ad::physics::DurationSquared::cMinValue * 0.9);
  EXPECT_TRUE(value.isValid());
}

TEST(DurationSquaredTests, belowMinIsInvalid) {
  ::ad::physics::DurationSquared value(
      ::ad::physics::DurationSquared::cMinValue * 1.1);
  EXPECT_FALSE(value.isValid());
}
...
TEST(DurationSquaredTests, aboveMaxIsInvalid) {
  ::ad::physics::DurationSquared value(
      ::ad::physics::DurationSquared::cMaxValue * 1.1);
  EXPECT_FALSE(value.isValid());
}

TEST(DurationSquaredTests, belowMaxIsValid) {
  ::ad::physics::DurationSquared value(
      ::ad::physics::DurationSquared::cMaxValue * 0.9);
  EXPECT_TRUE(value.isValid());
}
...
TEST(DurationSquaredTestsStd, numericLimitsEpsilonIsPrecision) {
  EXPECT_DOUBLE_EQ(
      static_cast<double>(::ad::physics::DurationSquared::getPrecision()),
      static_cast<double>(
          std::numeric_limits<::ad::physics::DurationSquared>::epsilon()));
}

TEST(DurationSquaredTestsStd, fabsIsWorkingCorrectly) {
  EXPECT_DOUBLE_EQ(
      0., static_cast<double>(std::fabs(::ad::physics::DurationSquared(-0.))));
  EXPECT_DOUBLE_EQ(
      1., static_cast<double>(std::fabs(::ad::physics::DurationSquared(-1.))));
  EXPECT_DOUBLE_EQ(::ad::physics::DurationSquared::cPrecisionValue,
                   static_cast<double>(std::fabs(::ad::physics::DurationSquared(
                       ::ad::physics::DurationSquared::cPrecisionValue))));
  EXPECT_DOUBLE_EQ(std::fabs(::ad::physics::DurationSquared::cMinValue),
                   static_cast<double>(std::fabs(::ad::physics::DurationSquared(
                       ::ad::physics::DurationSquared::cMinValue))));
  EXPECT_DOUBLE_EQ(std::fabs(::ad::physics::DurationSquared::cMinValue),
                   static_cast<double>(std::fabs(::ad::physics::DurationSquared(
                       -::ad::physics::DurationSquared::cMinValue))));
  EXPECT_DOUBLE_EQ(std::fabs(::ad::physics::DurationSquared::cMaxValue),
                   static_cast<double>(std::fabs(::ad::physics::DurationSquared(
                       ::ad::physics::DurationSquared::cMaxValue))));
  EXPECT_DOUBLE_EQ(std::fabs(::ad::physics::DurationSquared::cMaxValue),
                   static_cast<double>(std::fabs(::ad::physics::DurationSquared(
...
TEST(DurationSquaredTests, copyConstructionFromValidValue) {
  ::ad::physics::DurationSquared const validValue(
      ::ad::physics::DurationSquared::cMinValue);
  ::ad::physics::DurationSquared value(validValue);
  EXPECT_TRUE(value.isValid());
...
TEST(DurationSquaredTests, moveConstructionFromValidValue) {
  ::ad::physics::DurationSquared validValue(
      ::ad::physics::DurationSquared::cMinValue);
...
TEST(DurationSquaredTests, arithmeticOperatorsThrowOnInvalid) {
  ::ad::physics::DurationSquared const minimalValue(
      ::ad::physics::DurationSquared::cMinValue);
  ::ad::physics::DurationSquared const maximalValue(
      ::ad::physics::DurationSquared::cMaxValue);
  ::ad::physics::DurationSquared const invalidValue;
  ...
  //  operator*(double)
  EXPECT_THROW(invalidValue * static_cast<double>(maximalValue),
               std::out_of_range);
  EXPECT_THROW(maximalValue * static_cast<double>(maximalValue),
               std::out_of_range);
  ...
  EXPECT_THROW(invalidValue / static_cast<double>(maximalValue),
               std::out_of_range);
  EXPECT_THROW(maximalValue / static_cast<double>(invalidValue),
               std::out_of_range);
  ...
  EXPECT_THROW(invalidValue / maximalValue, std::out_of_range);
  EXPECT_THROW(maximalValue / invalidValue, std::out_of_range);
  EXPECT_THROW(maximalValue / ::ad::physics::DurationSquared(0.0),
               std::out_of_range);

  //  operator-()
  EXPECT_THROW(-invalidValue, std::out_of_range);
  if (std::fabs(static_cast<double>(maximalValue)) >
      std::fabs(static_cast<double>(minimalValue))) {
    EXPECT_THROW(-maximalValue, std::out_of_range);
  } else if (std::fabs(static_cast<double>(maximalValue)) <
             std::fabs(static_cast<double>(minimalValue))) {
...
TEST(DurationSquaredTests, comparisonOperatorsRespectPrecision) {
  double const precisionValueTimesTen =
      ::ad::physics::DurationSquared::cPrecisionValue * 10.;
  ::ad::physics::DurationSquared value;
  if (::ad::physics::DurationSquared::cMinValue > precisionValueTimesTen) {
    value = ::ad::physics::DurationSquared(
        ::ad::physics::DurationSquared::cMinValue + precisionValueTimesTen);
  } else if (::ad::physics::DurationSquared::cMaxValue <
             precisionValueTimesTen) {
    value = ::ad::physics::DurationSquared(
        ::ad::physics::DurationSquared::cMaxValue - precisionValueTimesTen);
  } else {
    value = ::ad::physics::DurationSquared(precisionValueTimesTen);
  }
  ::ad::physics::DurationSquared const sameValue = value;
  ::ad::physics::DurationSquared const slightlyBiggerValue(
      static_cast<double>(value) +
      ::ad::physics::DurationSquared::cPrecisionValue * 0.9);
  ::ad::physics::DurationSquared const slightlySmallerValue(
      static_cast<double>(value) -
      ::ad::physics::DurationSquared::cPrecisionValue * 0.9);
  ::ad::physics::DurationSquared const actuallyBiggerValue(
      static_cast<double>(value) +
      ::ad::physics::DurationSquared::cPrecisionValue * 1.1);
  ::ad::physics::DurationSquared const actuallySmallerValue(
      static_cast<double>(value) -
      ::ad::physics::DurationSquared::cPrecisionValue * 1.1);
...
TEST(DurationSquaredTests, arithmeticOperatorsComputeCorrectly) {
  ...
  //  operator+(::ad::physics::DurationSquared)
  result = value + value;
  EXPECT_NEAR(static_cast<double>(value) + static_cast<double>(value),
              static_cast<double>(result), cDoubleNear);
  ...
  //  operator*(double)
  result = value * 5.;
  EXPECT_NEAR(static_cast<double>(value) * 5., static_cast<double>(result),
              cDoubleNear);

  //  std::sqrt()
  ::ad::physics::Duration const squareRootResult = std::sqrt(value);
  EXPECT_NEAR(std::sqrt(static_cast<double>(value)),
              static_cast<double>(squareRootResult), cDoubleNear);
  ...
  EXPECT_NEAR(static_cast<double>(value) / static_cast<double>(value),
              doubleResult, cDoubleNear);

  //  operator-()
  if ((::ad::physics::DurationSquared::cMinValue <
       -static_cast<double>(value)) &&
      (-static_cast<double>(value) <
       ::ad::physics::DurationSquared::cMaxValue)) {
    result = -value;
  } else {
    // not clear on how to trigger valid result if such small value is not
    // working
  }
}
