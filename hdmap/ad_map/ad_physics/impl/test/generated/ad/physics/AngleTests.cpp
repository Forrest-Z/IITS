...
TEST(AngleTests, precisionIsDefinedAsExpected) {
  ...
  EXPECT_DOUBLE_EQ(::ad::physics::Angle::cPrecisionValue,
                   static_cast<double>(::ad::physics::Angle::getPrecision()));
}
...
TEST(AngleTestsStd, fabsIsWorkingCorrectly) {
  EXPECT_DOUBLE_EQ(0.,
                   static_cast<double>(std::fabs(::ad::physics::Angle(-0.))));
  EXPECT_DOUBLE_EQ(1.,
                   static_cast<double>(std::fabs(::ad::physics::Angle(-1.))));
  EXPECT_DOUBLE_EQ(::ad::physics::Angle::cPrecisionValue,
                   static_cast<double>(std::fabs(::ad::physics::Angle(
                       ::ad::physics::Angle::cPrecisionValue))));
  EXPECT_DOUBLE_EQ(std::fabs(::ad::physics::Angle::cMinValue),
                   static_cast<double>(std::fabs(
                       ::ad::physics::Angle(::ad::physics::Angle::cMinValue))));
  EXPECT_DOUBLE_EQ(std::fabs(::ad::physics::Angle::cMinValue),
                   static_cast<double>(std::fabs(::ad::physics::Angle(
                       -::ad::physics::Angle::cMinValue))));
  EXPECT_DOUBLE_EQ(std::fabs(::ad::physics::Angle::cMaxValue),
                   static_cast<double>(std::fabs(
                       ::ad::physics::Angle(::ad::physics::Angle::cMaxValue))));
  EXPECT_DOUBLE_EQ(std::fabs(::ad::physics::Angle::cMaxValue),
                   static_cast<double>(std::fabs(::ad::physics::Angle(
...
TEST(AngleTests, comparisonOperatorsRespectPrecision) {
  double const precisionValueTimesTen =
      ::ad::physics::Angle::cPrecisionValue * 10.;
  ::ad::physics::Angle value;
  if (::ad::physics::Angle::cMinValue > precisionValueTimesTen) {
    value = ::ad::physics::Angle(::ad::physics::Angle::cMinValue +
                                 precisionValueTimesTen);
  } else if (::ad::physics::Angle::cMaxValue < precisionValueTimesTen) {
    value = ::ad::physics::Angle(::ad::physics::Angle::cMaxValue -
                                 precisionValueTimesTen);
  } else {
    value = ::ad::physics::Angle(precisionValueTimesTen);
  }
  ::ad::physics::Angle const sameValue = value;
  ::ad::physics::Angle const slightlyBiggerValue(
      static_cast<double>(value) + ::ad::physics::Angle::cPrecisionValue * 0.9);
  ::ad::physics::Angle const slightlySmallerValue(
      static_cast<double>(value) - ::ad::physics::Angle::cPrecisionValue * 0.9);
  ::ad::physics::Angle const actuallyBiggerValue(
      static_cast<double>(value) + ::ad::physics::Angle::cPrecisionValue * 1.1);
  ::ad::physics::Angle const actuallySmallerValue(
      static_cast<double>(value) - ::ad::physics::Angle::cPrecisionValue * 1.1);
