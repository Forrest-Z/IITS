...
TEST(DistanceSquaredTests, aboveMinIsValid) {
  ::ad::physics::DistanceSquared value(
      ::ad::physics::DistanceSquared::cMinValue * 0.9);
  EXPECT_TRUE(value.isValid());
}

TEST(DistanceSquaredTests, belowMinIsInvalid) {
  ::ad::physics::DistanceSquared value(
      ::ad::physics::DistanceSquared::cMinValue * 1.1);
  EXPECT_FALSE(value.isValid());
}
...
TEST(DistanceSquaredTests, aboveMaxIsInvalid) {
  ::ad::physics::DistanceSquared value(
      ::ad::physics::DistanceSquared::cMaxValue * 1.1);
  EXPECT_FALSE(value.isValid());
}

TEST(DistanceSquaredTests, belowMaxIsValid) {
  ::ad::physics::DistanceSquared value(
      ::ad::physics::DistanceSquared::cMaxValue * 0.9);
  EXPECT_TRUE(value.isValid());
}
...
TEST(DistanceSquaredTestsStd, fabsIsWorkingCorrectly) {
  EXPECT_DOUBLE_EQ(
      0., static_cast<double>(std::fabs(::ad::physics::DistanceSquared(-0.))));
  EXPECT_DOUBLE_EQ(
      1., static_cast<double>(std::fabs(::ad::physics::DistanceSquared(-1.))));
  EXPECT_DOUBLE_EQ(::ad::physics::DistanceSquared::cPrecisionValue,
                   static_cast<double>(std::fabs(::ad::physics::DistanceSquared(
                       ::ad::physics::DistanceSquared::cPrecisionValue))));
  EXPECT_DOUBLE_EQ(std::fabs(::ad::physics::DistanceSquared::cMinValue),
                   static_cast<double>(std::fabs(::ad::physics::DistanceSquared(
                       ::ad::physics::DistanceSquared::cMinValue))));
  EXPECT_DOUBLE_EQ(std::fabs(::ad::physics::DistanceSquared::cMinValue),
                   static_cast<double>(std::fabs(::ad::physics::DistanceSquared(
                       -::ad::physics::DistanceSquared::cMinValue))));
  EXPECT_DOUBLE_EQ(std::fabs(::ad::physics::DistanceSquared::cMaxValue),
                   static_cast<double>(std::fabs(::ad::physics::DistanceSquared(
                       ::ad::physics::DistanceSquared::cMaxValue))));
  EXPECT_DOUBLE_EQ(std::fabs(::ad::physics::DistanceSquared::cMaxValue),
                   static_cast<double>(std::fabs(::ad::physics::DistanceSquared(
...
TEST(DistanceSquaredTests, copyConstructionFromValidValue) {
  ::ad::physics::DistanceSquared const validValue(
      ::ad::physics::DistanceSquared::cMinValue);
  ::ad::physics::DistanceSquared value(validValue);
  EXPECT_TRUE(value.isValid());
...
TEST(DistanceSquaredTests, moveConstructionFromValidValue) {
  ::ad::physics::DistanceSquared validValue(
      ::ad::physics::DistanceSquared::cMinValue);
...
TEST(DistanceSquaredTests, arithmeticOperatorsThrowOnInvalid) {
  ::ad::physics::DistanceSquared const minimalValue(
      ::ad::physics::DistanceSquared::cMinValue);
  ::ad::physics::DistanceSquared const maximalValue(
      ::ad::physics::DistanceSquared::cMaxValue);
  ::ad::physics::DistanceSquared const invalidValue;
  ...
  EXPECT_THROW(invalidValue / maximalValue, std::out_of_range);
  EXPECT_THROW(maximalValue / invalidValue, std::out_of_range);
  EXPECT_THROW(maximalValue / ::ad::physics::DistanceSquared(0.0),
               std::out_of_range);
...
TEST(DistanceSquaredTests, comparisonOperatorsRespectPrecision) {
  double const precisionValueTimesTen =
      ::ad::physics::DistanceSquared::cPrecisionValue * 10.;
  ::ad::physics::DistanceSquared value;
  if (::ad::physics::DistanceSquared::cMinValue > precisionValueTimesTen) {
    value = ::ad::physics::DistanceSquared(
        ::ad::physics::DistanceSquared::cMinValue + precisionValueTimesTen);
  } else if (::ad::physics::DistanceSquared::cMaxValue <
             precisionValueTimesTen) {
    value = ::ad::physics::DistanceSquared(
        ::ad::physics::DistanceSquared::cMaxValue - precisionValueTimesTen);
  } else {
    value = ::ad::physics::DistanceSquared(precisionValueTimesTen);
  }
  ::ad::physics::DistanceSquared const sameValue = value;
  ::ad::physics::DistanceSquared const slightlyBiggerValue(
      static_cast<double>(value) +
      ::ad::physics::DistanceSquared::cPrecisionValue * 0.9);
  ::ad::physics::DistanceSquared const slightlySmallerValue(
      static_cast<double>(value) -
      ::ad::physics::DistanceSquared::cPrecisionValue * 0.9);
  ::ad::physics::DistanceSquared const actuallyBiggerValue(
      static_cast<double>(value) +
      ::ad::physics::DistanceSquared::cPrecisionValue * 1.1);
  ::ad::physics::DistanceSquared const actuallySmallerValue(
      static_cast<double>(value) -
      ::ad::physics::DistanceSquared::cPrecisionValue * 1.1);
...
TEST(DistanceSquaredTests, arithmeticOperatorsComputeCorrectly) {
  ...
  //  operator-()
  if ((::ad::physics::DistanceSquared::cMinValue <
       -static_cast<double>(value)) &&
      (-static_cast<double>(value) <
       ::ad::physics::DistanceSquared::cMaxValue)) {
    result = -value;
