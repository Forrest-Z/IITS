...
TEST(WeightTests, precisionIsDefinedAsExpected) {
  ...
  EXPECT_DOUBLE_EQ(::ad::physics::Weight::cPrecisionValue,
                   static_cast<double>(::ad::physics::Weight::getPrecision()));
}
...
TEST(WeightTestsStd, numericLimitsMaxIsMax) {
  EXPECT_DOUBLE_EQ(
      static_cast<double>(::ad::physics::Weight::getMax()),
...
TEST(WeightTestsStd, fabsIsWorkingCorrectly) {
  EXPECT_DOUBLE_EQ(0.,
                   static_cast<double>(std::fabs(::ad::physics::Weight(-0.))));
  EXPECT_DOUBLE_EQ(1.,
                   static_cast<double>(std::fabs(::ad::physics::Weight(-1.))));
  EXPECT_DOUBLE_EQ(::ad::physics::Weight::cPrecisionValue,
                   static_cast<double>(std::fabs(::ad::physics::Weight(
...
TEST(WeightTests, moveConstructionFromValidValue) {
  ...
  EXPECT_TRUE(value.isValid());
  EXPECT_DOUBLE_EQ(::ad::physics::Weight::cMinValue,
...
TEST(WeightTests, comparisonOperatorsRespectPrecision) {
  double const precisionValueTimesTen =
      ::ad::physics::Weight::cPrecisionValue * 10.;
  ::ad::physics::Weight value;
  if (::ad::physics::Weight::cMinValue > precisionValueTimesTen) {
    value = ::ad::physics::Weight(::ad::physics::Weight::cMinValue +
                                  precisionValueTimesTen);
  } else if (::ad::physics::Weight::cMaxValue < precisionValueTimesTen) {
    value = ::ad::physics::Weight(::ad::physics::Weight::cMaxValue -
                                  precisionValueTimesTen);
  } else {
    value = ::ad::physics::Weight(precisionValueTimesTen);
  }
  ::ad::physics::Weight const sameValue = value;
  ::ad::physics::Weight const slightlyBiggerValue(
      static_cast<double>(value) +
      ::ad::physics::Weight::cPrecisionValue * 0.9);
  ::ad::physics::Weight const slightlySmallerValue(
      static_cast<double>(value) -
      ::ad::physics::Weight::cPrecisionValue * 0.9);
  ::ad::physics::Weight const actuallyBiggerValue(
      static_cast<double>(value) +
      ::ad::physics::Weight::cPrecisionValue * 1.1);
  ::ad::physics::Weight const actuallySmallerValue(
      static_cast<double>(value) -
      ::ad::physics::Weight::cPrecisionValue * 1.1);
