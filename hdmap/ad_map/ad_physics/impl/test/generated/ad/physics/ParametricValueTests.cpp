...
TEST(ParametricValueTests, aboveMinIsValid) {
  ::ad::physics::ParametricValue value(
      ::ad::physics::ParametricValue::cMinValue * 0.9);
  EXPECT_TRUE(value.isValid());
}

TEST(ParametricValueTests, belowMinIsInvalid) {
  ::ad::physics::ParametricValue value(
      ::ad::physics::ParametricValue::cMinValue * 1.1);
  EXPECT_FALSE(value.isValid());
}
...
TEST(ParametricValueTests, aboveMaxIsInvalid) {
  ::ad::physics::ParametricValue value(
      ::ad::physics::ParametricValue::cMaxValue * 1.1);
  EXPECT_FALSE(value.isValid());
}

TEST(ParametricValueTests, belowMaxIsValid) {
  ::ad::physics::ParametricValue value(
      ::ad::physics::ParametricValue::cMaxValue * 0.9);
  EXPECT_TRUE(value.isValid());
}
...
TEST(ParametricValueTestsStd, numericLimitsLowestIsMin) {
  EXPECT_DOUBLE_EQ(
      static_cast<double>(::ad::physics::ParametricValue::getMin()),
      static_cast<double>(
...
TEST(ParametricValueTestsStd, numericLimitsMaxIsMax) {
  EXPECT_DOUBLE_EQ(
      static_cast<double>(::ad::physics::ParametricValue::getMax()),
      static_cast<double>(
...
TEST(ParametricValueTestsStd, fabsIsWorkingCorrectly) {
  EXPECT_DOUBLE_EQ(
      0., static_cast<double>(std::fabs(::ad::physics::ParametricValue(-0.))));
  EXPECT_DOUBLE_EQ(
      1., static_cast<double>(std::fabs(::ad::physics::ParametricValue(-1.))));
  EXPECT_DOUBLE_EQ(::ad::physics::ParametricValue::cPrecisionValue,
                   static_cast<double>(std::fabs(::ad::physics::ParametricValue(
                       ::ad::physics::ParametricValue::cPrecisionValue))));
  EXPECT_DOUBLE_EQ(std::fabs(::ad::physics::ParametricValue::cMinValue),
                   static_cast<double>(std::fabs(::ad::physics::ParametricValue(
                       ::ad::physics::ParametricValue::cMinValue))));
  EXPECT_DOUBLE_EQ(std::fabs(::ad::physics::ParametricValue::cMinValue),
                   static_cast<double>(std::fabs(::ad::physics::ParametricValue(
                       -::ad::physics::ParametricValue::cMinValue))));
  EXPECT_DOUBLE_EQ(std::fabs(::ad::physics::ParametricValue::cMaxValue),
                   static_cast<double>(std::fabs(::ad::physics::ParametricValue(
...
TEST(ParametricValueTests, copyConstructionFromValidValue) {
  ::ad::physics::ParametricValue const validValue(
      ::ad::physics::ParametricValue::cMinValue);
  ::ad::physics::ParametricValue value(validValue);
  EXPECT_TRUE(value.isValid());
...
TEST(ParametricValueTests, moveConstructionFromValidValue) {
  ::ad::physics::ParametricValue validValue(
      ::ad::physics::ParametricValue::cMinValue);
  ::ad::physics::ParametricValue value(std::move(validValue));
  EXPECT_TRUE(value.isValid());
  EXPECT_DOUBLE_EQ(::ad::physics::ParametricValue::cMinValue,
...
TEST(ParametricValueTests, comparisonOperatorsThrowOnInvalid) {
  ::ad::physics::ParametricValue const value(
      ::ad::physics::ParametricValue::cMinValue);
  ::ad::physics::ParametricValue const invalidValue;
...
TEST(ParametricValueTests, arithmeticOperatorsThrowOnInvalid) {
  ::ad::physics::ParametricValue const minimalValue(
      ::ad::physics::ParametricValue::cMinValue);
  ::ad::physics::ParametricValue const maximalValue(
      ::ad::physics::ParametricValue::cMaxValue);
  ::ad::physics::ParametricValue const invalidValue;
  ...
  EXPECT_THROW(invalidValue / maximalValue, std::out_of_range);
  EXPECT_THROW(maximalValue / invalidValue, std::out_of_range);
  EXPECT_THROW(maximalValue / ::ad::physics::ParametricValue(0.0),
               std::out_of_range);
...
TEST(ParametricValueTests, comparisonOperatorsRespectPrecision) {
  double const precisionValueTimesTen =
      ::ad::physics::ParametricValue::cPrecisionValue * 10.;
  ::ad::physics::ParametricValue value;
  if (::ad::physics::ParametricValue::cMinValue > precisionValueTimesTen) {
    value = ::ad::physics::ParametricValue(
        ::ad::physics::ParametricValue::cMinValue + precisionValueTimesTen);
  } else if (::ad::physics::ParametricValue::cMaxValue <
             precisionValueTimesTen) {
    value = ::ad::physics::ParametricValue(
        ::ad::physics::ParametricValue::cMaxValue - precisionValueTimesTen);
  } else {
    value = ::ad::physics::ParametricValue(precisionValueTimesTen);
  }
  ::ad::physics::ParametricValue const sameValue = value;
  ::ad::physics::ParametricValue const slightlyBiggerValue(
      static_cast<double>(value) +
      ::ad::physics::ParametricValue::cPrecisionValue * 0.9);
  ::ad::physics::ParametricValue const slightlySmallerValue(
      static_cast<double>(value) -
      ::ad::physics::ParametricValue::cPrecisionValue * 0.9);
  ::ad::physics::ParametricValue const actuallyBiggerValue(
      static_cast<double>(value) +
      ::ad::physics::ParametricValue::cPrecisionValue * 1.1);
  ::ad::physics::ParametricValue const actuallySmallerValue(
      static_cast<double>(value) -
      ::ad::physics::ParametricValue::cPrecisionValue * 1.1);
...
TEST(ParametricValueTests, arithmeticOperatorsComputeCorrectly) {
  ...
  //  operator-()
  if ((::ad::physics::ParametricValue::cMinValue <
       -static_cast<double>(value)) &&
      (-static_cast<double>(value) <
       ::ad::physics::ParametricValue::cMaxValue)) {
    result = -value;
