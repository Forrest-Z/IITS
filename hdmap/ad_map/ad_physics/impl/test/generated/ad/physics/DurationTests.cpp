...
TEST(DurationTests, minIsDefinedAsExpected) {
  ...
  EXPECT_DOUBLE_EQ(::ad::physics::Duration::cMinValue,
                   static_cast<double>(::ad::physics::Duration::getMin()));
}

TEST(DurationTests, maxIsDefinedAsExpected) {
  EXPECT_DOUBLE_EQ(1e6, ::ad::physics::Duration::cMaxValue);
  EXPECT_DOUBLE_EQ(::ad::physics::Duration::cMaxValue,
                   static_cast<double>(::ad::physics::Duration::getMax()));
}
...
TEST(DurationTestsStd, fabsIsWorkingCorrectly) {
  EXPECT_DOUBLE_EQ(
      0., static_cast<double>(std::fabs(::ad::physics::Duration(-0.))));
  EXPECT_DOUBLE_EQ(
      1., static_cast<double>(std::fabs(::ad::physics::Duration(-1.))));
  EXPECT_DOUBLE_EQ(::ad::physics::Duration::cPrecisionValue,
                   static_cast<double>(std::fabs(::ad::physics::Duration(
                       ::ad::physics::Duration::cPrecisionValue))));
...
TEST(DurationTests, arithmeticOperatorsThrowOnInvalid) {
  ::ad::physics::Duration const minimalValue(
      ::ad::physics::Duration::cMinValue);
  ::ad::physics::Duration const maximalValue(
      ::ad::physics::Duration::cMaxValue);
  ::ad::physics::Duration const invalidValue;
...
TEST(DurationTests, comparisonOperatorsRespectPrecision) {
  double const precisionValueTimesTen =
      ::ad::physics::Duration::cPrecisionValue * 10.;
  ::ad::physics::Duration value;
  if (::ad::physics::Duration::cMinValue > precisionValueTimesTen) {
    value = ::ad::physics::Duration(::ad::physics::Duration::cMinValue +
                                    precisionValueTimesTen);
  } else if (::ad::physics::Duration::cMaxValue < precisionValueTimesTen) {
    value = ::ad::physics::Duration(::ad::physics::Duration::cMaxValue -
                                    precisionValueTimesTen);
  } else {
    value = ::ad::physics::Duration(precisionValueTimesTen);
  }
  ::ad::physics::Duration const sameValue = value;
  ::ad::physics::Duration const slightlyBiggerValue(
      static_cast<double>(value) +
      ::ad::physics::Duration::cPrecisionValue * 0.9);
  ::ad::physics::Duration const slightlySmallerValue(
      static_cast<double>(value) -
      ::ad::physics::Duration::cPrecisionValue * 0.9);
  ::ad::physics::Duration const actuallyBiggerValue(
      static_cast<double>(value) +
      ::ad::physics::Duration::cPrecisionValue * 1.1);
  ::ad::physics::Duration const actuallySmallerValue(
      static_cast<double>(value) -
      ::ad::physics::Duration::cPrecisionValue * 1.1);
