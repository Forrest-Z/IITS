...
TEST(DistanceTests, minIsDefinedAsExpected) {
  ...
  EXPECT_DOUBLE_EQ(::ad::physics::Distance::cMinValue,
                   static_cast<double>(::ad::physics::Distance::getMin()));
}

TEST(DistanceTests, maxIsDefinedAsExpected) {
  EXPECT_DOUBLE_EQ(1e9, ::ad::physics::Distance::cMaxValue);
  EXPECT_DOUBLE_EQ(::ad::physics::Distance::cMaxValue,
                   static_cast<double>(::ad::physics::Distance::getMax()));
}
...
TEST(DistanceTestsStd, fabsIsWorkingCorrectly) {
  EXPECT_DOUBLE_EQ(
      0., static_cast<double>(std::fabs(::ad::physics::Distance(-0.))));
  EXPECT_DOUBLE_EQ(
      1., static_cast<double>(std::fabs(::ad::physics::Distance(-1.))));
  EXPECT_DOUBLE_EQ(::ad::physics::Distance::cPrecisionValue,
                   static_cast<double>(std::fabs(::ad::physics::Distance(
                       ::ad::physics::Distance::cPrecisionValue))));
...
TEST(DistanceTests, arithmeticOperatorsThrowOnInvalid) {
  ::ad::physics::Distance const minimalValue(
      ::ad::physics::Distance::cMinValue);
  ::ad::physics::Distance const maximalValue(
      ::ad::physics::Distance::cMaxValue);
  ::ad::physics::Distance const invalidValue;
...
TEST(DistanceTests, comparisonOperatorsRespectPrecision) {
  double const precisionValueTimesTen =
      ::ad::physics::Distance::cPrecisionValue * 10.;
  ::ad::physics::Distance value;
  if (::ad::physics::Distance::cMinValue > precisionValueTimesTen) {
    value = ::ad::physics::Distance(::ad::physics::Distance::cMinValue +
                                    precisionValueTimesTen);
  } else if (::ad::physics::Distance::cMaxValue < precisionValueTimesTen) {
    value = ::ad::physics::Distance(::ad::physics::Distance::cMaxValue -
                                    precisionValueTimesTen);
  } else {
    value = ::ad::physics::Distance(precisionValueTimesTen);
  }
  ::ad::physics::Distance const sameValue = value;
  ::ad::physics::Distance const slightlyBiggerValue(
      static_cast<double>(value) +
      ::ad::physics::Distance::cPrecisionValue * 0.9);
  ::ad::physics::Distance const slightlySmallerValue(
      static_cast<double>(value) -
      ::ad::physics::Distance::cPrecisionValue * 0.9);
  ::ad::physics::Distance const actuallyBiggerValue(
      static_cast<double>(value) +
      ::ad::physics::Distance::cPrecisionValue * 1.1);
  ::ad::physics::Distance const actuallySmallerValue(
      static_cast<double>(value) -
      ::ad::physics::Distance::cPrecisionValue * 1.1);
