...
TEST(AngularAccelerationTests, aboveMinIsValid) {
  ::ad::physics::AngularAcceleration value(
      ::ad::physics::AngularAcceleration::cMinValue * 0.9);
  EXPECT_TRUE(value.isValid());
}

TEST(AngularAccelerationTests, belowMinIsInvalid) {
  ::ad::physics::AngularAcceleration value(
      ::ad::physics::AngularAcceleration::cMinValue * 1.1);
  EXPECT_FALSE(value.isValid());
}
...
TEST(AngularAccelerationTests, aboveMaxIsInvalid) {
  ::ad::physics::AngularAcceleration value(
      ::ad::physics::AngularAcceleration::cMaxValue * 1.1);
  EXPECT_FALSE(value.isValid());
}

TEST(AngularAccelerationTests, belowMaxIsValid) {
  ::ad::physics::AngularAcceleration value(
      ::ad::physics::AngularAcceleration::cMaxValue * 0.9);
  EXPECT_TRUE(value.isValid());
}
...
TEST(AngularAccelerationTestsStd, fabsIsWorkingCorrectly) {
  EXPECT_DOUBLE_EQ(0., static_cast<double>(
                           std::fabs(::ad::physics::AngularAcceleration(-0.))));
  EXPECT_DOUBLE_EQ(1., static_cast<double>(
                           std::fabs(::ad::physics::AngularAcceleration(-1.))));
  EXPECT_DOUBLE_EQ(
      ::ad::physics::AngularAcceleration::cPrecisionValue,
      static_cast<double>(std::fabs(::ad::physics::AngularAcceleration(
          ::ad::physics::AngularAcceleration::cPrecisionValue))));
  EXPECT_DOUBLE_EQ(
...
TEST(AngularAccelerationTests, copyConstructionFromValidValue) {
  ::ad::physics::AngularAcceleration const validValue(
      ::ad::physics::AngularAcceleration::cMinValue);
  ::ad::physics::AngularAcceleration value(validValue);
  EXPECT_TRUE(value.isValid());
...
TEST(AngularAccelerationTests, moveConstructionFromValidValue) {
  ::ad::physics::AngularAcceleration validValue(
      ::ad::physics::AngularAcceleration::cMinValue);
...
TEST(AngularAccelerationTests, arithmeticOperatorsThrowOnInvalid) {
  ::ad::physics::AngularAcceleration const minimalValue(
      ::ad::physics::AngularAcceleration::cMinValue);
  ::ad::physics::AngularAcceleration const maximalValue(
      ::ad::physics::AngularAcceleration::cMaxValue);
  ::ad::physics::AngularAcceleration const invalidValue;
  ...
  EXPECT_THROW(invalidValue / maximalValue, std::out_of_range);
  EXPECT_THROW(maximalValue / invalidValue, std::out_of_range);
  EXPECT_THROW(maximalValue / ::ad::physics::AngularAcceleration(0.0),
               std::out_of_range);
...
TEST(AngularAccelerationTests, comparisonOperatorsRespectPrecision) {
  double const precisionValueTimesTen =
      ::ad::physics::AngularAcceleration::cPrecisionValue * 10.;
  ::ad::physics::AngularAcceleration value;
  if (::ad::physics::AngularAcceleration::cMinValue > precisionValueTimesTen) {
    value = ::ad::physics::AngularAcceleration(
        ::ad::physics::AngularAcceleration::cMinValue + precisionValueTimesTen);
  } else if (::ad::physics::AngularAcceleration::cMaxValue <
             precisionValueTimesTen) {
    value = ::ad::physics::AngularAcceleration(
        ::ad::physics::AngularAcceleration::cMaxValue - precisionValueTimesTen);
  } else {
...
TEST(AngularAccelerationTests, arithmeticOperatorsComputeCorrectly) {
  ...
  //  operator-()
  if ((::ad::physics::AngularAcceleration::cMinValue <
       -static_cast<double>(value)) &&
      (-static_cast<double>(value) <
       ::ad::physics::AngularAcceleration::cMaxValue)) {
    result = -value;
