...
void bench_formatter(benchmark::State &state, std::string pattern) {
  ...
  spdlog::details::log_msg msg(source_loc, logger_name, spdlog::level::info,
                               text);
...
void bench_formatters() {
  ...
  for (auto &flag : all_flags) {
    ...
    //        benchmark::RegisterBenchmark(pattern.c_str(), bench_formatter,
    //        pattern);
    //
