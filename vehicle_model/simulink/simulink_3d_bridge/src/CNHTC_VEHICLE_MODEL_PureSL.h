...
typedef struct {
  ...
  real_T Add_c;                        // '<S2>/Add'
  real_T Divide_f;                     // '<S2>/Divide'
  real_T Gain6;                        // '<Root>/Gain6'
  real_T Cos1;                         // '<Root>/Cos1'
  ...
  real_T Product3_i;                   // '<S48>/Product3'
  ...
  real_T Product2_fw;                  // '<S28>/Product2'
...
typedef struct {
  ...
  real_T Velong_kph;                   // '<Root>/Velong_kph'
  real_T Yaw_deg;                      // '<Root>/Yaw_deg'
  real_T YawRate_dps;                  // '<Root>/YawRate_dps'
  real_T Omega_w_rads;                 // '<Root>/Omega_w_rads'
  real_T Velate_kph;                   // '<Root>/Velate_kph'
  real_T ax_mps2;                      // '<Root>/ax_mps2'
  real_T Vx_kph;                       // '<Root>/Vx_kph'
  real_T Vy_kph;                       // '<Root>/Vy_kph'
  real_T X;                            // '<Root>/X'
  real_T Y;                            // '<Root>/Y'
  real_T Vz_kph;                       // '<Root>/Vz_kph'
  real_T Z;                            // '<Root>/Z'
} ExtY_CNHTC_VEHICLE_MODEL_PureSL_T;

extern ExtY_CNHTC_VEHICLE_MODEL_PureSL_T *output;
...
struct P_CNHTC_VEHICLE_MODEL_PureSL_T_ {
  ...
  real_T Gain6_Gain;                   // Expression: 1/57.3
  ...
  real_T Gain7_Gain;                   // Expression: 1/57.3
                                          //  Referenced by: '<Root>/Gain7'

  real_T Gain5_Gain_n;                 // Expression: 3.6
...
class CNHTC_VEHICLE_MODEL_PureSLModelClass {
 ...
 public:
  ...
  // model step function
  // void step();
  ExtY_CNHTC_VEHICLE_MODEL_PureSL_T step();
