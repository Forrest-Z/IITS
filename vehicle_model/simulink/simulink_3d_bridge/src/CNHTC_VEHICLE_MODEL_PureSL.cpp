...
// Model step function
ExtY_CNHTC_VEHICLE_MODEL_PureSL_T CNHTC_VEHICLE_MODEL_PureSLModelClass::step()
{
  boolean_T zcEvent;
  ...
  if (rtmIsMajorTimeStep((&CNHTC_VEHICLE_MODEL_PureSL_M))) {
    ...
    CNHTC_VEHICLE_MODEL_PureSL_Y.throttle =
      CNHTC_VEHICLE_MODEL_PureSL_P.Gain_Gain_b * pedalPos_pct;
  ...
  // Gain: '<Root>/Gain3'
  CNHTC_VEHICLE_MODEL_PureSL_B.Velong_kph =
    CNHTC_VEHICLE_MODEL_PureSL_P.Gain3_Gain *
    CNHTC_VEHICLE_MODEL_PureSL_B.VxBody_mps;

  // Outport: '<Root>/Velong_kph'
  CNHTC_VEHICLE_MODEL_PureSL_Y.Velong_kph =
    CNHTC_VEHICLE_MODEL_PureSL_B.Velong_kph;
  if (rtmIsMajorTimeStep((&CNHTC_VEHICLE_MODEL_PureSL_M))) {
  ...
  // Gain: '<S126>/Gain'
  CNHTC_VEHICLE_MODEL_PureSL_B.Gain = CNHTC_VEHICLE_MODEL_PureSL_P.Gain_Gain_m *
    CNHTC_VEHICLE_MODEL_PureSL_B.Integrator1_f;

  // Outport: '<Root>/Yaw_deg'
  CNHTC_VEHICLE_MODEL_PureSL_Y.Yaw_deg = CNHTC_VEHICLE_MODEL_PureSL_B.Gain;
  if (rtmIsMajorTimeStep((&CNHTC_VEHICLE_MODEL_PureSL_M))) {
  ...
  if (rtmIsMajorTimeStep((&CNHTC_VEHICLE_MODEL_PureSL_M))) {
    // Outport: '<Root>/YawRate_dps' incorporates:
    //   Gain: '<S126>/Gain2'

    CNHTC_VEHICLE_MODEL_PureSL_Y.YawRate_dps =
      CNHTC_VEHICLE_MODEL_PureSL_P.Gain2_Gain_h *
      CNHTC_VEHICLE_MODEL_PureSL_B.UnitDelay_c;
  }
  ...
  if (rtmIsMajorTimeStep((&CNHTC_VEHICLE_MODEL_PureSL_M))) {
    // Outport: '<Root>/Velate_kph' incorporates:
    //   Gain: '<Root>/Gain1'

    CNHTC_VEHICLE_MODEL_PureSL_Y.Velate_kph =
      CNHTC_VEHICLE_MODEL_PureSL_P.Gain1_Gain_g *
      CNHTC_VEHICLE_MODEL_PureSL_B.UnitDelay_f;
    ...
    // Gain: '<S129>/Gain2'
    CNHTC_VEHICLE_MODEL_PureSL_B.Gain2_a =
      CNHTC_VEHICLE_MODEL_PureSL_P.Gain2_Gain_g *
      CNHTC_VEHICLE_MODEL_PureSL_B.Divide1_l;

    // Gain: '<S129>/Gain'
    u0 = 1.0 / rtP_Chas.Rt;
    CNHTC_VEHICLE_MODEL_PureSL_B.FxfDr = u0 *
      CNHTC_VEHICLE_MODEL_PureSL_B.Gain2_a;
    ...
    CNHTC_VEHICLE_MODEL_PureSL_B.Gain_n =
      CNHTC_VEHICLE_MODEL_PureSL_P.Gain_Gain_h *
      CNHTC_VEHICLE_MODEL_PureSL_B.BraF;
  }
  ...
  if (CNHTC_VEHICLE_MODEL_PureSL_B.Compare) {
    ...
    CNHTC_VEHICLE_MODEL_PureSL_B.BraF_g = CNHTC_VEHICLE_MODEL_PureSL_B.Gain_n;
  }
  ...
  if (CNHTC_VEHICLE_MODEL_PureSL_B.Compare_g) {
    ...
    // Gain: '<S127>/Gain5'
    CNHTC_VEHICLE_MODEL_PureSL_B.Gain5_b =
      CNHTC_VEHICLE_MODEL_PureSL_P.Gain5_Gain *
      CNHTC_VEHICLE_MODEL_PureSL_B.VxBody_mps;
  ...
  CNHTC_VEHICLE_MODEL_PureSL_B.Divide_f = CNHTC_VEHICLE_MODEL_PureSL_B.Add_c /
    rtP_VEH.Mass;

  // Outport: '<Root>/ax_mps2'
  CNHTC_VEHICLE_MODEL_PureSL_Y.ax_mps2 = CNHTC_VEHICLE_MODEL_PureSL_B.Divide_f;

  // Gain: '<Root>/Gain6' incorporates:
  //   Inport: '<Root>/Grade_deg'

  CNHTC_VEHICLE_MODEL_PureSL_B.Gain6 = CNHTC_VEHICLE_MODEL_PureSL_P.Gain6_Gain *
    Grade_deg;

  // Trigonometry: '<Root>/Cos1'
  CNHTC_VEHICLE_MODEL_PureSL_B.Cos1 = std::cos
    (CNHTC_VEHICLE_MODEL_PureSL_B.Gain6);

  // Product: '<Root>/Product2'
  CNHTC_VEHICLE_MODEL_PureSL_B.Product2 = CNHTC_VEHICLE_MODEL_PureSL_B.Cos1 *
    CNHTC_VEHICLE_MODEL_PureSL_B.VxBody_mps;

  // Gain: '<Root>/Gain'
  CNHTC_VEHICLE_MODEL_PureSL_B.Gain_g =
    CNHTC_VEHICLE_MODEL_PureSL_P.Gain_Gain_h3 *
    CNHTC_VEHICLE_MODEL_PureSL_B.Gain;
  ...
  CNHTC_VEHICLE_MODEL_PureSL_B.Product = CNHTC_VEHICLE_MODEL_PureSL_B.Product2 *
    CNHTC_VEHICLE_MODEL_PureSL_B.Cos;

  // Gain: '<Root>/Gain2'
  CNHTC_VEHICLE_MODEL_PureSL_B.Vx_kph =
    CNHTC_VEHICLE_MODEL_PureSL_P.Gain2_Gain_n *
    CNHTC_VEHICLE_MODEL_PureSL_B.Product;

  // Outport: '<Root>/Vx_kph'
  CNHTC_VEHICLE_MODEL_PureSL_Y.Vx_kph = CNHTC_VEHICLE_MODEL_PureSL_B.Vx_kph;
  ...
  CNHTC_VEHICLE_MODEL_PureSL_B.Product1_f =
    CNHTC_VEHICLE_MODEL_PureSL_B.Product2 * CNHTC_VEHICLE_MODEL_PureSL_B.Sin;

  // Gain: '<Root>/Gain4'
  CNHTC_VEHICLE_MODEL_PureSL_B.Vy_kph = CNHTC_VEHICLE_MODEL_PureSL_P.Gain4_Gain *
    CNHTC_VEHICLE_MODEL_PureSL_B.Product1_f;

  // Outport: '<Root>/Vy_kph'
  CNHTC_VEHICLE_MODEL_PureSL_Y.Vy_kph = CNHTC_VEHICLE_MODEL_PureSL_B.Vy_kph;

  // Integrator: '<Root>/Integrator'
  CNHTC_VEHICLE_MODEL_PureSL_B.X =
    CNHTC_VEHICLE_MODEL_PureSL_X.Integrator_CSTATE_l;

  // Outport: '<Root>/X'
  CNHTC_VEHICLE_MODEL_PureSL_Y.X = CNHTC_VEHICLE_MODEL_PureSL_B.X;

  // Integrator: '<Root>/Integrator1'
  CNHTC_VEHICLE_MODEL_PureSL_B.Y =
    CNHTC_VEHICLE_MODEL_PureSL_X.Integrator1_CSTATE_o;

  // Outport: '<Root>/Y'
  CNHTC_VEHICLE_MODEL_PureSL_Y.Y = CNHTC_VEHICLE_MODEL_PureSL_B.Y;

  // Gain: '<Root>/Gain7' incorporates:
  //   Inport: '<Root>/Grade_deg'

  CNHTC_VEHICLE_MODEL_PureSL_B.Gain7 = CNHTC_VEHICLE_MODEL_PureSL_P.Gain7_Gain *
    Grade_deg;

  // Trigonometry: '<Root>/Cos2'
  CNHTC_VEHICLE_MODEL_PureSL_B.Cos2 = std::sin
    (CNHTC_VEHICLE_MODEL_PureSL_B.Gain7);

  // Product: '<Root>/Product3'
  CNHTC_VEHICLE_MODEL_PureSL_B.Product3 = CNHTC_VEHICLE_MODEL_PureSL_B.Cos2 *
    CNHTC_VEHICLE_MODEL_PureSL_B.VxBody_mps;

  // Gain: '<Root>/Gain5'
  CNHTC_VEHICLE_MODEL_PureSL_B.Gain5 = CNHTC_VEHICLE_MODEL_PureSL_P.Gain5_Gain_n
    * CNHTC_VEHICLE_MODEL_PureSL_B.Product3;

  // Outport: '<Root>/Vz_kph'
  CNHTC_VEHICLE_MODEL_PureSL_Y.Vz_kph = CNHTC_VEHICLE_MODEL_PureSL_B.Gain5;

  // Integrator: '<Root>/Integrator2'
  CNHTC_VEHICLE_MODEL_PureSL_B.Integrator2 =
    CNHTC_VEHICLE_MODEL_PureSL_X.Integrator2_CSTATE;

  // Outport: '<Root>/Z'
  CNHTC_VEHICLE_MODEL_PureSL_Y.Z = CNHTC_VEHICLE_MODEL_PureSL_B.Integrator2;
  if (rtmIsMajorTimeStep((&CNHTC_VEHICLE_MODEL_PureSL_M))) {
    // Memory: '<S47>/Memory'
  ...
  switch (rtAction) {
   case 0:
    ...
    CNHTC_VEHICLE_MODEL_PureSL_B.Product2_fw =
      CNHTC_VEHICLE_MODEL_PureSL_B.Subtract_d1 *
      CNHTC_VEHICLE_MODEL_PureSL_B.omega;
   ...
   case 1:
    ...
    // Gain: '<S54>/Gain'
    CNHTC_VEHICLE_MODEL_PureSL_B.Gain_nv =
      CNHTC_VEHICLE_MODEL_PureSL_P.Gain_Gain *
      CNHTC_VEHICLE_MODEL_PureSL_B.Add2_d;
  ...
  CNHTC_VEHICLE_MODEL_PureSL_B.Product3_i = CNHTC_VEHICLE_MODEL_PureSL_B.J /
  ...
  u0 = rtP_Chas.Ie_kgm2 * 3.0;
  CNHTC_VEHICLE_MODEL_PureSL_B.Add3 = u0 +
    CNHTC_VEHICLE_MODEL_PureSL_B.Product3_i;

  // Product: '<S48>/Product8'
  CNHTC_VEHICLE_MODEL_PureSL_B.ApparentInertiaRatio = 1.0 /
    CNHTC_VEHICLE_MODEL_PureSL_B.Add3 * CNHTC_VEHICLE_MODEL_PureSL_B.Product3_i;
  ...
  CNHTC_VEHICLE_MODEL_PureSL_B.Product1_e =
    CNHTC_VEHICLE_MODEL_PureSL_B.Product2_f / CNHTC_VEHICLE_MODEL_PureSL_B.N;
  ...
  if (rtmIsMajorTimeStep((&CNHTC_VEHICLE_MODEL_PureSL_M))) {
    ...
    if (rtmIsMajorTimeStep((&CNHTC_VEHICLE_MODEL_PureSL_M))) {
      ...
      CNHTC_VEHICLE_MODEL_PureSL_DW.UnitDelay_DSTATE =
        CNHTC_VEHICLE_MODEL_PureSL_B.Divide_f;
  ...
  // std::cout<<CNHTC_VEHICLE_MODEL_PureSL_Y.Velong_kph<<std::endl;
   return CNHTC_VEHICLE_MODEL_PureSL_Y;
}
  ...
  CNHTC_VEHICLE_MODEL_PureSL_derivatives()
{
  ...
  _rtXdot->Integrator_CSTATE = CNHTC_VEHICLE_MODEL_PureSL_B.Divide_f;
  ...
  _rtXdot->Integrator2_CSTATE = CNHTC_VEHICLE_MODEL_PureSL_B.Product3;
...
void CNHTC_VEHICLE_MODEL_PureSLModelClass::initialize()
{
...

  {
    ...
    CNHTC_VEHICLE_MODEL_PureSL_B.Velong_kph = 0.0;
    ...
    CNHTC_VEHICLE_MODEL_PureSL_B.Gain2_a = 0.0;
    ...
    CNHTC_VEHICLE_MODEL_PureSL_B.Divide_f = 0.0;
    CNHTC_VEHICLE_MODEL_PureSL_B.Gain6 = 0.0;
    CNHTC_VEHICLE_MODEL_PureSL_B.Cos1 = 0.0;
    ...
    CNHTC_VEHICLE_MODEL_PureSL_B.Vx_kph = 0.0;
    CNHTC_VEHICLE_MODEL_PureSL_B.Sin = 0.0;
    CNHTC_VEHICLE_MODEL_PureSL_B.Product1_f = 0.0;
    CNHTC_VEHICLE_MODEL_PureSL_B.Vy_kph = 0.0;
    CNHTC_VEHICLE_MODEL_PureSL_B.X = 0.0;
    CNHTC_VEHICLE_MODEL_PureSL_B.Y = 0.0;
    CNHTC_VEHICLE_MODEL_PureSL_B.Gain7 = 0.0;
    CNHTC_VEHICLE_MODEL_PureSL_B.Cos2 = 0.0;
    CNHTC_VEHICLE_MODEL_PureSL_B.Product3 = 0.0;
    CNHTC_VEHICLE_MODEL_PureSL_B.Gain5 = 0.0;
    CNHTC_VEHICLE_MODEL_PureSL_B.Integrator2 = 0.0;
    ...
    CNHTC_VEHICLE_MODEL_PureSL_B.Product3_i = 0.0;
    ...
    CNHTC_VEHICLE_MODEL_PureSL_B.Gain5_b = 0.0;
    ...
    CNHTC_VEHICLE_MODEL_PureSL_B.Gain_nv = 0.0;
    ...
    CNHTC_VEHICLE_MODEL_PureSL_B.Product2_fw = 0.0;
  ...
  CNHTC_VEHICLE_MODEL_PureSL_Y.throttle = 0.0;
  ...
  CNHTC_VEHICLE_MODEL_PureSL_Y.Velong_kph = 0.0;
  CNHTC_VEHICLE_MODEL_PureSL_Y.Yaw_deg = 0.0;
  CNHTC_VEHICLE_MODEL_PureSL_Y.YawRate_dps = 0.0;
  CNHTC_VEHICLE_MODEL_PureSL_Y.Omega_w_rads = 0.0;
  CNHTC_VEHICLE_MODEL_PureSL_Y.Velate_kph = 0.0;
  CNHTC_VEHICLE_MODEL_PureSL_Y.ax_mps2 = 0.0;
  CNHTC_VEHICLE_MODEL_PureSL_Y.Vx_kph = 0.0;
  CNHTC_VEHICLE_MODEL_PureSL_Y.Vy_kph = 0.0;
  CNHTC_VEHICLE_MODEL_PureSL_Y.X = 0.0;
  CNHTC_VEHICLE_MODEL_PureSL_Y.Y = 0.0;
  CNHTC_VEHICLE_MODEL_PureSL_Y.Vz_kph = 0.0;
  CNHTC_VEHICLE_MODEL_PureSL_Y.Z = 0.0;
  ...
  CNHTC_VEHICLE_MODEL_PureSL_X.Integrator2_CSTATE =
    CNHTC_VEHICLE_MODEL_PureSL_P.Integrator2_IC;
  ...
  {
    int_T rootPeriodicContStateIndices[1] = { 18 };
