###########################################################################
## Makefile generated for Simulink model 'TCU'. 
## 
## Makefile     : TCU.mk
## Generated on : Thu Jul 09 18:47:01 2020
## MATLAB Coder version: 4.3 (R2019b)
## 
## Build Info:
## 
## Final product: .\TCU_rtwlib.lib
...
COMPILER_COMMAND_FILE     = TCU_comp.rsp
CMD_FILE                  = TCU.rsp
C_STANDARD_OPTS           = 
CPP_STANDARD_OPTS         = 
NODEBUG                   = 1
MODELLIB                  = TCU_rtwlib.lib
...
DEFINES_STANDARD = -DMODEL=TCU -DNUMST=1 -DNCSTATES=0 -DHAVESTDIO -DMODEL_HAS_DYNAMICALLY_LOADED_SFCNS=0
...
SRCS = $(START_DIR)\slprj\ert\TCU\TCU.cpp
...
{$(START_DIR)\slprj\ert\TCU}.c.obj :
	$(CC) $(CFLAGS) -Fo"$@" "$<"


{$(START_DIR)\slprj\ert\TCU}.cpp.obj :
	$(CPP) $(CPPFLAGS) -Fo"$@" "$<"
