...
// C/C++ source code generated on : Thu Jul  9 18:46:58 2020
//
...
void TCUModelClass::TCU_calc(real_T rtu_gear, real_T rtu_pedal, real_T rtu_speed,
  real_T *rty_SpdThr, B_calc_TCU_T *localB, P_calc_TCU_T *localP)
{
  // Lookup_n-D: '<S3>/Calculate Upshift Threshold1'
  localB->CalculateUpshiftThreshold1 = look2_binlcapw(rtu_pedal, rtu_gear,
    rtP_ShiftUpTa_Bp_PedPos, rtP_ShiftUpTa_Bp_GearPos, rtP_UpshiftSpdTa,
    localP->CalculateUpshiftThreshold1_maxIndex, 10U);

  // Sum: '<S3>/Add1'
  localB->Add1 = localB->CalculateUpshiftThreshold1 - rtu_speed;

  // Lookup_n-D: '<S3>/Calculate  Downshift Threshold'
  localB->CalculateDownshiftThreshold = look2_binlcapw(rtu_pedal, rtu_gear,
    rtP_ShiftDnTa_Bp_PedPos, rtP_ShiftDnTa_Bp_GearPos, rtP_DnShiftSpdTa,
    localP->CalculateDownshiftThreshold_maxIndex, 9U);
...
void TCUModelClass::TCU_GearState(const real_T *rtu_VehSpdFdbk, real_T
  *rty_TransmissionCmd)
{
...
// Function for Chart: '<Root>/TCM Shift Controller'
void TCUModelClass::TCU_c1_TCU(const real_T *rtu_VehSpdFdbk, real_T
  *rty_TransmissionCmd)
{
  ...
  if (TCU_DW.is_active_c1_TCU == 0U) {
    ...
    *rty_TransmissionCmd = 2.0;
    ...
    if (TCU_DW.is_active_SelectionState != 0U) {
      ...
      TCU_B.CalculateUpshiftThreshold = look2_binlcapw(TCU_B.pedal, TCU_B.gear,
        rtP_ShiftUpTa_Bp_PedPos, rtP_ShiftUpTa_Bp_GearPos, rtP_UpshiftSpdTa,
      ...
      TCU_B.CalculateDownshiftThreshold = look2_binlcapw(TCU_B.pedal_h,
        TCU_B.gear_i, rtP_ShiftDnTa_Bp_PedPos, rtP_ShiftDnTa_Bp_GearPos,
        rtP_DnShiftSpdTa, TCU_rtP.CalculateDownshiftThreshold_maxIndex, 9U);
      ...
      switch (TCU_DW.is_SelectionState) {
       ...
       case TCU_IN_preDownShifting:
        ...
        if ((TCU_DW.temporalCounter_i1 >= 250U) && (*rtu_VehSpdFdbk <
             TCU_B.CalculateDownshiftThreshold - 2.0)) {
          // Transition: '<S2>:159'
       ...
       case TCU_IN_preUpShifting:
        ...
        if ((TCU_DW.temporalCounter_i1 >= 1U) && ((*rtu_VehSpdFdbk > up_th) &&
             (TCU_B.Gain >= 0.6) && (*rty_TransmissionCmd <= 8.0))) {
          // Transition: '<S2>:395'
          // Event: '<S2>:391'
          b_previousEvent = TCU_DW.sfEvent;
        ...
        } else if ((TCU_DW.temporalCounter_i1 >= 1U) && ((*rtu_VehSpdFdbk >
                     up_th) && (TCU_B.Gain < 0.6))) {
          // Transition: '<S2>:155'
...
void TCUModelClass::step(const real_T *rtu_pedalPos_pct, const real_T
  *rtu_VehSpdFdbk, const real_T *rtu_EngSpdFdbk_rpm, real_T *rty_TransmissionCmd)
{
  // Gain: '<Root>/Gain'
  ...
  TCU_B.LogicalOperator = (TCU_B.RelationalOperator1 && TCU_B.RelationalOperator);

  // Chart: '<Root>/TCM Shift Controller'
  if (TCU_DW.temporalCounter_i1 < 255U) {
    TCU_DW.temporalCounter_i1 = static_cast<uint8_T>((TCU_DW.temporalCounter_i1
      + 1U));
  }
...
void TCUModelClass::initialize()
{
  ...
  // block I/O
  (void) std::memset((static_cast<void *>(&TCU_B)), 0,
                     sizeof(B_TCU_T));
  ...
  // states (dwork)
  (void) std::memset(static_cast<void *>(&TCU_DW), 0,
                     sizeof(DW_TCU_T));
}
...
RT_MODEL_TCU_T * TCUModelClass::getRTM()
{
  return (&TCU_M);
}
