...
//
#ifndef RTW_HEADER_TCU_h_
#define RTW_HEADER_TCU_h_
#include <cmath>
#include <cstring>
#include <stddef.h>
...
typedef struct {
  ...
  uint8_T temporalCounter_i1;          // '<Root>/TCM Shift Controller'
} DW_TCU_T;
...
class TCUModelClass {
 ...
 public:
  ...
  // model step function
  void step(const real_T *rtu_pedalPos_pct, const real_T *rtu_VehSpdFdbk, const
            real_T *rtu_EngSpdFdbk_rpm, real_T *rty_TransmissionCmd);
 ...
 private:
  ...
  void TCU_calc(real_T rtu_gear, real_T rtu_pedal, real_T rtu_speed, real_T
                *rty_SpdThr, B_calc_TCU_T *localB, P_calc_TCU_T *localP);
