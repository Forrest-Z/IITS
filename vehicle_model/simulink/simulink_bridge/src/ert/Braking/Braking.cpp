...
void BrakingModelClass::step(const real_T *rtu_XBR1_ExternalAccele, const real_T
  *rtu_ax_mps2, const real_T *rtu_XBR1_Ctrl_Mode, const real_T *rtu_Mass_kg,
  real_T rty_bwdWhlPre_Mpa[4], real_T rty_fwdWhlPre_Mpa[2], real_T
  rty_TrailWhlPre_Mpa[6])
{
  ...
  Braking_B.Compare = (*rtu_XBR1_Ctrl_Mode ==
                       Braking_rtP.CompareToConstant_const);
  ...
  if (Braking_B.UnitDelay1) {
    ...
    } else if (*rtu_ax_mps2 < u1) {
      Braking_B.Saturation = u1;
    } else {
      Braking_B.Saturation = *rtu_ax_mps2;
    }
  ...
  Braking_B.Compare_j = (Braking_B.Abs1 > Braking_rtP.CompareToConstant_const_n);
  ...
  Braking_B.BackAxleBrakePressure = look2_binlcapw(Braking_B.BraCmdCtrl_mps2,
    *rtu_Mass_kg, rtP_EBC.braCmd_BP, rtP_EBC.mass_BP, rtP_EBC.bwdAxlePre_Table,
    Braking_rtP.BackAxleBrakePressure_maxIndex, 26U);

  // Gain: '<S15>/Gain1'
  Braking_B.bwdWhlPreCmd_Kpa = Braking_rtP.Gain1_Gain_h *
  ...
  if (Braking_B.ManualSwitch != 0.0) {
    ...
    Braking_B.Compare_ae = (Braking_B.Subtract >
      Braking_rtP.CompareToConstant1_const);
    ...
    if (Braking_B.Compare_ae) {
      ...
      Braking_B.Compare_km = (Braking_B.Subtract <
        Braking_rtP.CompareToConstant2_const);
  ...
  Braking_B.TrailPreGain = look1_binlcapw(Braking_B.BraCmdCtrl_mps2,
    Braking_rtP.TrailPreGain_bp01Data, Braking_rtP.TrailPreGain_tableData, 1U);

  // Product: '<S15>/Product'
  Braking_B.TrailWhlPreCmd_Kpa = Braking_B.BackAxleBrakePressure *
    Braking_B.TrailPreGain;
  ...
  if (Braking_B.ManualSwitch_b != 0.0) {
    // Sum: '<S2>/Subtract'
    Braking_B.TrailPreErr_Kpa = Braking_B.TrailWhlPreCmd_Kpa -
      Braking_B.TrailAllWhlPre_Mpa;

    // RelationalOperator: '<S10>/Compare' incorporates:
    //   Constant: '<S10>/Constant'

    Braking_B.Compare_o = (Braking_B.TrailPreErr_Kpa >
      Braking_rtP.CompareToConstant1_const_l);
    ...
    if (Braking_B.Compare_o) {
      ...
      Braking_B.Compare_as = (Braking_B.TrailPreErr_Kpa <
        Braking_rtP.CompareToConstant2_const_f);
  ...
  Braking_B.forwardAxleBrakePressure1 = look2_binlcapw(Braking_B.BraCmdCtrl_mps2,
    *rtu_Mass_kg, rtP_EBC.braCmd_BP, rtP_EBC.mass_BP, rtP_EBC.fwdAxlePre_Table,
    Braking_rtP.forwardAxleBrakePressure1_maxIndex, 26U);

  // Gain: '<S15>/Gain'
  Braking_B.fwdWhlPreCmd_Kpa = Braking_rtP.Gain_Gain_j *
  ...
  if (Braking_B.ManualSwitch_p != 0.0) {
    ...
    Braking_B.Compare_au = (Braking_B.FwdPreErr_Kpa >
      Braking_rtP.CompareToConstant1_const_o);
    ...
    if (Braking_B.Compare_au) {
      ...
      Braking_B.Compare_k = (Braking_B.FwdPreErr_Kpa <
        Braking_rtP.CompareToConstant2_const_h);
  ...
  if (Braking_B.UnitDelay1_a) {
    ...
    Braking_B.Product_k = Braking_B.BwdWhlBraPreRate_Kpas *
      Braking_rtP.Constant3_Value_b;
  ...
  if (Braking_B.UnitDelay1_ah) {
    ...
    Braking_B.Product = Braking_B.TrailWhlBraPreRate_Kpas *
      Braking_rtP.Constant10_Value;
  ...
  if (Braking_B.UnitDelay1_m) {
    ...
    Braking_B.Product_p = Braking_B.FwdWhlBraPreRate_Kpas *
      Braking_rtP.Constant7_Value;
...
void BrakingModelClass::initialize()
{
  ...
  // block I/O
  (void) std::memset((static_cast<void *>(&Braking_B)), 0,
                     sizeof(B_Braking_T));
  ...
  // states (dwork)
  (void) std::memset(static_cast<void *>(&Braking_DW), 0,
                     sizeof(DW_Braking_T));
...
RT_MODEL_Braking_T * BrakingModelClass::getRTM()
{
  return (&Braking_M);
}
