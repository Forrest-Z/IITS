###########################################################################
## Makefile generated for Simulink model 'Braking'. 
## 
## Makefile     : Braking.mk
## Generated on : Thu Jul 09 18:39:13 2020
## MATLAB Coder version: 4.3 (R2019b)
## 
## Build Info:
## 
## Final product: .\Braking_rtwlib.lib
...
COMPILER_COMMAND_FILE     = Braking_comp.rsp
CMD_FILE                  = Braking.rsp
C_STANDARD_OPTS           = 
CPP_STANDARD_OPTS         = 
NODEBUG                   = 1
MODELLIB                  = Braking_rtwlib.lib
...
SRCS = $(START_DIR)\slprj\ert\Braking\Braking.cpp
...
{$(START_DIR)\slprj\ert\Braking}.c.obj :
	$(CC) $(CFLAGS) -Fo"$@" "$<"


{$(START_DIR)\slprj\ert\Braking}.cpp.obj :
	$(CPP) $(CPPFLAGS) -Fo"$@" "$<"
