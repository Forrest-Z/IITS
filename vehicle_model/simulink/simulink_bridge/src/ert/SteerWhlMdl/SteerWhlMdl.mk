###########################################################################
## Makefile generated for Simulink model 'SteerWhlMdl'. 
## 
## Makefile     : SteerWhlMdl.mk
## Generated on : Thu Jul 09 18:46:56 2020
## MATLAB Coder version: 4.3 (R2019b)
## 
## Build Info:
## 
## Final product: .\SteerWhlMdl_rtwlib.lib
...
COMPILER_COMMAND_FILE     = SteerWhlMdl_comp.rsp
CMD_FILE                  = SteerWhlMdl.rsp
C_STANDARD_OPTS           = 
CPP_STANDARD_OPTS         = 
NODEBUG                   = 1
MODELLIB                  = SteerWhlMdl_rtwlib.lib
...
PRODUCT = .\SteerWhlMdl_rtwlib.lib
...
DEFINES_STANDARD = -DMODEL=SteerWhlMdl -DNUMST=1 -DNCSTATES=0 -DHAVESTDIO -DMODEL_HAS_DYNAMICALLY_LOADED_SFCNS=0
...
SRCS = $(START_DIR)\slprj\ert\SteerWhlMdl\SteerWhlMdl.cpp
...
{$(START_DIR)\slprj\ert\SteerWhlMdl}.c.obj :
	$(CC) $(CFLAGS) -Fo"$@" "$<"


{$(START_DIR)\slprj\ert\SteerWhlMdl}.cpp.obj :
	$(CPP) $(CPPFLAGS) -Fo"$@" "$<"
