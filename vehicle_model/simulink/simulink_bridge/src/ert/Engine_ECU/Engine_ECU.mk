###########################################################################
## Makefile generated for Simulink model 'Engine_ECU'. 
## 
## Makefile     : Engine_ECU.mk
## Generated on : Thu Jul 09 18:45:52 2020
## MATLAB Coder version: 4.3 (R2019b)
## 
## Build Info:
## 
## Final product: .\Engine_ECU_rtwlib.lib
...
COMPILER_COMMAND_FILE     = Engine_ECU_comp.rsp
CMD_FILE                  = Engine_ECU.rsp
C_STANDARD_OPTS           = 
CPP_STANDARD_OPTS         = 
NODEBUG                   = 1
MODELLIB                  = Engine_ECU_rtwlib.lib
...
DEFINES_STANDARD = -DMODEL=Engine_ECU -DNUMST=1 -DNCSTATES=0 -DHAVESTDIO -DMODEL_HAS_DYNAMICALLY_LOADED_SFCNS=0
...
SRCS = $(START_DIR)\slprj\ert\Engine_ECU\Engine_ECU.cpp
...
{$(START_DIR)\slprj\ert\Engine_ECU}.c.obj :
	$(CC) $(CFLAGS) -Fo"$@" "$<"


{$(START_DIR)\slprj\ert\Engine_ECU}.cpp.obj :
	$(CPP) $(CPPFLAGS) -Fo"$@" "$<"
