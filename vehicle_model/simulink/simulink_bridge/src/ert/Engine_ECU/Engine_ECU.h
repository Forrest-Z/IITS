...
//
#ifndef RTW_HEADER_Engine_ECU_h_
#define RTW_HEADER_Engine_ECU_h_
#include <cmath>
#include <cstring>
#include <stddef.h>
...
struct P_Engine_ECU_T_ {
  ...
  int8_T CompareToConstant_const_b; // Mask Parameter: CompareToConstant_const_b
...
class Engine_ECUModelClass {
 ...
 public:
  ...
  // model step function
  void step(const real_T *rtu_EngSpd_rpm, const real_T *rtu_VehSpd_kmph, const
            real_T *rtu_BrkCmd, const real_T *rtu_PedalPos_pct, const boolean_T *
            rtu_ClutchLock, const real_T *rtu_GearSel, const real_T *rtu_GearPos,
            real_T *rty_TrqCmd);
 ...
 private:
  ...
  void Engine_ECU_IdleTrgCal(real_T rtu_TrqCmd, real_T rtu_VehSpd, real_T
    rtu_PedalPos_pct, real_T rtu_BrkCmd, boolean_T *rty_Idle_Trg,
  ...
  void Engine_ECU_IdleSpdCtrl(real_T rtu_EngSpd, real_T *rty_TrqCmd,
    B_IdleSpdCtrl_Engine_ECU_T *localB, DW_IdleSpdCtrl_Engine_ECU_T *localDW,
    P_IdleSpdCtrl_Engine_ECU_T *localP);
};
...
#endif                                 // RTW_HEADER_Engine_ECU_h_
