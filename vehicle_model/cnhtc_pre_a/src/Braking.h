...
//
#ifndef SIMULATION_VEHICLE_MODEL_CNHTC_PRE_A_V1P1_BRAKING_H_
#define SIMULATION_VEHICLE_MODEL_CNHTC_PRE_A_V1P1_BRAKING_H_
#include <cmath>
#include <cstring>
...
struct P_Braking_T_ {
  ...
  real_T
      CompareToConstant_const_n;    // Mask Parameter: CompareToConstant_const_n
...
class BrakingModelClass {
 ...
 public:
  ...
  void initialize();
  // model step function
  void step(const real_T *rtu_XBR1_ExternalAccele, const real_T *rtu_ax_g,
            const real_T *rtu_XBR1_Ctrl_Mode, const real_T *rtu_Mass_kg,
            real_T rty_bwdWhlPre_Mpa[4], real_T rty_fwdWhlPre_Mpa[2],
...
//  '<S18>'  : 'Braking/EBS
//  controller/BrakeController/IntergraterWiLimit/Saturation Dynamic'
...
//  '<S28>'  : 'Braking/HydraulicBrakeSystem/IntergraterWiLimit/Saturation
//  Dynamic'
//  '<S29>'  : 'Braking/HydraulicBrakeSystem/IntergraterWiLimit1/Saturation
//  Dynamic'
//  '<S30>'  : 'Braking/HydraulicBrakeSystem/IntergraterWiLimit2/Saturation
//  Dynamic'

#endif  // SIMULATION_VEHICLE_MODEL_CNHTC_PRE_A_V1P1_BRAKING_H_
//
