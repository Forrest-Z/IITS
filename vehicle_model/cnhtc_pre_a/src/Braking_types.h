...
//
#ifndef SIMULATION_VEHICLE_MODEL_CNHTC_PRE_A_V1P1_BRAKING_TYPES_H_
#define SIMULATION_VEHICLE_MODEL_CNHTC_PRE_A_V1P1_BRAKING_TYPES_H_
#include "rtwtypes.h"
...
#endif  // SIMULATION_VEHICLE_MODEL_CNHTC_PRE_A_V1P1_BRAKING_TYPES_H_
