...
#ifndef solver_zc_hpp_  // NOLINT
#define solver_zc_hpp_  // NOLINT
/* slZcSignalType ==============================================================
 *
 */
typedef enum {
...
#define SL_ZCS_EVENT_ALL_UP \
  (SL_ZCS_EVENT_N2P | SL_ZCS_EVENT_N2Z | SL_ZCS_EVENT_Z2P)
#define SL_ZCS_EVENT_ALL_DN \
  (SL_ZCS_EVENT_P2N | SL_ZCS_EVENT_P2Z | SL_ZCS_EVENT_Z2N)
