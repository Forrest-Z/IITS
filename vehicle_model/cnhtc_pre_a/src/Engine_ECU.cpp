...
void Engine_ECUModelClass::Engine_ECU_IdleTrgCal_Init(
    boolean_T *rty_Idle_Trg, DW_IdleTrgCal_Engine_ECU_T *localDW,
...
void Engine_ECUModelClass::Engine_ECU_IdleTrgCal(
    real_T rtu_TrqCmd, real_T rtu_VehSpd, real_T rtu_PedalPos_pct,
    real_T rtu_BrkCmd, boolean_T *rty_Idle_Trg,
    B_IdleTrgCal_Engine_ECU_T *localB, DW_IdleTrgCal_Engine_ECU_T *localDW,
    P_IdleTrgCal_Engine_ECU_T *localP) {
...
void Engine_ECUModelClass::Engine_ECU_IdleSpdCtrl_Init(
    real_T *rty_TrqCmd, DW_IdleSpdCtrl_Engine_ECU_T *localDW,
...
void Engine_ECUModelClass::Engine_ECU_IdleSpdCtrl_Disable(
    real_T *rty_TrqCmd, P_IdleSpdCtrl_Engine_ECU_T *localP) {
  // Disable for Outport: '<S4>/TrqCmd'
  *rty_TrqCmd = localP->TrqCmd_Y0;
}
// Output and update for function-call system: '<S1>/IdleSpdCtrl'
void Engine_ECUModelClass::Engine_ECU_IdleSpdCtrl(
    real_T rtu_EngSpd, real_T *rty_TrqCmd, B_IdleSpdCtrl_Engine_ECU_T *localB,
...
void Engine_ECUModelClass::init(void) {
  ...
  //
  //   Store in Global RAM
  Engine_ECU_DW.DelayInput2_DSTATE =
      Engine_ECU_rtP.DelayInput2_InitialCondition;
...
void Engine_ECUModelClass::step(const real_T *rtu_EngSpd_rpm,
                                const real_T *rtu_VehSpd_kmph,
                                const real_T *rtu_BrkCmd,
                                const real_T *rtu_PedalPos_pct,
                                const boolean_T *rtu_ClutchLock,
                                const real_T *rtu_GearSel,
  ...
  Engine_ECU_B.DataTypeConversion = static_cast<int8_T>(
      (u0 < 0.0 ? static_cast<int32_T>(static_cast<int8_T>(
  ...
  Engine_ECU_B.DataTypeConversion1 = static_cast<int8_T>(
      (u0 < 0.0 ? static_cast<int32_T>(static_cast<int8_T>(
                      -static_cast<int8_T>(static_cast<uint8_T>(-u0))))
                : static_cast<int32_T>(
                      static_cast<int8_T>(static_cast<uint8_T>(u0)))));
  ...
  Engine_ECU_B.torque_map1 = look2_binlcapw(
      *rtu_PedalPos_pct, *rtu_EngSpd_rpm, rtP_EngTorBp_ped, rtP_EngTorBp_ne,
      rtP_EngTorTable, Engine_ECU_rtP.torque_map1_maxIndex, 16U);
  // Chart: '<Root>/EngineControl'
  if (Engine_ECU_DW.temporalCounter_i1 < 1023U) {
    Engine_ECU_DW.temporalCounter_i1 =
        static_cast<uint16_T>((Engine_ECU_DW.temporalCounter_i1 + 1U));
  }
      ...
      case Engine_ECU_IN_ClutchLocked:
        ...
        if (Engine_ECU_DW.GearShiftTrg) {
          ...
          if (Engine_ECU_DW.Idle_Trg) {
            ...
            Engine_ECU_IdleSpdCtrl(
                Engine_ECU_B.EngSpd, &Engine_ECU_B.Saturation1_g,
                &Engine_ECU_B.IdleSpdCtrl, &Engine_ECU_DW.IdleSpdCtrl,
                &Engine_ECU_rtP.IdleSpdCtrl);
            ...
            Engine_ECU_B.RelationalOperator1 =
                (Engine_ECU_B.GearSel_d != Engine_ECU_B.UnitDelay1);
            ...
            // Logic: '<S7>/AND'
            Engine_ECU_B.AND =
                (Engine_ECU_B.RelationalOperator1 && Engine_ECU_B.Compare_o);
            ...
            // '<S1>:3:9' Idle_Trg =
            // IdleTrgCal(EngTor,VehSpd,BrkCmd,PedalPos_pct); Simulink Function
            // 'IdleTrgCal': '<S1>:26'
            ...
            Engine_ECU_IdleTrgCal(
                Engine_ECU_B.TrqCmd, Engine_ECU_B.VehSpd,
                Engine_ECU_B.PedalPos_pct, Engine_ECU_B.BrkCmd,
                &Engine_ECU_B.AND3, &Engine_ECU_B.IdleTrgCal,
                &Engine_ECU_DW.IdleTrgCal, &Engine_ECU_rtP.IdleTrgCal);
      ...
      default:
        ...
        if (Engine_ECU_DW.ShiftDoneTrg) {
          ...
          if (Engine_ECU_DW.Idle_Trg) {
            ...
            // '<S1>:1:6' ShiftDoneTrg =
            // ShiftDoneCal(GearSel,GearPos,ClutchLock); Simulink Function
            // 'ShiftDoneCal': '<S1>:35'
            ...
            Engine_ECU_B.RelationalOperator =
                (Engine_ECU_B.GearSel == Engine_ECU_B.GearPos);
            // RelationalOperator: '<S14>/Compare' incorporates:
            //   Constant: '<S14>/Constant'
            Engine_ECU_B.Compare_g =
                (Engine_ECU_B.ClutchLock ==
                 Engine_ECU_rtP.CompareToConstant1_const_g);
            // Logic: '<S6>/AND'
            Engine_ECU_B.AND_j =
                (Engine_ECU_B.RelationalOperator && Engine_ECU_B.Compare_g);
            ...
            if (Engine_ECU_DW.is_Syncronize == Engine_ECU_IN_ClutchDisconect) {
              ...
              if (Engine_ECU_DW.temporalCounter_i1 >= 700U) {
                // Transition: '<S1>:59'
                ...
                Engine_ECU_B.Add =
                    Engine_ECU_rtP.Syncronizecontrolspeed_N_idle -
                    Engine_ECU_B.EngSpd_f;
                // Gain: '<S16>/I Gain'
                Engine_ECU_B.IGain =
                    Engine_ECU_rtP.Syncronizecontrolspeed_Ki_idle *
                    Engine_ECU_B.Add;
                ...
                // Sum: '<S16>/Add1'
                Engine_ECU_B.Add1 =
                    Engine_ECU_B.Product_c + Engine_ECU_B.Saturation;
                // Gain: '<S16>/P Gain'
                Engine_ECU_B.PGain =
                    Engine_ECU_rtP.Syncronizecontrolspeed_Kp_idle *
                    Engine_ECU_B.Add;
                // Sum: '<S16>/Add2' incorporates:
                //   Constant: '<S16>/Constant1'
                Engine_ECU_B.Add2 =
                    (Engine_ECU_B.Saturation + Engine_ECU_B.PGain) +
  ...
  Engine_ECU_B.Product1 =
      *rtu_EngSpd_rpm / Engine_ECU_rtP.RevLimiterControl_EngRevLim;
  // Lookup_n-D: '<S3>/1-D Lookup Table'
  Engine_ECU_B.uDLookupTable = look1_binlcpw(
      Engine_ECU_B.Product1, Engine_ECU_rtP.uDLookupTable_bp01Data,
      Engine_ECU_rtP.uDLookupTable_tableData, 1U);
  // Product: '<S3>/Product'
  Engine_ECU_B.Product = Engine_ECU_B.EngTor * Engine_ECU_B.uDLookupTable;
  // RelationalOperator: '<S17>/Compare' incorporates:
  //   Constant: '<S17>/Constant'
  Engine_ECU_B.Compare =
      (Engine_ECU_B.Product >= Engine_ECU_rtP.CompareToConstant_const);
  ...
  if (Engine_ECU_B.LowerRelop1) {
    ...
    Engine_ECU_B.Compare_f =
        (Engine_ECU_B.Product >= Engine_ECU_rtP.CompareToConstant1_const);
    ...
    Engine_ECU_B.deltafalllimit =
        Engine_ECU_B.Switch1 * Engine_ECU_B.sampletime;
    // RelationalOperator: '<S20>/UpperRelop'
    Engine_ECU_B.UpperRelop =
        (Engine_ECU_B.UkYk1 < Engine_ECU_B.deltafalllimit);
    // Switch: '<S20>/Switch'
...
void Engine_ECUModelClass::setErrorStatusPointer(
